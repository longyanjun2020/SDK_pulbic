...
if not exist sc\customer\default\profile\%2 (
	echo can not find sc\customer\default\profile\%2
	goto END
)
echo compare and merge file list
perl tng\mergeCode.pl sc\customer\default\profile\%2 FileList.xml fileChangeLog.txt
