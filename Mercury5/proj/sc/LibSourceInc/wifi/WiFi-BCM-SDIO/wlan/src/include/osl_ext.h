...
#define OSL_CREATE_SEM_INT_ERR		(0xFF)
#define OSL_CREATE_SEM_EXCEED_MAX	(0xFE)
#define OSL_CREATE_FLAG_INT_ERR 	(0xFF)
#define OSL_CREATE_FLAG_EXCEED_MAX 	(0xFE)
...
typedef void (*osl_ext_timer_callback)(u32 TimerID, u32 UserData);
...
typedef enum
{
	...
	OSL_EXT_TASK_SUPER_HIGH_PRIORITY,
	OSL_EXT_TASK_SUPER_PRIORITY,
	OSL_EXT_TASK_TIME_CRITICAL_PRIORITY,
	OSL_EXT_TASK_SUPER_CRITICAL_PRIORITY,
	/* This must be last. */
...
*/
/****************************************************************************
* Function:   osl_ext_os_sleep
*
* Purpose:    sleep in Ms
* Parameters: Ms     (in)  Millisecond to sleep
*
* Returns:    OSL_EXT_SUCCESS
*****************************************************************************/
osl_ext_status_t osl_ext_os_sleep(unsigned int Ms);
...
/****************************************************************************
* Function:   osl_ext_sem_set
*
* Purpose:    Set the count associated with the semaphore. This will
*
* Parameters: sem (mod) Semaphore object to set.
*             cnt a value to set
*
* Returns:    OSL_EXT_SUCCESS if the semaphore was set successfully, or an
*             error code if the semaphore could not be set.
*****************************************************************************
*/
osl_ext_status_t osl_ext_sem_set(osl_ext_sem_t *sem, unsigned short cnt);
...
osl_ext_status_t osl_ext_sem_query(osl_ext_sem_t *sem, uint16 *count);
...
/****************************************************************************
* Function:   osl_ext_task_init , will be execute by LWIP init
*
* Purpose:    initial & prepare task
*
* Returns:    Nothing.
*****************************************************************************/
void osl_ext_task_init(void);
int osl_ext_task_get_task_idx(void);
/****************************************************************************
...
void* osl_ext_malloc(uint32 size);
void osl_ext_free(void* rmem);

void osl_ext_sdio_internal_set_id(uint32 uiDevID);
void osl_ext_sdio_reg_sdio_isr(uint32 uiDevID, SDIOISRCallBack *Func);
bool osl_ext_sdio_set_dev_id(uint32 uiDevID);
bool osl_ext_sdio_get_dev_id(uint32* puiDevID);
bool osl_ext_sdio_init_dev(uint32 uiDevID);	
bool osl_ext_sdio_reset_dev(uint32 uiDevID);
bool osl_ext_sdio_write_reg(uint32 uiDevID, uint8 byFuncNum, uint32 uiRegAddr, uint8 bySrc);
bool osl_ext_sdio_read_reg(uint32 uiDevID, uint8 byFuncNum, uint32 uiRegAddr, uint8 *pbyDst);
bool osl_ext_sdio_write_multi_reg(uint32 uiDevID,  uint8 byFuncNum, uint8 byBlkMode, uint8 byOpCode, uint32 uiRegAddr, uint32 uiCount, uint32  uiBlkSize, uint8 *pbySrc);
...
void osl_ext_sdio_enable_isr(uint32 uiDevID, bool bEnable);

/*read MAC address which sotred in the host flash*/
