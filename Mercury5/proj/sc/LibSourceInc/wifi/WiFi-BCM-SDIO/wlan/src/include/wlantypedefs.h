...
#if !defined(linux) && !defined(__DJGPP__) && !defined(__BOB__) && \
	!defined(TARGETOS_nucleus) && !defined(__RTK_OS__)
#define TYPEDEF_UINT
#define TYPEDEF_USHORT
#endif
...
#if !defined(__DJGPP__) && !defined(__BOB__) && !defined(TARGETOS_nucleus) && !defined(__RTK_OS__)
