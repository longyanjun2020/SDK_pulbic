...
#elif defined ( PLATFORM_UCOSII)
#include "ucosii/ucosii_service.h"
#elif defined(PLATFORM_RTK_OS)
#include "rtk/rtk_service.h"
#endif
...
//	_queue work_queue;  //TODO
	...
	void *pstack;
	u16 stack_size;
#if defined(PLATFORM_RTK_OS) 
  	osl_ext_task_t  task_RTK_OS;
#endif
};
...
_list *_rtw_get_next(_list *list);
...
#ifdef CONFIG_SEMAPHORE_SHRINK
void	rtw_init_queue_no_spinlock(_queue	*pqueue);
#endif
...
int 	rtw_strlen(char * str);
u32 	rtw_atoi(u8* s);
char * rtw_strtok (char * string, const char * control);
void	rtw_mdelay_os(int ms);
void	rtw_udelay_os(int us);
void	rtw_yield_os(void);

void	rtw_init_timer(_timer *ptimer, void *adapter, TIMER_FUN pfunc,void* cntx, const char *name);
void	rtw_init_periodic_timer(_timer *ptimer, void *adapter, TIMER_FUN pfunc,void* cntx, const char *name);
...
void	rtw_thread_exit(char *name);
/*********************************** Timer related *****************************************/
...
void rtw_get_stack_usage(UINT32 priority);
void rtw_reset_global_stack();
/*********************************** OSDEP API end *****************************************/
...
#if 0//YAN_MASK
	void (*rtw_init_listhead)(_list *list);
	UINT32(*rtw_is_list_empty)(_list *phead);
	void (*rtw_list_insert_tail)(_list *plist, _list *phead);
	void (*rtw_list_insert_head)(_list *plist, _list *phead);
	_list *(*rtw_get_next)(_list	*list);
	void (*rtw_list_delete)(_list *plist);
#endif
	void (*rtw_init_sema)(_sema *sema, int init_val);
	void (*rtw_free_sema)(_sema *sema);
