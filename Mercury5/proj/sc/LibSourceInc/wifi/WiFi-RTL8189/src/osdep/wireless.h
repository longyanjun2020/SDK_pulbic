...
/* Update TSF */
#define SIOCSIWTSF	0x8B38		/* Config TSF paras*/
#define SIOCGIWTSF	0x8B39		/* Get TSF value*/
#if defined(CONFIG_PLATFORM_MSTAR_MSC8328D) || defined(CONFIG_PLATFORM_MSTAR_MSC8339)
#define SIOCGIWAUTHTYPE   0x8B3A	/* get authentication mode */
#endif
...
union	iwreq_data
{
	...
	struct iw_point tsf;			/*TSF Value for 8821CS */
