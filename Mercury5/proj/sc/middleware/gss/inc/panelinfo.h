...
#define MAIN_PANEL_HEIGHT               176
  ...
  #define MAIN_PANEL_DEF_POWERSTATE       ((MAIN_PANEL_MIN_POWERSTATE+MAIN_PANEL_MAX_POWERSTATE)/2)
    ...
    #define SUB_PANEL_WIDTH               176
    #define SUB_PANEL_HEIGHT              220
...
//===============================================
    ...
    u16  GetTransparencyColorSW(u32);

    s32  UpdateScreen(u32 PanelID, PMSBLT_SRCCOPY pParam);
    ...
    s32  UpdateScreenMdl(u32 PanelID, PMSBLT_SRCCOPY pParam);
    ...
    extern u16  GetTransparencyColorSW(u32);

    extern s32  UpdateScreen (u32 PanelID, PMSBLT_SRCCOPY pParam);
    ...
    extern s32  UpdateScreenMdl(u32 PanelID, PMSBLT_SRCCOPY pParam);
