...
INTERFACE s32  DispUpdateScreenMdl(u32 nPanelID, PMSBLT_SRCCOPY pParam);
INTERFACE s32  DispUpdateScreenAppEx(u32 nPanelID, PMSUPDATE pParam);
INTERFACE s32  DispUpdateScreenApp(u32 nPanelID, PMSBLT_SRCCOPY pParam);
...
INTERFACE bool DispPollMdlUpdateFinish(u32 nPanelID);
INTERFACE bool DispPollMdlUpdateFinishLoop(u32 nPanelID,bool bIsInt);
