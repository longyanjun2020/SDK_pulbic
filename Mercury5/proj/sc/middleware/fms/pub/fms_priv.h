...
typedef enum
{
   ...
   FMS_AREA_TRACES,
   FMS_AREA_XMODEM
#ifdef __DYNA_FLASH_FREE_SPACE_INFO__
  ,FMS_AREA_FREE
#endif
} fms_Area_e;

#ifdef __DYNA_FLASH_FREE_SPACE_INFO__
#define FMS_AREA_MAXNUMBER 12
#else
...
typedef struct
{
   u32 u32_E2pInitTime_1;
   u32 u32_E2pInitTime_2;
   u32 u32_RaiInitTime;
   u32 u32_FmsInitTime;
   u8  u8_E2pBuildMirror;
   u8  u8_E2pGarbageCollection;
   u8  u8_RaiGarbageCollection;
} fms_PowerOnCheck_t;
...
/*--------------------+---+---+---+-----------------------------------------*/
/****************************************************************************/
s32 fms_Write(u32 i__u32_Address, u32 i__u32_Size, const void *i__p_Source, bool M18_object);
s32 fms_WriteEx(u32 i__u32_Address, u32 i__u32_Size, const void *i__p_Source, bool M18_object, void *i__ps_Device);
...
s32 fms_Check_Erase(u32 i__u32_Address, u32 i__u32_Mode);
s32 fms_EraseEx(u32 i__u32_Address, u32 i__u32_Mode, void *i__ps_Device);
...
s32 fms_SetProtectEx(u32 i__u32_Address, u32 i__u32_Mode, void *i__ps_Device);
...
void fms_m18_control_read(void * base_addr, int length, u16* buf);
...
bool fms_IsValidCUS(u32 *pAddr);
s32 fms_rai_low_write(u32 i__u32_Address, u32 i__u32_Size, const void *i__p_Source,bool M18_object);
s32 fms_rai_low_erase(u32 i__u32_Address, u32 i__u32_Mode);
void fms_rai_Memcpy(void * base_addr, u32 length, u8* buf);
int fms_rai_Memcmp(u8* source, u8* sector_base, u32 length);
int fms_m18_rai(void * base_addr, int num_sectors, int sector_size);
int fms_m18_caculate_sector(int num_sectors, u8*shift);
int fms_rai_Memcmp1(u8* source, u8* sector_base, u32 length);
u32 fms_Word_Align(u32 i__u32_Address, u8* l__pu8_Source);
