...
fms_test_write_seq_psram_1   FUNCTION
    EXPORT  fms_test_write_seq_psram_1
    stmfd   sp!, {r4-r11}
...
fms_test_write_seq_psram_2    FUNCTION
    EXPORT  fms_test_write_seq_psram_2
    stmfd   sp!, {r4-r11}

    ; write data to psram
    MOV   r7, base_addr
    SUBS  base_addr, base_addr, #32    
    MOV   r8, base_addr
    LDR   r9, para7
    LDR   r10, para11
    LDR   r4, para8
