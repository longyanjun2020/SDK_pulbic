...
fms_test_read_nonseq_psram_1   FUNCTION
    EXPORT  fms_test_read_nonseq_psram_1
...
fms_test_read_nonseq_psram_2   FUNCTION
    EXPORT  fms_test_read_nonseq_psram_2
