...
#ifndef __MDL_KEYPAD_PUB_H__
#define __MDL_KEYPAD_PUB_H__
...
/** MdlKeypadSetTbl
* @brief        Used to set the keypad table
* @param[in]    pKeypadTbl   keypad table name.
*
* @retval       MDL_KEYPAD_OK
*               MDL_KEYPAD_FAIL
*/
extern MdlKeypadErrCode_e MdlKeypadSetTbl(char *pKeypadTbl);

#ifdef __DRV_KEYPAD_TABLE_STACKABLE__
/** MdlKeypadFreeTbl
* @brief        Used to free the keypad table
* @param[in]    pKeypadTbl   keypad table name.
*
* @retval       MDL_KEYPAD_OK
*               MDL_KEYPAD_FAIL
*/
extern MdlKeypadErrCode_e MdlKeypadFreeTbl(char *pKeypadTbl);
#endif
...
*              MDL_KEYPAD_FAIL, key is not processed
*/
extern MdlKeypadErrCode_e MdlKeypadMultiKey(bool isEnable);

#endif//_VIRTUAL_KEY_CODE_BODY_
#endif//__MDL_KEYPAD_PUB_H__
