...
struct sys_ringbuffer {
    ...
    int32_t  size;                  // ringbuf size
    int32_t  pread;                 // offset of read pointer
    int32_t  pwrite;                // offset of write pointer
...
void sys_ringbuffer_pktt_release(struct sys_ringbuffer *rbuf, uint32_t release_len);
...
int32_t sys_ringbuffer_pktt_read_peek(struct sys_ringbuffer *rbuf, uint8_t *buf, int32_t len,
                             void *pkt_buf, uint32_t pkt_len);

/* write routines & macros */
/* ----------------------- */

int32_t sys_ringbuffer_pktt_write(struct sys_ringbuffer *rbuf, const uint8_t *buf, uint32_t len,
                              const void *pkt_buf, uint32_t pkt_len);
