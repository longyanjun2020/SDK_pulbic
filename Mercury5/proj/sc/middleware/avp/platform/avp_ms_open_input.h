...
int open_file_input(cb_io_st *cbio, const ms_fnchar *filename, int read_buf_size, cbio_open_mode_et mode);
int open_aync_file_input(cb_io_st *cbio, const ms_fnchar *filename);

/* push mode input source */
int open_file_stream(cb_io_st *cbio, const ms_fnchar *filename, int read_buf_size, int program_id);
