...
typedef struct
{
   ...
   int frame_num;
   S64 sum_bitrate;
   unsigned int sram_addr,sram_end,heap_addr,heap_end;
   void (*aop_seek)(void *,unsigned int file_ptr);   
   int (*aop_read)(void *,unsigned char *, int, int *, int *);
   void *cb_instance;
} mp3dec;
...
extern const int c_mp3_is_table_16[7];
extern const short c_mp3_is_lsf_table_16[2][15];
extern const int c_mp3_cs_ca_16[8];
extern const int c_mp3_cos16tab[16];
extern const int c_mp3_imdct36_coef[100];
extern const int c_mp3_window_l_16[18];
extern const int c_mp3_sf_table[63];

extern const unsigned short c_mp3_hufftab15[380];
extern const unsigned short c_mp3_hufftab16[402];
extern const unsigned short c_mp3_hufftab24[386];
