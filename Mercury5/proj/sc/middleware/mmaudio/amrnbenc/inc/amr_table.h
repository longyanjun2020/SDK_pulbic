...
static const Word16 pred[NPRED] =
{
   5571,
   4751,
   2785,
...
static const Word16 pred_MR122[NPRED] =
{
   44,
   37,
   22,
...
static const Word16 inv_sqrt_table[49] =
{
   32767,
   31790,
   30894,
...
static const Word16 window_200_40[L_WINDOW] = {
...
/* table of cos(x) */
static const Word16 cos_table[65] =
{
   32767,
   32729,
   32610,
...
static const Word16 acos_slope[64] =
{
   - 26887,
   - 8812,
   - 5323,
...
static const Word16 mean_lsf_3[10] =
{
   1546,
   2272,
   3778,
...
static const Word16 mean_lsf_5[10] =
{
   1384,
   2077,
   3420,
...
static const Word16 pred_fac[10] =
{
   9556,
   10769,
   12571,
...
/* 1st LSF quantizer (not in MR122 and MR795)  Q2 */
static const Word16 dico1_lsf_3[] =
{
   6,
   82,
   - 131,
...
static const Word16 dico2_lsf_3[] =
{
   50,
   71,
   - 9,
...
static const Word16 dico3_lsf_3[] =
{
   67,
   - 17,
   66,
...
static const Word16 mr515_3_lsf[] =
{
   419,
   163,
   - 30,
...
static const Word16 mr795_1_lsf[] =
{
   - 890,
   - 1550,
   - 2541,
...
static const Word16 past_rq_init[80] =
{
   - 258,
   - 318,
   - 439,
...
static const Word16 dico1_lsf_5[DICO1_SIZE_5 * 4] =
{
   - 451,
   - 1065,
   - 529,
...
static const Word16 dico2_lsf_5[DICO2_SIZE_5 * 4] =
{
   - 1631,
   - 1600,
   - 1796,
...
static const Word16 dico3_lsf_5[DICO3_SIZE_5 * 4] =
{
   - 1812,
   - 2275,
   - 1879,
...
static const Word16 dico4_lsf_5[DICO4_SIZE_5 * 4] =
{
   - 1857,
   - 1681,
   - 1857,
...
static const Word16 dico5_lsf_5[DICO5_SIZE_5 * 4] =
{
   - 1002,
   - 929,
   - 1096,
