...
WMARESULT audecGetPCM (void* paudec,
                       ...
                       /*tWMA_I64* prtTime,*/ // [out] time stamp (in 100ns) of 1st sample returned
                       audecState *paudecState, // [out]
...
WMARESULT   ibstrmAttach(CWMAInputBitStream *pibstrm,   WMA_U8* pbSrc, tWMA_I32 cbSrc, Bool fNewPacket, Bool fNoMoreInput, Int iVersion);
...
void        ibstrmLoadBits(CWMAInputBitStream *pibs, tWMA_I32 iFirstBit, WMA_U8 uByte);
...
void SetActualPower(const tWMA_I32 *piCoefQ, const tWMA_I32 iCount,
...
WMARESULT auReconSample(CAudioObject* pau, tWMA_I32* piOutput, WMA_U16 cSamples);
