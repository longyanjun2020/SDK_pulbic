...
typedef struct  
{
    ...
    tWMA_I32*           m_rgiCoefQ;                      //quantized coef
...
//    Int m_iMaxEscLevel;         // (1<<m_iMaxEscSize)
    ...
    Int     m_iVersion;
    tWMA_I32     m_iEncodeOpt;
//    tWMA_I32     m_iAdvancedEncodeOpt;
...
//    WMA_U32     m_nSaveChannelMask;
    ...
    tWMA_I32     m_iPCMSampleMin;
    tWMA_I32     m_iPCMSampleMax;    
    ...
    tWMA_I32*    m_rgiCoefQ;             // just a pointer
    ...
    tWMA_I32        *m_rgiDiscardSilence;
    tWMA_I32         m_iPCMReconStart;   // the start point in PCM recon buffer for output
    tWMA_I32         m_iPCMReconEnd;     // the end point in PCM recon buffer
    ...
    //WMARESULT (*aupfnReconSample) (struct CAudioObjects* pau, tWMA_I32* piOutput, WMA_U16 cSamples);
 ...
 //   Int m_cBytePacketLength; 
    ...
    tWMA_I32     m_iSampleMaxValue;
    tWMA_I32     m_iSampleMinValue;
...
typedef struct CAudioObjectDecoders 
{
    ...
    tWMA_I64                m_iNewTimeBase;//in 100nano second
    tWMA_I64                m_iNewTimeBaseTemp;// The second (later one) NewTimeBase.
    tWMA_I64                m_iCurrPresTime;//in samples
...
typedef struct tagWMAFileStateInternal
{
    ...
    tWMA_U64   total_payload_size; //total payload size ; add for AV by Nelson 2010/03/23
