...
#   define BP2LPC_FROM_FLOAT(flt) ((I32)((flt)*BP2LPC_FRAC_SCALE))
...
//#   define MULT_HI_UDWORD(a,b) (WMA_U32)((((U64)(a))*((U64)(b)))>>32)
...
#   define MULT_ADD2_HI_UDWORD(a,b,c,d) (WMA_U32)(( (((U64)(a))*((U64)(b))) + (((U64)(c))*((U64)(d))) )>>32)
#else //FUSED_MUL_ADD
...
static INLINE I32 DIVI64BYU32(I64 a, WMA_U32 b) {
    return (I32)((a)/(b));
}
...
*/
static INLINE I32   ROUNDINT(int f)
{
    if (f < 0)
        return (int) (f -4);
    else
...
static INLINE FastFloat ffltfltMultiply30(FastFloat ffltA, Int B)
{
    ...
    SMULL(ffltA.iFraction, B);
    GET_MACR_30(ffltP.iFraction);
    Norm4FastFloat(&ffltP);
...
static INLINE I64 divide64_I64 (I64 dividend, int divisor) //actually , this function is worked under unsigned int64
{
    temp_64 tmp; 
    ...
    ret_value = ( ((I64) time_hi) <<32) | ((I64) tmp.quotient);
    return ret_value;
}
...
#endif
static INLINE I32 LOG2(WMA_U32 i)
...
static INLINE FastFloat FastFloatFromU64(U64 u64, Int cExp) 
    {
        FastFloat fflt;
...
static INLINE void ibstrmSetPrevPacketNum(CWMAInputBitStream *pibs, WMA_I32 iVal)
  ...
  static  INLINE FastFloat ffltSqrtRatio( FastFloat fflt1, FastFloat fflt2 )
    {
            ...
            //u64Ratio = (((U64)fflt1.iFraction)<<32)/fflt2.iFraction;  //divdi3
            u64Ratio = (U64) divide64_I64( (((I64)fflt1.iFraction)<<32), fflt2.iFraction);
...
static INLINE I32 *prvAdvancePCMPointer(const I32 *pCurrentPos,
                                const Int nBytePerSample,
                                const Int iOffset)
{
    return (I32 *) (((WMA_U8*) pCurrentPos) + (nBytePerSample * iOffset));
}
