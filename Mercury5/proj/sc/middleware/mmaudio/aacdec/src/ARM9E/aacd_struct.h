...
//FFT Table
   ...
   int (*avp_read)(void *cb_instance,unsigned char *buf, int len, int *pts, int *chunk_size, int *fending);
   void *cb_instance;
   ic_stream *ics1,*ics2;
   //int (*aop_getposition_callback)(void);
}aac_dec;
