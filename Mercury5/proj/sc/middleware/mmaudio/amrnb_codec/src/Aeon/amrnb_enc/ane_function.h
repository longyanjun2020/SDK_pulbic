...
int lpc(
    ...
    Word16 *rc,Word16 *rLow, Word16 *rHigh, Word16 *scal_acf
);
...
int lsp(lspState *st,        /* i/o : State struct                            */
        ...
        Word16 txdtx_ctrl,EFR_DTX_VAD_ENC_DATA *efr_dtx);
...
int pre_big(
    Word16 mode,            /* i  : coder mode                             */
    Word16 gamma1[],     /* i  : spectral exp. factor 1                 */
    Word16 gamma1_12k2[],/* i  : spectral exp. factor 1 for EFR         */
    Word16 gamma2[],     /* i  : spectral exp. factor 2                 */
...
Word32 amrnb_Div_32 (Word32 L_num, Word16 denom_hi, Word16 denom_lo);
Word16 Autocorr (
    Word16 x[],        /* (i)    : Input signal (L_WINDOW)             */
    Word16 m,          /* (i)    : LPC order                           */
    Word16 r_h[],      /* (o)    : Autocorrelations  (msb)  (MP1)      */
    Word16 r_l[],      /* (o)    : Autocorrelations  (lsb)  (MP1)      */
    Word16 wind[]/* (i)    : window for LPC analysis. (L_WINDOW) */
);
...
int Speech_Encode_Frame (
    ...
    int efr_flag,int homing_frame
);
#endif
Word16 PackBits(Word16 used_mode,Word16 mode,Word16 frame_type,Word16 bits[],UWord8 packed_bits[]);

void Build_CN_code_enc( Word32 *seed, Word16 *cod);
...
int cod_amr(cod_amrState *st,         /* i/o : State struct                 */
            ...
            Word16 synth[],Word16 amr_mode,Word16 *usedMode,int efr_flag,int homing_frame, 
            short *status_p, int dtxSyncFlag
);
