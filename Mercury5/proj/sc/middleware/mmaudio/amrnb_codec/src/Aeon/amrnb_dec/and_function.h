...
void D_plsf_5( D_plsfState *st, Word16 bfi, Word16 *indice, Word32 *lsp1_q, Word32 *lsp2_q,EFR_DTX_VAD_DEC_DATA *efr_dtx);
...
void ec_gain_pitch_update( ec_gain_pitchState *st, Word32 bfi,
      Word32 prev_bf, Word32 *gain_pitch ,Word16 rxdtx_ctrl );
...
void Build_CN_param (
    ...
    Word8 param_size_table[], /* i : size of params       */   
...
void Decoder_amr( Decoder_amrState *st, Word16 mode, Word16 parm[],
      Word16 frame_type, Word32 synth[], Word32 A_t[],int efr_flag, int efr_bfi, int TAF, int SID_flag );


void copy16_to32 (Word32 *y, Word16 *x,Word32 L);
