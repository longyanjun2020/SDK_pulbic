...
extern const UWord8 toc_byte[];
extern const Word16 packed_size[];
extern const Word16 unused_size[];
extern const Word16 gamma1_12k2[M];
extern const Word16 T_gamma2[M];
extern const Word16 T_gamma1[M];
extern const Word16 T_trackTable[4*5];
extern const Word16 T_startPos1[2];
extern const Word16 T_startPos2[4];
extern const Word16 T_gray[8];
