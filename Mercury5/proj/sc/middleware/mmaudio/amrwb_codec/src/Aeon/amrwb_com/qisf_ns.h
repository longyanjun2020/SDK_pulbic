...
/* means of ISFs */
const Word16 mean_isf_noise[ORDER] = {
...
const Word16 dico1_isf_noise[SIZE_BK_NOISE1*2] = {
...
const Word16 dico2_isf_noise[SIZE_BK_NOISE2*3] = {
...
const Word16 dico3_isf_noise[SIZE_BK_NOISE3*3] = {
...
const Word16 dico4_isf_noise[SIZE_BK_NOISE4*4] = {
...
const Word16 dico5_isf_noise[SIZE_BK_NOISE5*4] = {
  -810,  -879,  -945,  -254,
   248,   184,   671,   128,
   288,   703,   918,    99,
   658,   558,   662,   219,
