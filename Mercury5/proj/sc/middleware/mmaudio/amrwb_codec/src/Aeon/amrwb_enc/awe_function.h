...
Word32 Count_stab_fac(Word16 *isf, Word16 *old_isf);

void Target_res_synth(
     Word16 *aq,
     Word16 *speech,
     Word16 *exc,
     Word16 *error,
...
void dtx_gen_white_noise(Word16 *seed,Word16 *exc2,Word16 log_e,Word16 log_m);
void cal_conv_energy(Word16 *synth,Word16 *exp,Word16 *ener,Word16 *fac);
Word32 D_UTIL_dot_product12_exc(Word16 x[], Word16 lg, Word16 *exp);
Word32 D_UTIL_dot_product12_hf(Word16 x[], Word16 lg, Word16 *exp , Word16 * seed);
...
void Syn_filt_32_2(Word16 a[], Word16 exc[],Word16 Qnew, Word32 sig[],Word16 lg);
...
void Pred_lt4(
     ...
     Word32 T0_0,                            /* input : integer pitch lag */
...
Word16 awe_dtx_enc_reset(dtx_encState * st, Word16 isf_init[]);
...
void awe_tx_dtx_handler(dtx_encState * st,     /* i/o : State struct           */
...
#if 1
void Filt_6k_7k(Word16 signal[], Word16 mem[]);
int calc_mantissa_exp(Word16 signal[], Word16 *exp);
#else
int Filt_6k_7k_HF(Word16 signal[], Word16 mem[],Word16 *exp);
#endif
int Filt_6k_7k_synth(Word16 signal[], Word16 mem[],Word16 *exp);
...
Word32 sat_shl(Word32 L_tmp, Word16 var2);
...
Word32 D_UTIL_Div_32 (Word32 L_num, Word32 L_denom);

#ifdef __aeon__
int Mstar_amrwb_aeon_hardware_init(void);
#endif
#endif
