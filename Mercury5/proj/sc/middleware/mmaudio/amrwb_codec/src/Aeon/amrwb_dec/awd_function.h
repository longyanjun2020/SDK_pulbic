...
Word16 awd_decoder_homing_frame_test(Decoder_State *st, Word16 mode);

Word16 awd_decoder_homing_frame_test_first(Decoder_State *st, Word16 mode);
...
void awb_agc2(Word16 *sig_in, Word32 *sig_out);
...
void Pred_lt4(Word16 exc[], Word32 T0_0, Word32 frac);
...
void Oversamp_16k(Word16 sig12k8[], Word16 sig16k[],
                         Word16 mem[]);
