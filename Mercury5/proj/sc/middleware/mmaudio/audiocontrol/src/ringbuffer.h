 ...
 * otherwise.
 */
void ringbuffer_create(ringbuffer_t * rb, void *data, size_t sz);
 ...
 */
size_t ringbuffer_read(ringbuffer_t *rb, unsigned char *dest, size_t cnt);
 ...
 * @return the number of bytes read, which may range from 0 to cnt.
 */
size_t ringbuffer_peek(ringbuffer_t *rb, unsigned char *dest, size_t cnt);
 ...
 */
size_t ringbuffer_write(ringbuffer_t *rb, const unsigned char *src,
			     size_t cnt);
