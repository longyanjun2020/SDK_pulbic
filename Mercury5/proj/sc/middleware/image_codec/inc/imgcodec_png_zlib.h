...
#ifndef _IMGCODEC_PNG_ZLIB_H_
#define _IMGCODEC_PNG_ZLIB_H_

#ifdef IMGCODEC_USE_EXTERNAL_ZLIB
#include "zlib.h"
...
#define zlib_inflateInit2_ inflateInit2_
#define zlib_adler32       adler32
...
ZEXTERN int ZEXPORT zlib_uncompress OF((Bytef *dest, uLongf *destLen,
                                        const Bytef *source, uLong sourceLen));

ZEXTERN int ZEXPORT zlib_uncompress_no_header OF((Bytef *dest, uLongf *destLen,
                                                  const Bytef *source, uLong sourceLen));
/*
...
ZEXTERN uLong ZEXPORT zlib_adler32 OF((uLong adler, const Bytef *buf, uInt len));
/*
...
#endif /* IMGCODEC_USE_EXTERNAL_ZLIB */
#endif /* _IMGCODEC_PNG_ZLIB_H_ */
#endif
