...
/**
 *  @brief The enumeration defines the Video codec
 */
typedef MmlVideoVideoCodec_e esl_VdoCodec_e;
...
typedef enum {
  ESL_VDO_STEREO_NONE = 0,
  ESL_VDO_STEREO_RED_CYAN,
  ESL_VDO_STEREO_LEFT_RIGHT,
  ESL_VDO_STEREO_NUM
} esl_VdoStereoType_e;
...
typedef struct {
  ...
  esl_VdoCodec_e     codec;       /**< Video codec */
  esl_VdoStereoType_e stereoType;  /**< 2D/ 3D */
  u16                 depthAdjustable;
} esl_VdoMediaInfo_t;
