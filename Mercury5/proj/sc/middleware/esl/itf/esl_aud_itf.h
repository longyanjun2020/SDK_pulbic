 ...
 */
esl_AudErrCode_e esl_AudPlayTone(esl_AudDTMF_e toneID);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudStopTone(void);
 ...
 *
 * @param  toneID                       : Tony ID indicated which sound effct should be played
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 * @return ESL_AUD_PARAM_ERROR          : Incorrect parameter setting
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudPlayDTMFReq(esl_AudDTMF_e toneID, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudPlayDTMFReqEx(esl_AudDTMF_e toneID, u8 volRange, u8 volLevel, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudStopDTMFReq(esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetPath(esl_AudChannel_e chanId, esl_AudPath_e audPath);


/**
 * @brief  This function is used to mute/un-mute voice input devices
 *
 * @param  chanId                       : Audio channel select to mute
 * @param  Mute                         : Enable mute or not(true/false)
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 * @return ESL_AUD_PARAM_ERROR          : Incorrect parameter setting
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetMute(bool bMute);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetVol(esl_AudChannel_e chanId, u8 range, u8 volume);
 ...
 * @param  level                        : Volume balance. Negative value means the volume of right channel is decreased. Positive value means the volume of left channel is decreased.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 * @return ESL_AUD_PARAM_ERROR          : Incorrect parameter setting
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetBalance(esl_AudChannel_e chanId, s8 range, s8 level);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudEnableLocalTone(bool enable);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudEnableSpeech(bool enable);


/**
 * @brief This function is used to set the audio configuration
 *
 * @param  param                        : audio configuration parameter contains 3D effect on or off and EQ type
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetMediaConfigReq(esl_AudConfigItem_e item, esl_AudMediaConfig_t value, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get the current PEQ table address
 *
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudGetPEQTableAddress(esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetPEQTableAddress(u32 PEQTableAddress);

/**
 * @brief This function is used to play audio media file.
 *
 * @param  fileParam                    : File name lengthe and file name buffer
 * @param  position                     : Assign which position to play
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudPlayFileReq(esl_AudFileParam_t fileParam, u32 position, esl_AudCb_t *pAudCb);


/**
 * @brief EMA audio play stream (support PCM, WAVE, MIDI and MIDI tone)
 *
 * @param  streamParam                  : stream format, buffer and length
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudPlayStreamReq(esl_AudStreamParam_t streamParam, esl_AudCb_t *pAudCb);


/**
 * @brief EMA audio play stream (support WAVE, MP3 and MIDI)
 *
 * @param  memoryParam                  : audio format, position, buffer and length
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudPlayMemoryReq(esl_AudMemoryParam_t memoryParam, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudPlayCmdReq(esl_AudPlayCmd_e playCmd, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to set the video playback speed
 *
 * @param  playSpeed                    : Audio set music plyabck speed
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetPlaySpeedReq(esl_AudPlaySpeed_e playSpeed, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to set the audio media file playing position
 *
 * @param  position                     : Position (milli-second) of the media file to start
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudSetPositionReq(u32 position, esl_AudCb_t *pAudCb);


/**
 * @brief EMA audio get position
 *
 * @param  pAudDoneCB				   			  : Audio done call back structure point
 *
 * @return ESL_AUD_OK       				  : Audio set success
 * @return ESL_AUD_FAIL               : Audio set fail
 * @return ESL_AUD_PARAM_ERROR        : Audio set parameter error
 */
esl_AudErrCode_e esl_AudGetPositionReq(esl_AudCb_t *pAudDoneCB);


/**
 * @brief This function is used to get the audio media file basic information
 *
 * @param  fileParam                    : File name lengthe and file name buffer
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
 esl_AudErrCode_e esl_AudGetFileInfoReq(esl_AudFileParam_t fileParam, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get the audio media memory basic information
 *
 * @param  memoryParam                  : audio format, buffer and length
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudGetMemoryInfoReq(esl_AudMemoryParam_t memoryParam, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
 esl_AudErrCode_e esl_AudGetStreamInfoReq(esl_AudStreamParam_t streamParam, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get the ID3V1 information of audio media file
 *
 * @param  fileParam                    : File name lengthe and file name buffer
 * @param  pID3Info                     : Buffer pointer to empty ID3 Info strucure
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudGetID3V1InfoReq(esl_AudFileParam_t fileParam, esl_AudID3V1Info_t *pID3Info, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get the lyrics information of audio media file
 *
 * @param  mode                         : The command indicates to read lyrics info size or read lyrics info data
 * @param  fileParam                    : File name lengthe and file name buffer
 * @param  pLyricsInfo                  : Buffer pointer to empty lyrics Info strucure
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudGetAdvancedInfoReq(esl_AudGetMode_e mode, esl_AudFileParam_t fileParam, esl_AudAdvancedInfo_t *pAdvancedInfo, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudRegNotifyReq(esl_AudNotifyType_e notifyType, esl_AudNotifyCb_t notifyCb, esl_AudCb_t *pAudCb);

#ifdef __BLUETOOTH_A2DP_DRV__
/**
 * @brief Register notify and command callback for A2DP palying
 *
 * @param notifyType                    : Notification selected type to register
 * @param notifyCb                      : Notification call back to info MMI when Multimedia task receivd notification.
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudRegA2dpReq(esl_AudA2dpCb_t a2dpCb, esl_AudCb_t *pAudCb);
#endif

/**
 * @brief This function is used for audio/voice recording, only AMR is supported currently
 *
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudRecStartReq(esl_AudRecParam_t recParam, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used terminate audio recording function
 *
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 ...
 * @return ESL_AUD_TIMEOUT              : Request command to MMP is no response
 */
esl_AudErrCode_e esl_AudRecStopReq(esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get recorded audio file name
 *
 * @param  fileParam                    : file type, name buffer pointer, and length
 * @param  pAudCb                       : Call back struct pointer, include sender task ID, userValue and call back function.
 *
 * @return ESL_AUD_OK                   : function request success
 * @return ESL_AUD_FAIL                 : function request fail
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudRecGetFileReq(esl_AudFileParam_t fileParam, esl_AudCb_t *pAudCb);


/**
 * @brief This function is used to get recorded remain time
 *
 * @param  recParam         : Property setting - codec type, sample rate, bitrate and storage path
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudRecGetRemainTimeReq(esl_AudRecTimeParam_t recTimeParam, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudRegPcmRecordCbReq(esl_AudPcmRecordCb *pfnCb, u32 userData, esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudStartPcmRecordReq(esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudStopPcmRecordReq(esl_AudCb_t *pAudCb);
 ...
 * @return ESL_AUD_ABORT                : Request aborted becuase of incorrect sequence
 */
esl_AudErrCode_e esl_AudSetMusicModeReq(esl_AudMusicMode_e mode, esl_AudCb_t *pAudCb);
