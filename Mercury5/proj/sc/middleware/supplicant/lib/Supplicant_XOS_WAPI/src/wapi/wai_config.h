...
/**
 * struct wai_peer_config - WAI peer configuration/credentials
 */
struct wai_peer_config {
	/**
...
#define WAI_CONFIG_FLAGS_PASSWORD_NTHASH BIT(0)
	/**
