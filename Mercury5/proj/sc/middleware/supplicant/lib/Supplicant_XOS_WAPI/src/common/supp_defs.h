...
#define WAPI_CIPHER_SMS4 BIT(5)                     //WAPI support
...
#define WAPI_KEY_MGMT_CERT BIT(10)
#define WAPI_KEY_MGMT_PSK BIT(11)
...
static inline int wpa_key_mgmt_wapi_cert(int akm)
{
	return akm == WAPI_KEY_MGMT_CERT;
}
...
typedef enum { WPA_ALG_NONE, WPA_ALG_WEP, WPA_ALG_TKIP, WPA_ALG_CCMP,
	       WPA_ALG_IGTK, WPA_ALG_PMK, WPA_ALG_SM4 } wpa_alg;
