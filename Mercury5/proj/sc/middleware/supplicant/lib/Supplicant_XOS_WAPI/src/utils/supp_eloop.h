...
/**
 * eloop_get_user_data - Post flag about any sock
 * Returns:
 */
void eloop_post_sock_flag(void);
/**
 * eloop_get_user_data - Post flag about any sock
 * Returns:
 */
void eloop_post_event_flag(void);

extern int eloop_register_msg(u32 mbox_src,
		void (*handler)(u32 mbox_src, void *eloop_ctx, void *sock_ctx, void *msg),
		void *eloop_data, void *user_data);
extern void eloop_post_msg_flag(void);		
#endif /* ELOOP_H */
