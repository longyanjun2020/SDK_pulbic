...
#include "supp_defs.h"
#include "supp_eapol_common.h"
#include "wapi_common.h"
#include "supp_wpa_common.h"
...
struct wpa_sm_ctx {
    ...
    u8 * (*alloc_wai)(void *ctx, u8 type, const void *data, u16 data_len,
                size_t *msg_len, void **data_pos);
...
//void wpa_sm_set_waiakm(struct wpa_sm *sm, struct waiakm_sm *waiakm);
int wpa_sm_set_assoc_wpa_ie(struct wpa_sm *sm, const u8 *ie, size_t len);
int wpa_sm_set_assoc_wapi_ie(struct wpa_sm *sm, const u8 *ie, size_t len);
...
int wpa_sm_rx_wai(struct wpa_sm *sm, const u8 *src_addr,
		    const u8 *buf, size_t len);
int wpa_sm_parse_own_wpa_ie(struct wpa_sm *sm, struct wpa_ie_data *data);
int wpa_sm_parse_own_wapi_ie(struct wpa_sm *sm, struct wpa_ie_data *data);

void wpa_wai_key_dump(u8 type, const union wai_key *key);
#else /* CONFIG_NO_WPA */
