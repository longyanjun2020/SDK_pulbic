...
struct GUI_DEVICE_API {
  ...
  void 	   (* pfSetCoordinateByRotateFlipMode)(GUI_DEVICE * pDevice, U8 RotateMode, U8 FlipMode);
  void 	   (* pfSetGetRectByRotateMode)(GUI_DEVICE * pDevice, U8 mode);
};
...
//extern const GUI_DEVICE_API GUIDRV_LIN_16_API; //Replaced by GUIDRV_LIN_16CCW_API.
extern const GUI_DEVICE_API GUIDRV_LIN_24_API;
//extern const GUI_DEVICE_API GUIDRV_LIN_ARGB32_API; //Replaced by GUIDRV_LIN_ARGB32CCW_API.
extern const GUI_DEVICE_API GUIDRV_LIN_ARGB32CCW_API;
extern const GUI_DEVICE_API GUIDRV_LIN_16CCW_API;
...
#define GUIDRV_LIN_16			  	  &GUIDRV_LIN_16CCW_API
#define GUIDRV_LIN_32			  	  &GUIDRV_LIN_ARGB32CCW_API
#endif
...
struct GUI_CONTEXT {
  ...
  U8   AlphaValue;                         // Alpha value for JPEG/BMP on ARGB8888
  U8   AlphaValueEnable;                   // Enable Alpha value or not
  U8   FontBkDisable;                      // Draw font only, don't draw background.
  U8   _DoFontBkDisable;                   // Draw font only, don't draw background.  

  U8   FlipDrawMode;                      // Enable left/right or up/down flip drawing.
  U8   RotateDrawMode;                    // Enable rotate 0, 90, 180, or 270 drawing.
...
void      GUI_SetAlphaValue(U8 alpha);
void      GUI_SetFontBkDisable(U8 bDisable);
U8        GUI_GetFontBkDisable(void);

typedef enum _GUI_COLORFORMAT {
    GUI_COLOR_RGB332 = 0,
    GUI_COLOR_RGB565,
    GUI_COLOR_RGB888,
    GUI_COLOR_ARGB32,
    GUI_COLOR_ARGB3454,
    GUI_COLOR_ARGB32_CCW,
    GUI_COLOR_RGB565_CCW
} GUI_COLORFORMAT;

#define   GUI_FLIP_DRAWING_NONE_ENABLE                       0x00
#define   GUI_FLIP_DRAWING_LR_ENABLE                         0x01
#define   GUI_FLIP_DRAWING_UD_ENABLE                         0x02
#define   GUI_FLIP_DRAWING_MASK                              0x0F

void      GUI_SetFlipDrawMode(U8 mode);

#define   GUI_ROTATE_DRAWING_0                               0x00
#define   GUI_ROTATE_DRAWING_90                              0x01
#define   GUI_ROTATE_DRAWING_180                             0x02
#define   GUI_ROTATE_DRAWING_270                             0x04
#define   GUI_ROTATE_DRAWING_MASK                            0x0F

void      GUI_SetRotateDrawMode(U8 mode);

void      GUI_SetColorIndex(int Index);

void 	  GUI_RegisterExternalFillRectCB(void *pExternalFillRectCB);
...
void  GUI_DispStringInRectSlide(const char GUI_UNI_PTR * s, GUI_RECT * pRect, int TextAlign, int *ps);
void  GUI_DispStringInRectSlide2(const char GUI_UNI_PTR * s, GUI_RECT * pRect, int TextAlign, int SpeedUp, int *ps);
...
int   GUI_GetLeadingBlankCols (U16 c); /* Currently not implemented in V5! */
int   GUI_GetTrailingBlankCols(U16 c); /* Currently not implemented in V5! */
...
void GUI_UC_DispStringAt(const U16 GUI_UNI_PTR *s, U16 x, U16 y);
...
int  GUI_SetLayerVSizeEx(unsigned LayerIndex, int xSize, int ySize);
...
// Configuration
//
void GUI__Config_Ex(U32 MemoryAddr,U32 GUI_NumBytes);

void GUI_X_Config(void);
void GUI_X_Init(void);

//swyang
void GUI_X_Config_Ex(U32 MemoryAddr,U32 GUI_NumBytes);
...
extern const GUI_BITMAP_METHODS GUI_BitmapMethods24_swap;
...
#define GUI_DRAW_BMP24SW &GUI_BitmapMethods24_swap     /* Method table ! */
