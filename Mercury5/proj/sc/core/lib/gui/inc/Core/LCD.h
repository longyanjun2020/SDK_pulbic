...
extern const LCD_API_COLOR_CONV LCD_API_ColorConv_M3454;
...
/*********************************************************************
*
*       Values for requesting function pointers (display driver)
*/
...
void GUI_CreateLayer(U32 OSDBufAddr,U32 OSDWidth, U32 OSDHeight, U32 ColorFormat, U32 LayerIndex);
...
/*********************************************************************
*
*       LCD_ Alpha value for jpeg/bmp in ARGB8888
*/
U8 LCD_GetAlphaValue(void);
void LCD_SetAlphaValue(U8 alpha);

U8 LCD_GetAlphaValueEnable(void);
void LCD_SetAlphaValueEnable(U8 alpha);
void LCD_SetFlipDrawMode( U8 mode);
void LCD_SetRotateDrawMode( U8 mode);
