...
#ifndef __AACPLUS_BASIC_OP_H
#define __AACPLUS_BASIC_OP_H


#include "mmpf_audio_typedef.h"
#include "aacplusdec_include.h"
//
...
extern Word16 etsiopround (Word32 L_var1);
...
//    }
//    var_out = aac_saturate (L_product_arr);
