...
#ifndef dec_ph_disp_h
#define dec_ph_disp_h "$Id $"
...
**************************************************************************
*/
int Decoder_ph_disp_init (ph_dispState *state);
...
**************************************************************************
*/
int Decoder_ph_disp_reset (ph_dispState *state);
...
**************************************************************************
*/
void Decoder_ph_disp_exit (ph_dispState *state);
...
**************************************************************************
*/
void Decoder_ph_disp_lock (ph_dispState *state);
...
**************************************************************************
*/
void Decoder_ph_disp_release (ph_dispState *state);
...
**************************************************************************
*/
void Decoder_ph_disp (
      ph_dispState *state, /* i/o     : State struct                     */
      enum Mode dec_mode,      /* i       : codec mode                       */
