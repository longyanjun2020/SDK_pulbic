...
********************************************************************************
*/
#ifndef dec_c_g_aver_h
#define dec_c_g_aver_h "$Id $"
...
**************************************************************************
*/
Word16 Decoder_Cb_gain_average_init (Cb_gain_averageState *st);
...
**************************************************************************
*/
Word16 Decoder_Cb_gain_average_reset (Cb_gain_averageState *st);
...
**************************************************************************
*/
void Decoder_Cb_gain_average_exit (Cb_gain_averageState *st);
...
**************************************************************************
*/
Word16 Decoder_Cb_gain_average (
