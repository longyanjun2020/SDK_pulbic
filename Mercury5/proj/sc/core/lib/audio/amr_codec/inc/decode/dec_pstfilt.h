...
********************************************************************************
*/
#ifndef dec_pstfilt_h
#define dec_pstfilt_h "$Id $"
...
int Decoder_Post_Filter_init (Post_FilterState *st);
...
int Decoder_Post_Filter_reset (Post_FilterState *st);
/* reset post filter (i.e. set state memory to zero)
   returns 0 on success
 */

void Decoder_Post_Filter_exit (Post_FilterState *st);
/* de-initialize post filter (i.e. free status struct)
   stores NULL in *s
 */

int Decoder_Post_Filter (
