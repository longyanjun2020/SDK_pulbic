...
********************************************************************************
*/
#ifndef dec_post_pro_h
#define dec_post_pro_h "$Id $"
...
int Decoder_Post_Process_init (Post_ProcessState *st);
...
int Decoder_Post_Process_reset (Post_ProcessState *st);
/* reset of Post processing state (i.e. set state memory to zero)
   returns 0 on success
 */
void Decoder_Post_Process_exit (Post_ProcessState *st);
/* de-initialize Post processing state (i.e. free status struct)
   stores NULL in *st
 */
 
int Decoder_Post_Process (
