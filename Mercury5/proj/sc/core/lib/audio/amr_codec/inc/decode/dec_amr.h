...
#include "dec_ec_gains.h"
#include "dec_ph_disp.h"
#include "dec_c_g_aver.h"
#include "dec_bgnscd.h"
#include "dec_lsp_avg.h"
#include "frame.h"
...
**************************************************************************
*/
int Decoder_amr_reset (Decoder_amrState *st,enum Mode dec_mode);
...
int Decoder_amr (
    ...
    Word16 dec_synth[],        /* o   : synthesis speech (L_FRAME)            */
