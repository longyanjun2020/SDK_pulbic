...
**************************************************************************
*/
Word16 Decoder_Bgn_scd_init (Bgn_scdState *st);
...
**************************************************************************
*/
Word16 Decoder_Bgn_scd_reset (Bgn_scdState *st);
...
**************************************************************************
*/
void Decoder_Bgn_scd_exit (Bgn_scdState *st);
...
**************************************************************************
*/
Word16 Decoder_Bgn_scd (Bgn_scdState *st,      /* i : State variables for bgn SCD         */
