...
********************************************************************************
*/
#ifndef dec_ec_gains_h
#define dec_ec_gains_h "$Id $"
...
**************************************************************************
*/
int Decoder_ec_gain_code_reset (
    ec_gain_codeState *state
);
...
**************************************************************************
*/
void Decoder_ec_gain_code_exit (
    ec_gain_codeState *state
);
...
**************************************************************************
*/
void Decoder_ec_gain_code_update (
    ec_gain_codeState *st,    /* i/o : State struct                     */
...
**************************************************************************
*/
int Decoder_ec_gain_pitch_init (
...
**************************************************************************
*/
int Decoder_ec_gain_pitch_reset (
    ec_gain_pitchState *state
);
...
**************************************************************************
*/
void Decoder_ec_gain_pitch_exit (
    ec_gain_pitchState *state
);
...
**************************************************************************
*/
void Decoder_ec_gain_pitch_update (
    ec_gain_pitchState *st, /* i/o : state variables                   */
    Word16 bfi,             /* i   : flag: frame is bad               */
    Word16 prev_bf,         /* i   : flag: previous frame was bad     */
