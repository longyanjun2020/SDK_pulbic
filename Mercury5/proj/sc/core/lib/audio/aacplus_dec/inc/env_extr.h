...
//  Word16 limiterBandTable[MAX_NUM_LIMITERS+1]; /*!< Limiter band table. */
  Word16 *limiterBandTable; /*!< Limiter band table. */
...
//  Word16  prevNoiseLevel[MAX_NOISE_COEFFS]; /*!< Previous noise envelope (required for differential-coded values) */
  Word16  *sfb_nrg_prev;  			/*!< Previous envelope (required for differential-coded values) */
  Word16  *prevNoiseLevel; 			/*!< Previous noise envelope (required for differential-coded values) */
