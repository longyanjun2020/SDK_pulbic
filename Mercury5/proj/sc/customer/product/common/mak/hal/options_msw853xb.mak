...
ifneq ($(filter __MSW8533BN__, $(CHIP_TYPE)),)
CHIP_NAND = TRUE
endif
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8532B__, $(CHIP_TYPE)),)
CHIP_SUPPORT_BUS_FSP_SPI = TRUE
endif
ifneq ($(filter __MSW8532B2__, $(CHIP_TYPE)),)
CHIP_SUPPORT_BUS_FSP_SPI = TRUE
endif
ifneq ($(filter __MSW8532BL__, $(CHIP_TYPE)),)
CHIP_SUPPORT_BUS_FSP_SPI = TRUE
endif
...
CHIP_STORAGE_IP = CHIP_STG_IP_FCIE
...
ifneq ($(filter __MSW8533BD__, $(CHIP_TYPE)),)
CHIP_SPI_RESET_BY_OFF_VMEM = FALSE
endif
ifneq ($(filter __MSW8532B__, $(CHIP_TYPE)),)
...
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8533BN__, $(CHIP_TYPE)),)
CHIP_CAMERA_SUPPORT_2M_BYPASS_SCALER = TRUE
endif
ifneq ($(filter __MSW8532B2__, $(CHIP_TYPE)),)
CHIP_CAMERA_SUPPORT_2M_BYPASS_SCALER = TRUE
endif
...
BOOTLOADER = bootloader_MSW853xb.ldr
...
BOOTSTRAP = bootstrap_MSW853xb.bst
...
ifneq ($(filter __MSW8533BN__, $(CHIP_TYPE)),)
CHIP_SCATTER = scatter_8533bn_nand
endif
ifneq ($(filter __MSW8533BD__, $(CHIP_TYPE)),)
CHIP_SCATTER = scatter_8533bd_64_32
endif
ifneq ($(filter __MSW8532B__, $(CHIP_TYPE)),)
CHIP_SCATTER = scatter_8532b_64_32
endif
ifneq ($(filter __MSW8532B2__, $(CHIP_TYPE)),)
CHIP_SCATTER = scatter_8532b_64_32
endif
...
# Option_Selection = 8533C,8533N,8533CN,8536N,8532,8533D,8532B,8532B2,8533BN,8533BD
ifneq ($(filter __MSW8532B__, $(CHIP_TYPE)),)
DZ_COMPATIBLE_CHIP = 8532B2
endif
ifneq ($(filter __MSW8532BL__, $(CHIP_TYPE)),)
DZ_COMPATIBLE_CHIP = 8532B2+8532B
endif
...
ifneq ($(filter __MSW8533BD__, $(CHIP_TYPE)),)
MCPCONFIG_XML_FILE = msw8533bd/default_8533bd.xml
endif
ifneq ($(filter __MSW8532B__, $(CHIP_TYPE)),)
MCPCONFIG_XML_FILE = msw8532b/default_8532b.xml
endif
ifneq ($(filter __MSW8532B2__, $(CHIP_TYPE)),)
MCPCONFIG_XML_FILE = msw8532b/default_8532b.xml
endif
...
ifneq ($(filter __MSW8533BD__, $(CHIP_TYPE)),)
MCPCONFIG_PAGE_PRM = msw8533bd/MemSettings.prm
endif
