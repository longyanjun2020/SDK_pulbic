...
ifneq ($(filter __MSW8533N__, $(CHIP_TYPE)),)
CHIP_NAND = TRUE
endif
ifneq ($(filter __MSW8533CN__, $(CHIP_TYPE)),)
CHIP_NAND = TRUE
endif
ifneq ($(filter __MSW8536N__, $(CHIP_TYPE)),)
CHIP_NAND = TRUE
endif
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_TINY_CMD_ADC_CALIBRATION = FALSE
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_SUPPORT_BUS_FSP_SPI = FALSE
...
CHIP_STORAGE_IP = CHIP_STG_IP_FCIE_SDIO
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_WATCHDOG_RESET_PATCH = TRUE
...
ifneq ($(filter __MSW8536N__, $(CHIP_TYPE)),)
CHIP_APP_TIMESTETCH = USE_APP_TIMESTRETCH
endif
ifneq ($(filter __MSW8533N__, $(CHIP_TYPE)),)
...
ifneq ($(filter __MSW8533C__, $(CHIP_TYPE)),)
CHIP_APP_TIMESTETCH = NULL
endif
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_MMI_SMALL_CALLER_PHOTO = FALSE
...
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8533N__, $(CHIP_TYPE)),)
CHIP_WQVGA_RECORD_SUPPORTED = TRUE
endif
ifneq ($(filter __MSW8533CN__, $(CHIP_TYPE)),)
CHIP_WQVGA_RECORD_SUPPORTED = TRUE
endif
...
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8536N__, $(CHIP_TYPE)),)
CHIP_HVGA_RECORD_SUPPORTED = TRUE
endif
...
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8533N__, $(CHIP_TYPE)),)
CHIP_KING_MOVIE_SUPPORT_HVGA_MMI = TRUE
endif
ifneq ($(filter __MSW8533CN__, $(CHIP_TYPE)),)
CHIP_KING_MOVIE_SUPPORT_HVGA_MMI = TRUE
endif
...
# Option_Selection = TRUE, FALSE
ifneq ($(filter __MSW8536N__, $(CHIP_TYPE)),)
CHIP_AUTO_FOCUS_SUPPORTED = TRUE
endif
...
BOOTLOADER = bootloader_MSW8533x.ldr
...
BOOTSTRAP = bootstrap_MSW8533x.bst
...
# Option_Selection = 8533C,8533N,8533CN,8536N,8532,8533D,8532B,8532B2,8533BN,8533BD
ifneq ($(filter __MSW8533N__, $(CHIP_TYPE)),)
DZ_COMPATIBLE_CHIP = 8536N
endif
ifneq ($(filter __MSW8533CN__, $(CHIP_TYPE)),)
DZ_COMPATIBLE_CHIP = 8533N+8536N
endif
...
ifneq ($(filter __MSW8533C__, $(CHIP_TYPE)),)
MCPCONFIG_XML_FILE = msw8533x/default_8533x.xml
endif
...
ifneq ($(filter __MSW8533C__, $(CHIP_TYPE)),)
MCPCONFIG_PAGE_PRM = msw8533x/MemSettings.prm
endif
