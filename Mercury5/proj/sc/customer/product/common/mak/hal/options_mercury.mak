...
# Feature_Name = Infinity Watchdog support
# Description = Option for R2 Watchdog support
# Pre_Variable_True = N/A
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_CHIPDRV_INFINITY_WDT = TRUE
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_V24_SOFT_FC_XAUTO_MODE = FALSE
...
# Pre_Variable_False = N/A
# Option_Selection = TRUE, FALSE
CHIP_NULL_READ_WRITE_EXEC_PROTECT = FALSE
...
ifneq ($(filter __MSC316D__, $(CHIP_TYPE)),)
CHIP_SCATTER = scatter_316d_16_128
endif
...
ifneq ($(filter __I_SW__, $(PP_OPT_COMMON)),)
CHIP_SCATTER := $(CHIP_SCATTER)_isw
endif

ifneq ($(filter __ISW_NORBOOT__, $(PP_OPT_COMMON)),)
CHIP_SCATTER := $(CHIP_SCATTER)_norboot
endif
