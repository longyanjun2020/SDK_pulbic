#-------------------------------------------------------------------------------
# Define all version information for compilation
...
UNDERLINE:=_
EMPTY:=
CHIPNAME=$(subst $(UNDERLINE),$(EMPTY),$(CHIP_TYPE))
...
VERSION=$(PRODUCT_ID)$(SRT)$(CUST_ID)$(SRT)$(CHIPNAME)$(SRT)$(STACK)$(SRT)$(YYTWyyww)$(SRT)$(SW_MAJ_VER)$(SRT)$(SW_MIN_VER)$(SRT)$(HW_VER)$(SRT)
