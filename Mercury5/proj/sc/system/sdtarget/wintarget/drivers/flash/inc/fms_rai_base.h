...
#define FLASH_DATA_TO_ITEM_SIZE(size) ((fms_rai_size_t)((size) + offsetof (frai_item_t, b.data) - sizeof (frai_header_t)))
#define FLASH_ITEM_TO_DATA_SIZE(size) ((fms_rai_size_t)((size) - offsetof (frai_item_t, b.data) + sizeof (frai_header_t)))
