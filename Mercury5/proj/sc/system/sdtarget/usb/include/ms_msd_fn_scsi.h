...
U8 FnRdFmtCap_Command(MSDFN_BOT_CBW_STRU *cbw,U32 noblk,U32 blksize,USB_VAR *gUSBStruct);
U8 FnRdCap_Command(MSDFN_BOT_CBW_STRU *cbw,U32 noblk,U32 blksize,USB_VAR *gUSBStruct);
#ifdef  CYGFUN_ENABLE_NAND
U8 FnNAND_READNANDINFO_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
U8 FnNAND_RESETNANDINFO_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
U8 FnNAND_ERASEBLOCK_Command(MSDFN_BOT_CBW_STRU *cbw);
U8 FnNAND_READPHYPAGE_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
U8 FnNAND_WRITEPHYPAGE_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
U8 FnNAND_WRITERDD_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
U8 FnNAND_EJECT_INSERT_Command(MSDFN_BOT_CBW_STRU *cbw);
#endif
U8 FnVendor_TEST_Command(MSDFN_BOT_CBW_STRU *cbw, USB_VAR *gUSBStruct);
