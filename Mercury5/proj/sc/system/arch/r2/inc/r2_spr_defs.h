...
#ifndef __R2_SPR_DEFS_H__
#define __R2_SPR_DEFS_H__
...
#define SPRGROUP_UTLB	(14<< MAX_SPRS_PER_GRP_BITS)	 /* UTLB */
...
#define SPR_CONTEXT_SAVE0	(SPRGROUP_SYS + 4)
#define SPR_CONTEXT_SAVE1	(SPRGROUP_SYS + 5)
#define SPR_CONTEXT_SAVE2	(SPRGROUP_SYS + 6)
#define SPR_CONTEXT_SAVE3	(SPRGROUP_SYS + 7)
...
#define SPR_EPOS		(SPRGROUP_SYS + 80)	/* Exception Byte Position Register */
#define SPR_EACC		(SPRGROUP_SYS + 81)	/* Exception Access Register */
#define SPR_ETYPE		(SPRGROUP_SYS + 82)	/* Exception Type Register */
#define SPR_FILL_UDTLB  (SPRGROUP_SYS + 90)
#define SPR_FILL_UITLB  (SPRGROUP_SYS + 91)
#define SPR_FLUSH_UDTLB (SPRGROUP_SYS + 92)
#define SPR_FLUSH_UITLB (SPRGROUP_SYS + 93)
...
#define SPR_PICPMR	(SPRGROUP_PIC + 4)	/* PIC Status Register */
