...
#define DECLARE_MDrv_PQ_GetIPNum_(PQTABLE_NAME) \
    extern u16 MDrv_PQ_GetIPNum_##PQTABLE_NAME(void);
...
#define DECLARE_MDrv_PQ_GetTableNum_(PQTABLE_NAME) \
    extern u16 MDrv_PQ_GetTableNum_##PQTABLE_NAME(u8 u8PQIPIdx);
...
#define DECLARE_MDrv_PQ_GetTable_(PQTABLE_NAME) \
    extern EN_IP_Info MDrv_PQ_GetTable_##PQTABLE_NAME(u8 u8TableIdx,u8 u8TabIdx, u8 u8PQIPIdx);

#define INSTALL_MDrv_PQ_GetTable_(PQTABLE_NAME) \
    EN_IP_Info MDrv_PQ_GetTable_##PQTABLE_NAME(u8 u8TableIdx,u8 u8TabIdx, u8 u8PQIPIdx){ \
...
#define DECLARE_MDrv_PQ_AddTable_(PQTABLE_NAME) \
    extern void MDrv_PQ_AddTable_##PQTABLE_NAME(u8 u8TableIdx,PQTABLE_INFO *pPQTableInfo);


#define INSTALL_MDrv_PQ_AddTable_(PQTABLE_NAME) \
    void MDrv_PQ_AddTable_##PQTABLE_NAME(u8 u8TableIdx,PQTABLE_INFO *pPQTableInfo){ \
...
#define DECLARE_MDrv_PQ_LoadTableByData_(PQTABLE_NAME) \
    extern void MDrv_PQ_LoadTableByData_##PQTABLE_NAME(u8 u8TableIdx,u16 u16PQSrcType, u8 u8PQIPIdx, PQ_DATA_INFO *pData);

#define INSTALL_MDrv_PQ_LoadTableByData_(PQTABLE_NAME) \
    void MDrv_PQ_LoadTableByData_##PQTABLE_NAME(u8 u8TableIdx,u16 u16PQSrcType, u8 u8PQIPIdx, PQ_DATA_INFO *pData){ \
...
#define DECLARE_MDrv_PQ_GetXRuleIPNum_(PQTABLE_NAME) \
    extern u8 MDrv_PQ_GetXRuleIPNum_##PQTABLE_NAME(u8 u8XRuleType);
...
#define DECLARE_MDrv_PQ_GetGRule_TableIndex_(PQTABLE_NAME) \
    extern u8 MDrv_PQ_GetGRule_TableIndex_##PQTABLE_NAME(u8 u8GRuleType, u8 u8PQSrcType, u8 u8PQ_NRIdx, u8 u8GRuleIPIndex);
...
#define DECLARE_MDrv_PQ_Set_MLoadEn_(PQTABLE_NAME) \
    extern void MDrv_PQ_Set_MLoadEn_##PQTABLE_NAME(bool bEn);

#define INSTALL_MDrv_PQ_Set_MLoadEn_(PQTABLE_NAME) \
    void MDrv_PQ_Set_MLoadEn_##PQTABLE_NAME(bool bEn){ \
...
#define DECLARE_MDrv_PQ_LoadPictureSetting_(PQTABLE_NAME) \
    extern bool MDrv_PQ_LoadPictureSetting_##PQTABLE_NAME(u8 u8TabIdx, u8 u8PQIPIdx, void *pTable, u16 u16TableSize);

#define INSTALL_MDrv_PQ_LoadPictureSetting_(PQTABLE_NAME) \
    bool MDrv_PQ_LoadPictureSetting_##PQTABLE_NAME(u8 u8TabIdx, u8 u8PQIPIdx, void *pTable, u16 u16TableSize){ \
...
//[Daniel]
#include "Mercury5_Main.h"              // table config parameter
#include "Mercury5_Main_HSPRule.h"      // table config parameter
#include "Mercury5_Main_VSPRule.h"      // table config parameter
#include "Mercury5_Main_GRule.h"        // table config parameter

#include "M5_DSPY.h"              // table config parameter
#include "M5_DSPY_HSPRule.h"      // table config parameter
#include "M5_DSPY_VSPRule.h"      // table config parameter
#include "M5_DSPY_GRule.h"        // table config parameter
