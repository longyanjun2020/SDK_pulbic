...
MS_BOOL OSAL_HVD_ISR_Attach(MS_BOOL isHVDIsr, void* pfnISRCB);
MS_BOOL OSAL_HVD_ISR_Detach(MS_BOOL isHVDIsr);
MS_BOOL OSAL_HVD_ISR_Enable(MS_BOOL isHVDIsr);
MS_BOOL OSAL_HVD_ISR_Disable(MS_BOOL isHVDIsr);
