...
#define SPARE_SIZE       gtSpinandInfo.nSpareByteCnt
#define BLOCK_PAGE_SIZE  gtSpinandInfo.nBlkPageCnt
#define SECTOR_SIZE      gtSpinandInfo.nSectorByteCnt
#define PAGE_SIZE        gtSpinandInfo.nPageByteCnt
#define PLANE            gtSpinandInfo.nPlaneCnt
#define CLKCFG           gtSpinandInfo.nCLKConfig
#define READ_MODE        gtSpinandInfo.nReadMode
#define WRITE_MODE       gtSpinandInfo.nWriteMode
