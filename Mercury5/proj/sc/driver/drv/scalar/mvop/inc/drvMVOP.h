...
#define MSIF_MVOP_LIBVER                {'0','6'}            //LIB version
#define MSIF_MVOP_BUILDNUM              {'2','3'}            //Build Number
#define MSIF_MVOP_CHANGELIST            {'0','0','4','7','8','2','5','6'} //P4 ChangeList Number
...
typedef void (*PfnMVOPIntcISR)(void);
...
typedef struct
{
    ...
    MS_BOOL bYUV_RGB_SEL;    //YUV or RGB 
...
typedef enum
{
    ...
    E_MVOP_CMD_SET_3DLR_INST_VBLANK, ///< Vertical blanking lines between L & R for 3D L/R mode.
    E_MVOP_CMD_SET_3DLR_ALT_OUT,     ///< Alternative lines output for 3D L/R mode.
} MVOP_Command;
...
typedef enum
{
    ...
    E_MVOP_FREERUNMODE,
     ...
     E_MVOP_216MHZ = 216000000ul,
     E_MVOP_240MHZ = 240000000ul,
     E_MVOP_288MHZ = 288000000ul,
...
//-------------------------------------------------------------------------------------------------
MS_U32 Drv_MVOP_RegisterRead(MS_U32 u32Addr);
...
void MDrv_MVOP_SetBlackBG(MS_BOOL bEnBG);

void MDrv_MVOP_EnableUVShift(MS_BOOL bEnable);
void MDrv_MVOP_SetMonoMode(MS_BOOL bEnable);

MS_BOOL MDrv_MVOP_AttachInterrupt (MS_U32 eIntNum, PfnMVOPIntcISR pIntCb,unsigned long flags,const char *name);
MS_BOOL MDrv_MVOP_DetachInterrupt (MS_U32 eIntNum);
MS_BOOL MDrv_MVOP_EnableInterrupt (MS_U32 eIntNum);
MS_BOOL MDrv_MVOP_DisableInterrupt (MS_U32 eIntNum);
MS_BOOL MDrv_MVOP_UnMaskInterrupt (E_MVOP_INT_STATUS enMvopIntSts);
MS_BOOL MDrv_MVOP_MaskInterrupt (E_MVOP_INT_STATUS enMvopIntSts);
MS_BOOL MDrv_MVOP_GetInterruptStatus (E_MVOP_INT_STATUS enMvopIntSts);
