...
#if defined(__I_SW__)
JpeDev_t*           JpeProbe(JpeDev_t* pDev, void* pCBFunc, int nClkRate);
JpeCtx_t*           JpeOpen(JpeDev_t* pDev, JpeCtx_t* pCtx);
JpeIocRetStatus_e   JpeRelease(JpeDev_t* pDev, JpeCtx_t* pCtx);
JpeIocRetStatus_e   JpeRemove(JpeDev_t* pDev);
JpeIocRetStatus_e   JpeCtxActions(JpeCtx_t*, unsigned int, void*);
