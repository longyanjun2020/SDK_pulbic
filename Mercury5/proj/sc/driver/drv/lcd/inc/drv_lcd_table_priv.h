...
typedef s32 (*fp_tbl_detect_t)(search_table_param_t *pSearchParam, lcdtbl_hdr_t *pLcdTblHdr);
...
#if defined (__CUS_LCM_TABLE_DRV__)
static s32 DrvLcdTbl_DetectLCM(search_table_param_t *pSearchParam, lcdtbl_hdr_t *pLcdTblHdr);
#endif

#if defined (__CUS_DISPLAY_TABLE_DRV__)
static s32 DrvLcdTbl_DetectDispTbl(search_table_param_t *pSearchParam, lcdtbl_hdr_t *pLcdTblHdr);
#endif
