...
#define NC_REG_MIU_LAST_DONE_ST    NC_PATH_CTL
#define NC_CLR_MIU_LAST_DONE()   
#define NC_MASK_INT_MIU_LAST_DONE() 

#define REG50_ECC_CTRL_INIT_VALUE    (BIT_NC_SHARE_PAD_EN)
#define REG30_TEST_MODE_INIT_VALUE   0x5800

#define ECC_ALLOWED_MAX_BITS_CNT      4
...
// no MIU_CLK_CTRL
#define NC_MMA_PRI_REG_SET_W()        REG_SET_BITS_UINT16(NC_MMA_PRI_REG, BIT_NC_DMA_DIR_W|BIT_NC_MIU_BURST_16);
#define NC_MMA_PRI_REG_SET_R()        REG_CLR_BITS_UINT16(NC_MMA_PRI_REG, BIT_NC_DMA_DIR_W);
#define NC_HAL_POST_HANDLER()         {} 
...
#if defined(__WINTARGET__)
#define ASSERT_FTL_ACCESS_BLK0         1
#define ASSERT_FTL_LBA_NOT_MAP         1
#else
#define ASSERT_FTL_ACCESS_BLK0         0
#define ASSERT_FTL_LBA_NOT_MAP         0
#endif
...
#define nand_printf    utl_printf//mem_printf//printf
