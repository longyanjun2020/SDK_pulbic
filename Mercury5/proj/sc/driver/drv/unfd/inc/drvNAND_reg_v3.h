...
#define NC_PATCH_EN         GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x36)
...
#define NC_REG_57h          GET_REG_ADDR(FCIE_REG_BASE_ADDR, 0x57)
...
#if (defined(NAND_DRV_B5_RTK) && NAND_DRV_B5_RTK) || \
	(defined(NAND_DRV_B5_ROM) && NAND_DRV_B5_ROM)
...
#if (defined(NAND_DRV_B5_RTK) && NAND_DRV_B5_RTK) || \
	(defined(NAND_DRV_B5_ROM) && NAND_DRV_B5_ROM)
#define BIT_NC_MIU_CLK_EN_SW       BIT12
#define BIT_NC_MIU_CLK_EN_HW       BIT13 
#define BIT_NC_MIU_CTRL_SW         BIT14 // 1:SW, 0:HW   reg_miu_clk_ctl_sw
#define BIT_NC_MIU_CLK_FREE        BIT15
#endif
...
#if (defined(NAND_DRV_B3_RTK) && NAND_DRV_B3_RTK) || \
	(defined(NAND_DRV_B3_ROM) && NAND_DRV_B3_ROM) || \
	(defined(NAND_DRV_G1_RTK) && NAND_DRV_G1_RTK) || \
	(defined(NAND_DRV_G1_ROM) && NAND_DRV_G1_ROM)
...
/* NC_REG_57h*/
#define BIT_NC_PATCH_WAIT_RB_EN    BIT0 // for B3 G1
#define BIT_NC_PATCH_JOB_START_EN  BIT1 // for B3 G1
#define BIT_NC_DAT_LATCH_SEL_MASK  (BIT2|BIT1|BIT0)
#define BIT_NC_DAT_LATCH_0_5T      BIT0
#define BIT_NC_DAT_LATCH_1T        BIT1
#define BIT_NC_ST_LATCH_SEL_MASK   (BIT6|BIT5|BIT4)
#define BIT_NC_ST_LATCH_1T         BIT4
