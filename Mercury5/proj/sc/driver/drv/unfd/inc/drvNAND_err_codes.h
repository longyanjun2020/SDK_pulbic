...
#define  UNFD_ST_ERR_W_TIMEOUT            (0x004F | UNFD_ST_PLAT)
...
#define  UNFD_ST_ERR_SEMAPHORE            (0x0043 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_FTL_NOT_FORMAT       (0x0044 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_FTL_NO_ROOT_BLK      (0x0045 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_FTL_VERSION_MISS     (0x0046 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_NOT_ALIGN            (0x0047 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_NOT_PACKED           (0x0048 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_FAT_SHIFT            (0x0049 | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_NO_FREE_BLK_FOR_RD   (0x004A | UNFD_ST_PLAT)
#define  UNFD_ST_ERR_EC_SHIFT             (0x004B | UNFD_ST_PLAT)
