...
#ifndef __DRV_UNFD_API_H__
#define __DRV_UNFD_API_H__
...
extern U32 drvNAND_LoadOS(U32 u32_SrcPhyAddr, U32 u32_StartSector, U32 u32_SectorCnt);
...
extern U32 drvNAND_WriteHFAT(U32 u32_SrcPhyAddr, U32 u32_StartSector, U32 u32_SectorCnt);
extern U32 drvNAND_ReadHFAT(U32 u32_SrcPhyAddr, U32 u32_StartSector, U32 u32_SectorCnt);
extern U32 drvNAND_IfHiddenFATExist(void);
extern U32 drvNAND_GetHFATCapacity(void);
...
extern U32 drvNAND_WriteCustomerID(U8 *pu8_CISCID, U8 len);
extern U32 drvNAND_ReadCustomerID(U8 *pu8_CISCID,U8 *return_len);

#endif /* __DRV_UNFD_API_H__ */
