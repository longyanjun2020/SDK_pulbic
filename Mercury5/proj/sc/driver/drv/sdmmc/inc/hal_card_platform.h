...
void Hal_CARD_InitPADPin(PADEmType ePAD);
void Hal_CARD_PullPADPin(PADEmType ePAD, PinPullEmType ePinPull);
...
//----------------------------------------------------------------------------------------------------------
volatile U32_T Hal_CARD_TransMIUAddr(U32_T u32Addr);
