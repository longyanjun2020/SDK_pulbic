...
void Hal_SDMMC_SetSDRSCanVal(IPEmType eIP, U8_T u8Skew4, U8_T u8Skew4Inv);
void Hal_SDMMC_SetDDRScanVal(IPEmType eIP, U8_T u8DQS_Mode, U8_T u8DQS_DLY_Sel);
...
void Hal_SDMMC_GlobalInit(IPEmType eIP);
