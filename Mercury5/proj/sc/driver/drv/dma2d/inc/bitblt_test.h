...
//#if (defined(__ENABLE_DMA2D_HW__) && !defined(__SDK_SIMULATION__))
	...
	u32 FillSolidRectQuickDMA2D(PMSBLT_FILLSOLID pParam);
	u32 DMA2DCmdFinish();
...
//#if (defined(__ENABLE_DMA2D_HW__) && !defined(__SDK_SIMULATION__))
	...
	extern u32 FillSolidRectQuickDMA2D(PMSBLT_FILLSOLID pParam);
    extern s32 FadeOutDMA2D(PMSBLT_BITBLT pParam);
	extern u32 DMA2DCmdFinish(void);
    void PrintOutBitbltTime(void);
