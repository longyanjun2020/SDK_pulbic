...
/* drvMsg.c */
extern void ms_usb_disable_endpoint (struct usb_device *, U32, BOOL);
extern void ms_usb_disable_interface (struct usb_device *,
		struct usb_interface *, BOOL);
extern void ms_usb_disable_device (struct usb_device *pDev, int skip_ep0);
extern void ms_usb_enable_endpoint (struct usb_device *,
		struct usb_host_endpoint *, BOOL);
extern void ms_usb_enable_interface (struct usb_device *,
		struct usb_interface *, BOOL);
...
extern int ms_is_generic_driver(struct device_driver *);
...
extern void ms_usb_ep0_reinit(struct usb_device *);
...
extern MS_BOOL ms_USBCriticalSectionIn(MS_U8 Port);
extern MS_BOOL ms_USBCriticalSectionIn_TimeOut(MS_U8 Port, MS_U32 WaitMs);
