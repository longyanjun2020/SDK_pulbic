...
//******************************************************************************
//<MStar Software>
#ifndef _DRVUSB_RTK_H
#define _DRVUSB_RTK_H
...
#define USB_MASS_STORAGE_SUPPORT 	0

#define USB_HID_SUPPORT             0

#define USB_OTG_SWITCH_SUPPORT		0
/*
 * Extended Function support
 */
//#define UHC_TASK_START_AT_POWER_ON
 ...
 * u8Event: 1=plug, 2=unplug, ... can extend later;
 ...
 * u32Para: not used
 */
void MDrv_USB_HotPlug_RegisterCallBack (USBCallback pCallbackFn);

/* for MDrv_OverCurrentDetect_RegisterCallBack()
 * u8Event: 1=over current, ... can extend later;
 * u32Para: port number
 */
