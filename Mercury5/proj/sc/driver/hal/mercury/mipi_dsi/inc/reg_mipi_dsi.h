...
#ifndef __HAL_MIPI_TX_DSI_REG_H__
#define __HAL_MIPI_TX_DSI_REG_H__

#define DSI_REG_BASE    0x1A2100  // 0x1400 - 0x14FF
#define DSI_REG_BASE_2    0x344200  // 0x1400 - 0x14FF
#define DSI_CMDQ_BASE    0x1A2200  // 0x1400 - 0x14FF
#define DSI_CMDQ_BASE_2    0x344400  // 0x1400 - 0x14FF
#define REG_CHIPTOP_BASE        0x101E00  //
#define REG_CKG_BASE        0x103800  //
#define DSI_DPHY_REG_BASE    0x161200  // 0x1400 - 0x14FF
#define REG_LPLL_BASE       0x103300  //

#define REG_PNL_BASE        0x162200  //
...
#define REG_CHIPTOP_16     BK_REG(0x16)
#define CHIPTOP_PAD_TX_MODE     (REG_CHIPTOP_BASE+REG_CHIPTOP_16)
    #define MIPITX_4LANE_MODE       BITS(1:0,2)
    #define MIPITX_2LANE_MODE       BITS(1:0,1)
    #define MIPITX_PAD_MASK       BITMASK(1:0)

#define REG_CHIPTOP_4A     BK_REG(0x4A)    //LCD IE
#define REG_CHIPTOP_4B     BK_REG(0x4B)    //LCD IE
#define REG_CHIPTOP_4C     BK_REG(0x4C)    //LCD PE
#define REG_CHIPTOP_4D    BK_REG(0x4D)     //LCD PE
#define REG_CHIPTOP_4E     BK_REG(0x4E)    //LCD PS
#define REG_CHIPTOP_4F    BK_REG(0x4F)     //LCD PS

#define REG_CHIPTOP_5B     BK_REG(0x5B)  //SNR0 IE
#define REG_CHIPTOP_5C     BK_REG(0x5C)  //SNR0 PE
#define REG_CHIPTOP_5D    BK_REG(0x5D)  //SNR0 PS
...
#define CLKG_MCU_CLK_CTRL0     (REG_CKG_BASE+BK_REG(0x01))
#define CLKG_TX_DSI_CLK_CTRL0     (REG_CKG_BASE+BK_REG(0x55))
    #define CKG_TX_DSI_CLK_DIS_CLK             BIT(0)
    #define CKG_TX_DSI_CLK_INV_CLK             BIT(1)
    #define CKG_TX_DSI_CLK_MPLL_240M             BITS(4:2,5)
    #define CKG_TX_DSI_CLK_MPLL_216M            BITS(4:2,4)
    #define CKG_TX_DSI_CLK_MPLL_160M            BITS(4:2,1)
    #define CKG_TX_DSI_CLK_MPLL_144M            BITS(4:2,2)
    #define CKG_TX_DSI_CLK_MPLL_108M            BITS(4:2,3)
    #define CKG_TX_DSI_CLK_LPLL_CLK                BITS(4:2,0)
...
// D-PHY Setting
//------------------------------------------------------------------------------
#define DPHY_DSI_REG00     (DSI_DPHY_REG_BASE+BK_REG(0x0))
    #define DPHY_PD_LDO   BIT(6) //power down LPTX VREG
    #define DPHY_SW_RST   BIT(0)  //local SW reset, active low

#define DPHY_DSI_REG01     (DSI_DPHY_REG_BASE+BK_REG(0x1))
    #define DPHY_PD_ID_DPHY   BIT(0) //PD HS mode
    #define DPHY_PD_DPHY   BIT(1) //PD whole D-phy analog

#define DPHY_DSI_REG03     (DSI_DPHY_REG_BASE+BK_REG(0x3))

#define DPHY_DSI_REG04     (DSI_DPHY_REG_BASE+BK_REG(0x4))
#define DPHY_DSI_REG06     (DSI_DPHY_REG_BASE+BK_REG(0x6))

#define DPHY_DSI_REG08     (DSI_DPHY_REG_BASE+BK_REG(0x8))

#define DPHY_DSI_REG0A     (DSI_DPHY_REG_BASE+BK_REG(0xA))

#define DPHY_DSI_REG0c     (DSI_DPHY_REG_BASE+BK_REG(0x0c))

#define DPHY_DSI_REG0E     (DSI_DPHY_REG_BASE+BK_REG(0xE))

#define DPHY_DSI_REG14     (DSI_DPHY_REG_BASE+BK_REG(0x14))

#define DPHY_DSI_REG1C     (DSI_DPHY_REG_BASE+BK_REG(0x1C))

#define DPHY_DSI_REG1D     (DSI_DPHY_REG_BASE+BK_REG(0x1D))

#define DPHY_DSI_REG20     (DSI_DPHY_REG_BASE+BK_REG(0x20))


#define DPHY_DSI_REG22     (DSI_DPHY_REG_BASE+BK_REG(0x22))

#define DPHY_DSI_REG23     (DSI_DPHY_REG_BASE+BK_REG(0x23))

#define DPHY_DSI_REG25     (DSI_DPHY_REG_BASE+BK_REG(0x25))

#define DPHY_DSI_REG35     (DSI_DPHY_REG_BASE+BK_REG(0x35))
...
#define REG_LPLL_40      BK_REG(0x40)
#define REG_LPLL_41      BK_REG(0x41)
#define REG_LPLL_42      BK_REG(0x42)
#define REG_LPLL_43      BK_REG(0x43)
#define REG_LPLL_44      BK_REG(0x44)
#define REG_LPLL_45      BK_REG(0x45)

#define LPLL_EXT_0     (REG_LPLL_BASE+BK_REG(0x40))
#define LPLL_EXT_DIV     (REG_LPLL_BASE+BK_REG(0x41))

#define LPLL_EXT_DIV     (REG_LPLL_BASE+BK_REG(0x41))

#endif /* __HAL_MIPI_TX_DSI_REG_H__ */
