...
INTERFACE void DrvSclDmaSetLineOffsetEn(DrvSclDmaClientType_e enClientType,bool bEn);
INTERFACE bool DrvSclDmaSetYLineOffsetConfig(DrvSclDmaClientType_e enClientType, u16 u16LineOffset);
INTERFACE bool DrvSclDmaSetCLineOffsetConfig(DrvSclDmaClientType_e enClientType, u16 u16LineOffset);
INTERFACE void DrvSclDmaSetMatchLineV1(DrvSclDmaClientType_e enClientType, u16 u16MatchLine);
INTERFACE void DrvSclDmaSetMatchLineV2(DrvSclDmaClientType_e enClientType, u16 u16MatchLine);
