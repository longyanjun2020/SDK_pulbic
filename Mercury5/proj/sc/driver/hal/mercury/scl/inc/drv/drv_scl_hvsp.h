...
#endif
#define HVSP_irq                    0
INTERFACE void DrvSclHvspSetMemoryAllocateReady(u32 u32Channel, bool bEn);
...
INTERFACE DrvSclHvspScalingConfig_t DrvSclHvspSetScaling(DrvSclHvspIdType_e enHVSP_ID, DrvSclHvspScalingConfig_t stCfg, DrvSclHvspClkConfig_t* stclk, u32 IPMChannel);
...
INTERFACE u32 DrvSclHvspCropCheck(void);
INTERFACE u32 DrvSclHvspDmaCheck(DrvSclHvspMonitorType_e enMonitorType);
