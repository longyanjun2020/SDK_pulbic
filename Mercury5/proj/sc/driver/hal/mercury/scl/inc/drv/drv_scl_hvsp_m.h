...
INTERFACE void MDrvSclHvspSetMemoryAllocateReady(u32 u32Channel, bool bEn);
...
INTERFACE u32 MDrvSclHvspHwMonitor(bool u8flag);
...
INTERFACE void MDrvSclHvspSetIpmChannel(u32 ulchannel);
INTERFACE bool MDrvSclHvspCfgIpmFinal(u32 ulchannel);
INTERFACE bool MDrvSclHvspIpmSwitch(u32 ulchannel);
INTERFACE void MDrvSclHvspGetIpmbyChannel(u32 ulchannel, DrvSclHvspIpmConfig_t *stIPMCfg);
