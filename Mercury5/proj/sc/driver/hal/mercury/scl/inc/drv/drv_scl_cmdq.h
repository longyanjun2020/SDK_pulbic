...
void DrvSclCmdq1Enable(bool bEnable,DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq1SetForceSkip(bool bEn);

void DrvSclCmdq2Enable(bool bEnable,DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq2SetForceSkip(bool bEn);

//==============================Delete===============================================
void DrvSclCmdqDelete(void);
...
u64  DrvSclCmdqGetCMDFromPoint(u16 u16Point);
u32  DrvSclCmdqGetCMDBankFromCMD(u64 u64Cmd);
void DrvSclCmdqWriteRegWithMaskDirect(u32 u32Addr,u16 u16Data,u16 u16Mask);

void DrvSclCmdq1Delete(void);
void DrvSclCmdq1SetRPoint(DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq1SetDPoint(DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq1SetLPoint(DrvSclCmdqIpType_e enIPType);
u32  DrvSclCmdq1BeTrigger(DrvSclCmdqIpType_e enIPType,bool bStart);
u64  DrvSclCmdq1GetCMDFromPoint(u16 u16Point);
u32  DrvSclCmdq1GetCMDBankFromCMD(u64 u64Cmd);
void DrvSclCmdq1WriteRegWithMaskDirect(u32 u32Addr,u16 u16Data,u16 u16Mask);

void DrvSclCmdq2Delete(void);
void DrvSclCmdq2SetRPoint(DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq2SetDPoint(DrvSclCmdqIpType_e enIPType);
void DrvSclCmdq2SetLPoint(DrvSclCmdqIpType_e enIPType);
u32  DrvSclCmdq2BeTrigger(DrvSclCmdqIpType_e enIPType,bool bStart);
u64  DrvSclCmdq2GetCMDFromPoint(u16 u16Point);
u32  DrvSclCmdq2GetCMDBankFromCMD(u64 u64Cmd);
void DrvSclCmdq2WriteRegWithMaskDirect(u32 u32Addr,u16 u16Data,u16 u16Mask);
...
//-------------------------------------------------------------------------------------------------
void DrvSclCmdqInit(u32 PhyAddr1, u32 u32VirAddr1, u32 u32BufByteLen,u32 u32RIUBase);
void DrvSclCmdq1Init(u32 PhyAddr1, u32 u32VirAddr1, u32 u32BufByteLen,u32 u32RIUBase);
void DrvSclCmdq2Init(u32 PhyAddr1, u32 u32VirAddr1, u32 u32BufByteLen,u32 u32RIUBase);
...
u16  DrvSclCmdq1GetFinalIrq(DrvSclCmdqIpType_e enIPType);
u16  DrvSclCmdq2GetFinalIrq(DrvSclCmdqIpType_e enIPType);
void DrvSclCmdqClearIrqByFlag(DrvSclCmdqIpType_e enIPType,u16 u16Irq);
void DrvSclCmdq1ClearIrqByFlag(DrvSclCmdqIpType_e enIPType,u16 u16Irq);
void DrvSclCmdq2ClearIrqByFlag(DrvSclCmdqIpType_e enIPType,u16 u16Irq);
void DrvSclCmdqSetISRStatus(bool bEn);
void DrvSclCmdq1SetISRStatus(bool bEn);
void DrvSclCmdq2SetISRStatus(bool bEn);
void DrvSclCmdqGetModuleMutex(DrvSclCmdqIpType_e enIPType,bool bEn);
void DrvSclCmdq1GetModuleMutex(DrvSclCmdqIpType_e enIPType,bool bEn);
void DrvSclCmdq2GetModuleMutex(DrvSclCmdqIpType_e enIPType,bool bEn);
...
//-------------------------------------------------------------------------------------------------
bool DrvSclCmdqWriteCmd(u32 u32Addr, u16 u16Data, u16 u16Mask,bool bSkipCheckSameAddr);
bool DrvSclCmdq1WriteCmd(u32 u32Addr, u16 u16Data, u16 u16Mask,bool bSkipCheckSameAddr);
bool DrvSclCmdq2WriteCmd(u32 u32Addr, u16 u16Data, u16 u16Mask,bool bSkipCheckSameAddr);

void DrvSclCmdqrelease(void);
void DrvSclCmdq1release(void);
void DrvSclCmdq2release(void);
u8   DrvSclCmdqGetISPHWCnt(void);
u8   DrvSclCmdq1GetISPHWCnt(void);
u8   DrvSclCmdq2GetISPHWCnt(void);
...
//-------------------------------------------------------------------------------------------------
 ...
 //-------------------------------------------------------------------------------------------------
 void DrvSclCmdqWaitCmd(u16 u16bus);
 void DrvSclCmdq1WaitCmd(u16 u16bus);
 void DrvSclCmdq2WaitCmd(u16 u16bus);
 ...
 /// @param  u16Mask \b IN:  16bit ~mask,
 //-------------------------------------------------------------------------------------------------
 void DrvSclCmdqPollingEqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
 void DrvSclCmdq1PollingEqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
 void DrvSclCmdq2PollingEqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
 void DrvSclCmdqPollingNeqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
 void DrvSclCmdq1PollingNeqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
 void DrvSclCmdq2PollingNeqCmd(u32 u32Addr, u16 u16Data, u16 u16Mask);
...
bool DrvSclCmdq1Fire(DrvSclCmdqIpType_e enIPType,bool bStart);
bool DrvSclCmdq2Fire(DrvSclCmdqIpType_e enIPType,bool bStart);
void DrvSclCmdqSetEventForFire(void);
void DrvSclCmdq1SetEventForFire(void);
void DrvSclCmdq2SetEventForFire(void);
...
bool DrvSclCmdq1CheckIPAlreadyDone(DrvSclCmdqIpType_e enIPType);
bool DrvSclCmdq2CheckIPAlreadyDone(DrvSclCmdqIpType_e enIPType);

//===============================write Register==============================================

/// DrvSclCmdqApplyMenuload
/// For Trigger SCL menuload
//-------------------------------------------------------------------------------------------------
void DrvSclCmdqApplyMenuload(void);
