...
// Base Address
//------------------------------------------------------------------------------
#define MVOP_REG_BASE                           0x160F00  // 0x1400 - 0x14FF
#define MVOP_SUB_REG_BASE                       0x1300  // 0x1300 - 0x137F
#define MVOP_3RD_REG_BASE                       0x1380  // 0x1380 - 0x13FF
#define CHIP_REG_BASE                           0x101E00  //chiptop CLKGEN0
#define CLKGEN_REG_BASE                           0x103800  //chiptop CLKGEN0


#define CLKG_DC0_CTRL0        (CLKGEN_REG_BASE + 0xA4)
    #define CKG_DC0_DIS_CLK             BIT0
    #define CKG_DC0_INV_CLK             BIT1
    #define CKG_DC0_MPLL_172M             BITS(5:2,0)
    #define CKG_DC0_MPLL_160M             BITS(5:2,1)
    #define CKG_DC0_MPLL_123M             BITS(5:2,2)
    #define CKG_DC0_MPLL_144M             BITS(5:2,3)
    #define CKG_DC0_MPLL_54M             BITS(5:2,4)
    #define CKG_DC0_MPLL_27M             BITS(5:2,5)
    #define CKG_DC0_MPLL_192M             BITS(5:2,6)
    #define CKG_DC0_MPLL_216M             BITS(5:2,7)
    #define CKG_DC0_MPLL_240M             BITS(5:2,8)
    #define CKG_DC0_MPLL_288M             BITS(5:2,9)
    #define CKG_DC0_MPLL_320M             BITS(5:2,10)
...
#define VOP_INT_MASK                            (MVOP_REG_BASE + 0x3E)
    #define VOP_INT_MSK_BITS        (BIT0 |BIT1|BIT2|BIT3 | BIT4 | BIT5 | BIT6 | BIT7)
    #define VOP_INT_FIELD           (BIT5)
    #define VOP_INT_RDY             (BIT4)
    #define VOP_INT_HSYNC           (BIT3)
    #define VOP_INT_VSYNC           (BIT2)
    #define VOP_INT_BUF_OV          (BIT1)
    #define VOP_INT_BUF_UD          (BIT0)
...
#define VOP_REG_HANDSHAKE                  (MVOP_REG_BASE + 0x7C)
    #define VOP_HANDSHAKE       (BIT0) 
    #define VOP_TRIG_FROM_SC       (BIT1) 
    #define VOP_VSYNC_FROM_SC       (BIT2)
...
// chip top
//------------------------------------------------------------------------------
#define REG_CKG_DC0                             (CHIP_REG_BASE + 0xA4)
