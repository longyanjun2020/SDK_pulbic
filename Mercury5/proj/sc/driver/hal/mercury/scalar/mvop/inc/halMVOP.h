...
#define _MVOP_128BIT_BUS        1//128-bit MIU bus
#define _MVOP_64BIT_BUS         2// 64-bit MIU bus
#define MVOP_BUS_WIDTH          _MVOP_128BIT_BUS

#define HAL_MVOP_MODULE_CNT     1
...
typedef enum
{
    ...
    HALMVOP_216MHZ = 216000000ul,
    HALMVOP_240MHZ = 240000000ul,
...
MS_U32 HAL_MVOP_RegisterRead(MS_U32 u32Addr);
...
void HAL_MVOP_EnableBlackBG(MS_BOOL bEnBG);
