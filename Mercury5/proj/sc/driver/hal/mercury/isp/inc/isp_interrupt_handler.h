...
typedef enum
{
    ...
    INT3_PIPE0_INPUT_HIT_LINE_COUNT    = 4,
    INT3_PIPE0_OUTPUT_HIT_LINE_COUNT   = 5,
...
void HalIspDisableInt(isp_handle_t *handle);
void HalIspEnableInt(isp_handle_t *handle);
void HalIspMaskIntAll(isp_handle_t *handle);
u32 HalIspGetIntStatus1(isp_handle_t *handle);
u32 HalIspGetIntStatus2(isp_handle_t *handle);
u32 HalIspGetIntStatus3(isp_handle_t *handle);
u32 HalIspGetIntStatus4(isp_handle_t *handle);
void HalIspMaskClear1(isp_handle_t *handle, u32 clear);
void HalIspMaskClear2(isp_handle_t *handle, u32 clear);
void HalIspMaskClear3(isp_handle_t *handle, u32 clear);
void HalIspMaskClear4(isp_handle_t *handle, u32 clear);
void HalIspMaskInt1(isp_handle_t *handle, u32 mask);
void HalIspMaskInt2(isp_handle_t *handle, u32 mask);
void HalIspMaskInt3(isp_handle_t *handle, u32 mask);
void HalIspMaskInt4(isp_handle_t *handle, u32 mask);
void HalIspClearInt(isp_handle_t *handle, volatile u32 *clear, ISP_INT_STATUS int_num);
void HalIspClearIntAll(isp_handle_t *handle);
void HalIspReset(isp_handle_t *handle, ISP_PIPE_e isp_pipe);
void HalIspInputEnable(isp_handle_t *handle, u32 enable);
void HalIspAsyncEnable(isp_handle_t *handle, u32 enable);
void HalIspSetAEDgain(isp_handle_t *handle, u32 enable, u32 gain);
void HalIspSetYUVCCM(isp_handle_t *handle, const s16 *ccm_coeff);
u8 HalISPGetFrameDoneCount(isp_handle_t *handle);
void HalIspIrqInit(isp_handle_t *handle);
#endif
