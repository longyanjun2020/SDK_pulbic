// Generate Time: 2017-06-23 20:12:53.766902
////////////////////////////////////////////////////////////////////////////////
//
...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __MERCURY5_REG_VIF__
#define __MERCURY5_REG_VIF__
typedef struct {
	// h0000, bit: 0
	...
	// h0000, bit: 4
	/* HDR function enable*/
	#define offset_of_vif_reg_hdr0_en (0)
	#define mask_of_vif_reg_hdr0_en (0x10)
	...
	# 3'd6 HISPI2 source
	# 3'd7 HISPI3 source*/
	#define offset_of_vif_reg_hdr0_sel (0)
	#define mask_of_vif_reg_hdr0_sel (0xe0)
	...
	#define offset_of_vif_reg_vif_ch0_par_width (16)
	#define mask_of_vif_reg_vif_ch0_par_width (0x3fff)
	...
	#define offset_of_vif_reg_bt601_byteint_en (18)
	#define mask_of_vif_reg_bt601_byteint_en (0x1)
	unsigned int reg_bt601_byteint_en:1;

	// h0009, bit: 1
	/* BT601 Byte-interleaved channel select*/
	#define offset_of_vif_reg_vif_ch0_bt601_ch_sel (18)
	#define mask_of_vif_reg_vif_ch0_bt601_ch_sel (0x2)
	...
	# 1'b0: YC
	# 1'b1: CY*/
	#define offset_of_vif_reg_vif_ch0_bt656_yc16bit_mode (18)
	#define mask_of_vif_reg_vif_ch0_bt656_yc16bit_mode (0x4)
	...
	#define mask_of_vif_reg_vif_debug_sel (0xf)
	...
	// h000b, bit: 6
	/* Interrupt Mask*/
	#define offset_of_vif_reg_c_irq_mask0 (22)
	#define mask_of_vif_reg_c_irq_mask0 (0x7f)
	...
	#define offset_of_vif_reg_c_irq_force0 (24)
	#define mask_of_vif_reg_c_irq_force0 (0x7f)
	...
	// h000d, bit: 6
	/* Interrupt Clear*/
	#define offset_of_vif_reg_c_irq_clr0 (26)
	#define mask_of_vif_reg_c_irq_clr0 (0x7f)
	...
	#define offset_of_vif_reg_irq_final_status0 (28)
	#define mask_of_vif_reg_irq_final_status0 (0x7f)
	...
	#define offset_of_vif_reg_irq_raw_status0 (30)
	#define mask_of_vif_reg_irq_raw_status0 (0x7f)
	...
	#define offset_of_vif_reg_vif_ch0_pat_de_rate (32)
	...
	#define offset_of_vif_reg_vif_ch0_pat_img_width_m1 (34)
	...
	#define offset_of_vif_reg_vif_ch0_pat_img_height_m1 (36)
	...
	#define offset_of_vif_reg_vif_ch0_pat_vs_line (38)
	...
	#define offset_of_vif_reg_vif_ch0_pat_hs_pxl (38)
	...
	// h0014, bit: 7
	/* H-blanking time (x2)*/
	#define offset_of_vif_reg_vif_ch0_pat_hblank (40)
	#define mask_of_vif_reg_vif_ch0_pat_hblank (0xff)
	unsigned int reg_vif_ch0_pat_hblank:8;

	// h0014, bit: 14
	/* V-blanking time*/
	#define offset_of_vif_reg_vif_ch0_pat_vblank (40)
	...
	#define offset_of_vif_reg_vif_ch0_pat_blk_width_m1 (42)
	...
	#define offset_of_vif_reg_vif_ch0_pat_blk_height_m1 (44)
	...
	#define offset_of_vif_reg_vif_ch0_pat_color_init_idx (46)
	...
	#define offset_of_vif_reg_vif_ch0_pat_color_percent (46)
	...
	#define offset_of_vif_reg_vif_ch0_pat_frm_chg_rate (48)
	...
	#define offset_of_vif_reg_vif_ch0_pat_frm_chg_x (48)
	...
	#define offset_of_vif_reg_vif_ch0_pat_frm_chg_y (48)
	...
	#define offset_of_vif_reg_vif_ch0_vif2isp_line_cnt0 (52)
	...
	#define offset_of_vif_reg_vif_ch0_vif2isp_line_cnt1 (54)
	...
	// h001c, bit: 12
	/* input HSYNC count*/
	#define offset_of_vif_reg_vif_ch0_input_hs_cnt (56)
	...
	// h001d, bit: 12
	/* input DE count*/
	#define offset_of_vif_reg_vif_ch0_input_de_cnt (58)
	...
	#define offset_of_vif_reg_vif_ch0_li_end (62)
	...
	# 3'd6 HISPI2 source
	# 3'd7 HISPI3 source*/
	#define offset_of_vif_reg_hdr1_sel (64)
	#define mask_of_vif_reg_hdr1_sel (0xe0)
	...
	# 5'd20 BT656 2
	# 5'd21 BT601*/
	#define offset_of_vif_reg_vif_ch1_src_sel (64)
	...
	#define offset_of_vif_reg_vif_ch1_en (64)
	...
	// h0021, bit: 0
	/* Mask sensor/csi ready to ISP_IF*/
	#define offset_of_vif_reg_vif_ch1_sensor_mask (66)
	#define mask_of_vif_reg_vif_ch1_sensor_mask (0x1)
	unsigned int reg_vif_ch1_sensor_mask:1;

	// h0021, bit: 1
	/* Ready only mode*/
	#define offset_of_vif_reg_vif_ch1_if_de_mode (66)
	...
	# 1'b1: Enable
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_en_sw_strobe (68)
	...
	/* Software Strobe Setting
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_sw_strobe (68)
	...
	# 1'b0: high active
	# 1'b1: low active*/
	#define offset_of_vif_reg_vif_ch1_strobe_polarity (68)
	...
	/* Start Strobe after reference strobe start (unit:256xPCLK)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_strobe_start (70)
	...
	# 1'b1 : vertical blanking start
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_strobe_ref (70)
	...
	/* End Strobe after reference strobe start (unit:256xPCLK)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_strobe_end (72)
	...
	# 1'b1: Enable
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_en_hw_strobe (72)
	...
	/* Hardware Flash Strobe Counter to count sensor frame number
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_hw_strobe_cnt (74)
	...
	# 1'b1: vertical blanking start
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_hw_long_strobe_end_ref (74)
	...
	# 1'b1: long strobe (enable several frames)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_hw_strobe_mode (74)
	...
	# 2'b10 : shift 4bit
	# 2'b11 : shift 6bit*/
	#define offset_of_vif_reg_vif_ch1_sensor_format_left_sht (76)
	...
	// h0026, bit: 7
	/* swap sensor input data*/
	#define offset_of_vif_reg_vif_ch1_sensor_bit_swap (76)
	...
	# 1'b1: low active
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_sensor_hsync_polarity (76)
	...
	# 1'b1: low active
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_sensor_vsync_polarity (76)
	...
	# 2'b10: 16bit
	# 2'b11: 12bit*/
	#define offset_of_vif_reg_vif_ch1_sensor_format (76)
	...
	# 1'b1: RGB pattern
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch1_sensor_rgb_in (76)
	...
	# 2'b10: {[11:2], [11:10]}
	# 2'b11: {[11:2], 2'b0}*/
	#define offset_of_vif_reg_vif_ch1_sensor_format_ext_mode (76)
	...
	# 1'b0: separate Y/C mode
	# 1'b1: YC 16bit mode*/
	#define offset_of_vif_reg_vif_ch1_sensor_yc16bit (78)
	...
	# 2'd2: vsync rising edge delay 1 line
	# 2'd3: vsync rising edge*/
	#define offset_of_vif_reg_vif_ch1_sensor_vs_dly (78)
	...
	# 1'b0: hsync rising edge
	# 1'b1: hsync falling edge*/
	#define offset_of_vif_reg_vif_ch1_sensor_hs_dly (78)
	...
	/* Parallel sensor input image width
	Only avalible in parallel sensor & BT601 mode*/
	#define offset_of_vif_reg_vif_ch1_par_width (80)
	#define mask_of_vif_reg_vif_ch1_par_width (0x3fff)
	...
	// h0029, bit: 1
	/* BT601 Byte-interleaved channel select*/
	#define offset_of_vif_reg_vif_ch1_bt601_ch_sel (82)
	#define mask_of_vif_reg_vif_ch1_bt601_ch_sel (0x2)
	...
	# 1'b0: YC
	# 1'b1: CY*/
	#define offset_of_vif_reg_vif_ch1_bt656_yc16bit_mode (82)
	#define mask_of_vif_reg_vif_ch1_bt656_yc16bit_mode (0x4)
	...
	# 1'b0: disable
	# 1'b1: enable*/
	#define offset_of_vif_reg_vif_ch1_capture_en (84)
	...
	// h002b, bit: 6
	/* Interrupt Mask*/
	#define offset_of_vif_reg_c_irq_mask1 (86)
	#define mask_of_vif_reg_c_irq_mask1 (0x7f)
	...
	// h002c, bit: 6
	/* Force Interrupt Enable*/
	#define offset_of_vif_reg_c_irq_force1 (88)
	#define mask_of_vif_reg_c_irq_force1 (0x7f)
	...
	// h002d, bit: 6
	/* Interrupt Clear*/
	#define offset_of_vif_reg_c_irq_clr1 (90)
	#define mask_of_vif_reg_c_irq_clr1 (0x7f)
	...
	// h002e, bit: 6
	/* Status of Interrupt on CPU side*/
	#define offset_of_vif_reg_irq_final_status1 (92)
	#define mask_of_vif_reg_irq_final_status1 (0x7f)
	...
	#[5]: VIF to ISP line count hit0
	#[6]: VIF to ISP line count hit1*/
	#define offset_of_vif_reg_irq_raw_status1 (94)
	#define mask_of_vif_reg_irq_raw_status1 (0x7f)
	...
	// h0030, bit: 10
	/* data enable valid rate control*/
	#define offset_of_vif_reg_vif_ch1_pat_de_rate (96)
	...
	// h0031, bit: 12
	/* image width minus one*/
	#define offset_of_vif_reg_vif_ch1_pat_img_width_m1 (98)
	...
	// h0032, bit: 12
	/* image height minus one*/
	#define offset_of_vif_reg_vif_ch1_pat_img_height_m1 (100)
	...
	// h0033, bit: 7
	/* vsync pulse position, line number before v-active*/
	#define offset_of_vif_reg_vif_ch1_pat_vs_line (102)
	#define mask_of_vif_reg_vif_ch1_pat_vs_line (0xff)
	unsigned int reg_vif_ch1_pat_vs_line:8;

	// h0033, bit: 14
	/* hsync pulse position, pixel number before v-active*/
	#define offset_of_vif_reg_vif_ch1_pat_hs_pxl (102)
	...
	// h0034, bit: 7
	/* H-blanking time (x2)*/
	#define offset_of_vif_reg_vif_ch1_pat_hblank (104)
	#define mask_of_vif_reg_vif_ch1_pat_hblank (0xff)
	unsigned int reg_vif_ch1_pat_hblank:8;

	// h0034, bit: 14
	/* V-blanking time*/
	#define offset_of_vif_reg_vif_ch1_pat_vblank (104)
	...
	// h0035, bit: 12
	/* pattern block width minus one*/
	#define offset_of_vif_reg_vif_ch1_pat_blk_width_m1 (106)
	...
	// h0036, bit: 12
	/* pattern block height minus one*/
	#define offset_of_vif_reg_vif_ch1_pat_blk_height_m1 (108)
	...
	// h0037, bit: 2
	/* initial color bar index*/
	#define offset_of_vif_reg_vif_ch1_pat_color_init_idx (110)
	...
	// h0037, bit: 5
	/* color bar value percentage*/
	#define offset_of_vif_reg_vif_ch1_pat_color_percent (110)
	...
	// h003a, bit: 12
	/* VIF line cnt number0 for interrupt*/
	#define offset_of_vif_reg_vif_ch1_vif2isp_line_cnt0 (116)
	...
	// h003b, bit: 12
	/* VIF line cnt number1 for interrupt*/
	#define offset_of_vif_reg_vif_ch1_vif2isp_line_cnt1 (118)
	...
	// h003c, bit: 12
	/* input HSYNC count*/
	#define offset_of_vif_reg_vif_ch1_input_hs_cnt (120)
	...
	// h003d, bit: 12
	/* input DE count*/
	#define offset_of_vif_reg_vif_ch1_input_de_cnt (122)
	...
	// h003e, bit: 12
	/* Line interleaved start line*/
	#define offset_of_vif_reg_vif_ch1_li_st (124)
	#define mask_of_vif_reg_vif_ch1_li_st (0x1fff)
	unsigned int reg_vif_ch1_li_st:13;

	// h003e, bit: 13
	/* Line interleaved skip first 4 data*/
	#define offset_of_vif_reg_vif_ch1_li_skip_4data (124)
	#define mask_of_vif_reg_vif_ch1_li_skip_4data (0x2000)
	unsigned int reg_vif_ch1_li_skip_4data:1;

	// h003e, bit: 14
	/* Line interleaved channel*/
	#define offset_of_vif_reg_vif_ch1_li_ch (124)
	#define mask_of_vif_reg_vif_ch1_li_ch (0x4000)
	unsigned int reg_vif_ch1_li_ch:1;

	// h003e, bit: 15
	/* Line interleaved mode enable*/
	#define offset_of_vif_reg_vif_ch1_li_mode_en (124)
	...
	// h003f, bit: 12
	/* Line interleaved end line*/
	#define offset_of_vif_reg_vif_ch1_li_end (126)
	...
	# Low Active
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_sensor_sw_rstz (128)
	#define mask_of_vif_reg_vif_ch2_sensor_sw_rstz (0x1)
	unsigned int reg_vif_ch2_sensor_sw_rstz:1;

	// h0040, bit: 1
	/* VIF IF status reset*/
	#define offset_of_vif_reg_vif_ch2_if_state_rst (128)
	#define mask_of_vif_reg_vif_ch2_if_state_rst (0x2)
	unsigned int reg_vif_ch2_if_state_rst:1;

	// h0040, bit: 2
	/* Reset Sensor2*/
	#define offset_of_vif_reg_vif_ch2_sensor_rst (128)
	#define mask_of_vif_reg_vif_ch2_sensor_rst (0x4)
	unsigned int reg_vif_ch2_sensor_rst:1;

	// h0040, bit: 3
	/* Power down sensor2*/
	#define offset_of_vif_reg_vif_ch2_sensor_pwrdn (128)
	#define mask_of_vif_reg_vif_ch2_sensor_pwrdn (0x8)
	...
	# 5'd20 BT656 2
	# 5'd21 BT601*/
	#define offset_of_vif_reg_vif_ch2_src_sel (128)
	#define mask_of_vif_reg_vif_ch2_src_sel (0x1f00)
	...
	// h0040, bit: 15
	/* VIF channel 2 enable*/
	#define offset_of_vif_reg_vif_ch2_en (128)
	#define mask_of_vif_reg_vif_ch2_en (0x8000)
	unsigned int reg_vif_ch2_en:1;
	...
	// h0041, bit: 0
	/* Mask sensor/csi ready to ISP_IF*/
	#define offset_of_vif_reg_vif_ch2_sensor_mask (130)
	#define mask_of_vif_reg_vif_ch2_sensor_mask (0x1)
	unsigned int reg_vif_ch2_sensor_mask:1;

	// h0041, bit: 1
	/* Ready only mode*/
	#define offset_of_vif_reg_vif_ch2_if_de_mode (130)
	#define mask_of_vif_reg_vif_ch2_if_de_mode (0x2)
	...
	# 1'b1: Enable
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_en_sw_strobe (132)
	#define mask_of_vif_reg_vif_ch2_en_sw_strobe (0x1)
	unsigned int reg_vif_ch2_en_sw_strobe:1;

	// h0042, bit: 1
	/* Software Strobe Setting
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_sw_strobe (132)
	#define mask_of_vif_reg_vif_ch2_sw_strobe (0x2)
	...
	# 1'b0: high active
	# 1'b1: low active*/
	#define offset_of_vif_reg_vif_ch2_strobe_polarity (132)
	#define mask_of_vif_reg_vif_ch2_strobe_polarity (0x10)
	...
	/* Start Strobe after reference strobe start (unit:256xPCLK)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_strobe_start (134)
	#define mask_of_vif_reg_vif_ch2_strobe_start (0x7fff)
	...
	# 1'b1 : vertical blanking start
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_strobe_ref (134)
	#define mask_of_vif_reg_vif_ch2_strobe_ref (0x8000)
	...
	/* End Strobe after reference strobe start (unit:256xPCLK)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_strobe_end (136)
	#define mask_of_vif_reg_vif_ch2_strobe_end (0x7fff)
	...
	# 1'b1: Enable
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_en_hw_strobe (136)
	#define mask_of_vif_reg_vif_ch2_en_hw_strobe (0x8000)
	...
	/* Hardware Flash Strobe Counter to count sensor frame number
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_hw_strobe_cnt (138)
	#define mask_of_vif_reg_vif_ch2_hw_strobe_cnt (0xf)
	...
	# 1'b1: vertical blanking start
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_hw_long_strobe_end_ref (138)
	#define mask_of_vif_reg_vif_ch2_hw_long_strobe_end_ref (0x4000)
	...
	# 1'b1: long strobe (enable several frames)
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_hw_strobe_mode (138)
	#define mask_of_vif_reg_vif_ch2_hw_strobe_mode (0x8000)
	...
	# 2'b10 : shift 4bit
	# 2'b11 : shift 6bit*/
	#define offset_of_vif_reg_vif_ch2_sensor_format_left_sht (140)
	#define mask_of_vif_reg_vif_ch2_sensor_format_left_sht (0xc)
	...
	// h0046, bit: 7
	/* swap sensor input data*/
	#define offset_of_vif_reg_vif_ch2_sensor_bit_swap (140)
	#define mask_of_vif_reg_vif_ch2_sensor_bit_swap (0x80)
	...
	# 1'b1: low active
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_sensor_hsync_polarity (140)
	#define mask_of_vif_reg_vif_ch2_sensor_hsync_polarity (0x100)
	...
	# 1'b1: low active
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_sensor_vsync_polarity (140)
	#define mask_of_vif_reg_vif_ch2_sensor_vsync_polarity (0x200)
	...
	# 2'b10: 16bit
	# 2'b11: 12bit*/
	#define offset_of_vif_reg_vif_ch2_sensor_format (140)
	#define mask_of_vif_reg_vif_ch2_sensor_format (0xc00)
	...
	# 1'b1: RGB pattern
	 ( single buffer register )*/
	#define offset_of_vif_reg_vif_ch2_sensor_rgb_in (140)
	#define mask_of_vif_reg_vif_ch2_sensor_rgb_in (0x1000)
	...
	# 2'b10: {[11:2], [11:10]}
	# 2'b11: {[11:2], 2'b0}*/
	#define offset_of_vif_reg_vif_ch2_sensor_format_ext_mode (140)
	#define mask_of_vif_reg_vif_ch2_sensor_format_ext_mode (0xc000)
	...
	# 1'b0: separate Y/C mode
	# 1'b1: YC 16bit mode*/
	#define offset_of_vif_reg_vif_ch2_sensor_yc16bit (142)
	#define mask_of_vif_reg_vif_ch2_sensor_yc16bit (0x40)
	...
	# 2'd2: vsync rising edge delay 1 line
	# 2'd3: vsync rising edge*/
	#define offset_of_vif_reg_vif_ch2_sensor_vs_dly (142)
	#define mask_of_vif_reg_vif_ch2_sensor_vs_dly (0x300)
	...
	# 1'b0: hsync rising edge
	# 1'b1: hsync falling edge*/
	#define offset_of_vif_reg_vif_ch2_sensor_hs_dly (142)
	#define mask_of_vif_reg_vif_ch2_sensor_hs_dly (0x1000)
	...
	/* Parallel sensor input image width
	Only avalible in parallel sensor & BT601 mode*/
	#define offset_of_vif_reg_vif_ch2_par_width (144)
	#define mask_of_vif_reg_vif_ch2_par_width (0x3fff)
	...
	// h0049, bit: 1
	/* BT601 Byte-interleaved channel select*/
	#define offset_of_vif_reg_vif_ch2_bt601_ch_sel (146)
	#define mask_of_vif_reg_vif_ch2_bt601_ch_sel (0x2)
	...
	# 1'b0: YC
	# 1'b1: CY*/
	#define offset_of_vif_reg_vif_ch2_bt656_yc16bit_mode (146)
	#define mask_of_vif_reg_vif_ch2_bt656_yc16bit_mode (0x4)
	...
	# 1'b0: disable
	# 1'b1: enable*/
	#define offset_of_vif_reg_vif_ch2_capture_en (148)
	#define mask_of_vif_reg_vif_ch2_capture_en (0x100)
	...
	// h004b, bit: 6
	/* Interrupt Mask*/
	#define offset_of_vif_reg_c_irq_mask2 (150)
	#define mask_of_vif_reg_c_irq_mask2 (0x7f)
	...
	// h004c, bit: 6
	/* Force Interrupt Enable*/
	#define offset_of_vif_reg_c_irq_force2 (152)
	#define mask_of_vif_reg_c_irq_force2 (0x7f)
	...
	// h004d, bit: 6
	/* Interrupt Clear*/
	#define offset_of_vif_reg_c_irq_clr2 (154)
	#define mask_of_vif_reg_c_irq_clr2 (0x7f)
	...
	// h004e, bit: 6
	/* Status of Interrupt on CPU side*/
	#define offset_of_vif_reg_irq_final_status2 (156)
	#define mask_of_vif_reg_irq_final_status2 (0x7f)
	...
	#[5]: VIF to ISP line count hit0
	#[6]: VIF to ISP line count hit1*/
	#define offset_of_vif_reg_irq_raw_status2 (158)
	#define mask_of_vif_reg_irq_raw_status2 (0x7f)
	...
	// h0050, bit: 0
	/* timing generator enable*/
	#define offset_of_vif_reg_vif_ch2_pat_tgen_en (160)
	#define mask_of_vif_reg_vif_ch2_pat_tgen_en (0x1)
	unsigned int reg_vif_ch2_pat_tgen_en:1;

	// h0050, bit: 1
	/* data generator enable*/
	#define offset_of_vif_reg_vif_ch2_pat_dgen_en (160)
	#define mask_of_vif_reg_vif_ch2_pat_dgen_en (0x2)
	unsigned int reg_vif_ch2_pat_dgen_en:1;

	// h0050, bit: 2
	/* hsync generator*/
	#define offset_of_vif_reg_vif_ch2_pat_hsgen_en (160)
	#define mask_of_vif_reg_vif_ch2_pat_hsgen_en (0x4)
	unsigned int reg_vif_ch2_pat_hsgen_en:1;

	// h0050, bit: 3
	/* data generator  reset*/
	#define offset_of_vif_reg_vif_ch2_pat_dgen_rst (160)
	#define mask_of_vif_reg_vif_ch2_pat_dgen_rst (0x8)
	unsigned int reg_vif_ch2_pat_dgen_rst:1;

	// h0050, bit: 5
	/* bayer format*/
	#define offset_of_vif_reg_vif_ch2_pat_sensor_array (160)
	#define mask_of_vif_reg_vif_ch2_pat_sensor_array (0x30)
	...
	// h0050, bit: 10
	/* data enable valid rate control*/
	#define offset_of_vif_reg_vif_ch2_pat_de_rate (160)
	#define mask_of_vif_reg_vif_ch2_pat_de_rate (0x700)
	...
	// h0051, bit: 12
	/* image width minus one*/
	#define offset_of_vif_reg_vif_ch2_pat_img_width_m1 (162)
	#define mask_of_vif_reg_vif_ch2_pat_img_width_m1 (0x1fff)
	...
	// h0052, bit: 12
	/* image height minus one*/
	#define offset_of_vif_reg_vif_ch2_pat_img_height_m1 (164)
	#define mask_of_vif_reg_vif_ch2_pat_img_height_m1 (0x1fff)
	...
	// h0053, bit: 7
	/* vsync pulse position, line number before v-active*/
	#define offset_of_vif_reg_vif_ch2_pat_vs_line (166)
	#define mask_of_vif_reg_vif_ch2_pat_vs_line (0xff)
	unsigned int reg_vif_ch2_pat_vs_line:8;

	// h0053, bit: 14
	/* hsync pulse position, pixel number before v-active*/
	#define offset_of_vif_reg_vif_ch2_pat_hs_pxl (166)
	#define mask_of_vif_reg_vif_ch2_pat_hs_pxl (0xff00)
	...
	// h0054, bit: 7
	/* H-blanking time (x2)*/
	#define offset_of_vif_reg_vif_ch2_pat_hblank (168)
	#define mask_of_vif_reg_vif_ch2_pat_hblank (0xff)
	unsigned int reg_vif_ch2_pat_hblank:8;

	// h0054, bit: 14
	/* V-blanking time*/
	#define offset_of_vif_reg_vif_ch2_pat_vblank (168)
	#define mask_of_vif_reg_vif_ch2_pat_vblank (0xff00)
	...
	// h0055, bit: 12
	/* pattern block width minus one*/
	#define offset_of_vif_reg_vif_ch2_pat_blk_width_m1 (170)
	#define mask_of_vif_reg_vif_ch2_pat_blk_width_m1 (0x1fff)
	...
	// h0056, bit: 12
	/* pattern block height minus one*/
	#define offset_of_vif_reg_vif_ch2_pat_blk_height_m1 (172)
	#define mask_of_vif_reg_vif_ch2_pat_blk_height_m1 (0x1fff)
	...
	// h0057, bit: 2
	/* initial color bar index*/
	#define offset_of_vif_reg_vif_ch2_pat_color_init_idx (174)
	#define mask_of_vif_reg_vif_ch2_pat_color_init_idx (0x7)
	...
	// h0057, bit: 5
	/* color bar value percentage*/
	#define offset_of_vif_reg_vif_ch2_pat_color_percent (174)
	#define mask_of_vif_reg_vif_ch2_pat_color_percent (0x30)
	...
	// h0058, bit: 7
	/* frame pattern change rate*/
	#define offset_of_vif_reg_vif_ch2_pat_frm_chg_rate (176)
	#define mask_of_vif_reg_vif_ch2_pat_frm_chg_rate (0xff)
	unsigned int reg_vif_ch2_pat_frm_chg_rate:8;

	// h0058, bit: 11
	/* pattern shift pixel number when frame change*/
	#define offset_of_vif_reg_vif_ch2_pat_frm_chg_x (176)
	#define mask_of_vif_reg_vif_ch2_pat_frm_chg_x (0xf00)
	unsigned int reg_vif_ch2_pat_frm_chg_x:4;

	// h0058, bit: 14
	/* pattern shift line number when frame change*/
	#define offset_of_vif_reg_vif_ch2_pat_frm_chg_y (176)
	#define mask_of_vif_reg_vif_ch2_pat_frm_chg_y (0xf000)
	...
	// h005a, bit: 12
	/* VIF line cnt number0 for interrupt*/
	#define offset_of_vif_reg_vif_ch2_vif2isp_line_cnt0 (180)
	#define mask_of_vif_reg_vif_ch2_vif2isp_line_cnt0 (0x1fff)
	...
	// h005b, bit: 12
	/* VIF line cnt number1 for interrupt*/
	#define offset_of_vif_reg_vif_ch2_vif2isp_line_cnt1 (182)
	#define mask_of_vif_reg_vif_ch2_vif2isp_line_cnt1 (0x1fff)
	...
	// h005c, bit: 12
	/* input HSYNC count*/
	#define offset_of_vif_reg_vif_ch2_input_hs_cnt (184)
	#define mask_of_vif_reg_vif_ch2_input_hs_cnt (0x1fff)
	...
	// h005d, bit: 12
	/* input DE count*/
	#define offset_of_vif_reg_vif_ch2_input_de_cnt (186)
	#define mask_of_vif_reg_vif_ch2_input_de_cnt (0x1fff)
	...
	// h005e, bit: 12
	/* Line interleaved start line*/
	#define offset_of_vif_reg_vif_ch2_li_st (188)
	#define mask_of_vif_reg_vif_ch2_li_st (0x1fff)
	unsigned int reg_vif_ch2_li_st:13;

	// h005e, bit: 13
	/* Line interleaved skip first 4 data*/
	#define offset_of_vif_reg_vif_ch2_li_skip_4data (188)
	#define mask_of_vif_reg_vif_ch2_li_skip_4data (0x2000)
	unsigned int reg_vif_ch2_li_skip_4data:1;

	// h005e, bit: 14
	/* Line interleaved channel*/
	#define offset_of_vif_reg_vif_ch2_li_ch (188)
	#define mask_of_vif_reg_vif_ch2_li_ch (0x4000)
	unsigned int reg_vif_ch2_li_ch:1;

	// h005e, bit: 15
	/* Line interleaved mode enable*/
	#define offset_of_vif_reg_vif_ch2_li_mode_en (188)
	#define mask_of_vif_reg_vif_ch2_li_mode_en (0x8000)
	...
	// h005f, bit: 12
	/* Line interleaved end line*/
	#define offset_of_vif_reg_vif_ch2_li_end (190)
	#define mask_of_vif_reg_vif_ch2_li_end (0x1fff)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_input_sel (192)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_ch_det_en (192)
	...
	#[0]: EAV detect
	#[1]: SAV detect*/
	#define offset_of_vif_reg_vif_ch0_bt656_ch_det_sel (192)
	#define mask_of_vif_reg_vif_ch0_bt656_ch_det_sel (0x4)
	unsigned int reg_vif_ch0_bt656_ch_det_sel:1;

	// h0060, bit: 3
	/* BT656 bit swap function*/
	#define offset_of_vif_reg_vif_ch0_bt656_bit_swap (192)
	#define mask_of_vif_reg_vif_ch0_bt656_bit_swap (0x8)
	unsigned int reg_vif_ch0_bt656_bit_swap:1;

	// h0060, bit: 4
	/* BT656 8bit mode*/
	#define offset_of_vif_reg_vif_ch0_bt656_8bit_mode (192)
	#define mask_of_vif_reg_vif_ch0_bt656_8bit_mode (0x10)
	unsigned int reg_vif_ch0_bt656_8bit_mode:1;

	// h0060, bit: 5
	/* BT656 8bit mode extend LSB bit for time mux*/
	#define offset_of_vif_reg_vif_ch0_bt656_8bit_ext (192)
	#define mask_of_vif_reg_vif_ch0_bt656_8bit_ext (0x20)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_ch (192)
	#define mask_of_vif_reg_vif_ch0_bt656_ch (0x100)
	unsigned int reg_vif_ch0_bt656_ch:1;

	// h0060, bit: 9
	/* BT656 time mux channel detect done*/
	#define offset_of_vif_reg_vif_ch0_bt656_ch_det_done (192)
	#define mask_of_vif_reg_vif_ch0_bt656_ch_det_done (0x200)
	...
	// h0061, bit: 7
	/* bt656 crop enable*/
	#define offset_of_vif_reg_vif_ch0_bt656_clamp_en (194)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_det_status0 (194)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_det_status1 (194)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_crop_v (196)
	...
	#define offset_of_vif_reg_vif_ch0_bt656_crop_h (198)
	...
	// h0064, bit: 0
	/* BT656 input source select*/
	#define offset_of_vif_reg_vif_ch1_bt656_input_sel (200)
	#define mask_of_vif_reg_vif_ch1_bt656_input_sel (0x1)
	unsigned int reg_vif_ch1_bt656_input_sel:1;

	// h0064, bit: 1
	/* BT656 time mux channel detect enable*/
	#define offset_of_vif_reg_vif_ch1_bt656_ch_det_en (200)
	...
	#[0]: EAV detect
	#[1]: SAV detect*/
	#define offset_of_vif_reg_vif_ch1_bt656_ch_det_sel (200)
	#define mask_of_vif_reg_vif_ch1_bt656_ch_det_sel (0x4)
	unsigned int reg_vif_ch1_bt656_ch_det_sel:1;

	// h0064, bit: 3
	/* BT656 bit swap function*/
	#define offset_of_vif_reg_vif_ch1_bt656_bit_swap (200)
	#define mask_of_vif_reg_vif_ch1_bt656_bit_swap (0x8)
	unsigned int reg_vif_ch1_bt656_bit_swap:1;

	// h0064, bit: 4
	/* BT656 8bit mode*/
	#define offset_of_vif_reg_vif_ch1_bt656_8bit_mode (200)
	#define mask_of_vif_reg_vif_ch1_bt656_8bit_mode (0x10)
	unsigned int reg_vif_ch1_bt656_8bit_mode:1;

	// h0064, bit: 5
	/* BT656 8bit mode extend LSB bit*/
	#define offset_of_vif_reg_vif_ch1_bt656_8bit_ext (200)
	#define mask_of_vif_reg_vif_ch1_bt656_8bit_ext (0x20)
	...
	#define offset_of_vif_reg_vif_ch1_bt656_ch (200)
	#define mask_of_vif_reg_vif_ch1_bt656_ch (0x100)
	unsigned int reg_vif_ch1_bt656_ch:1;

	// h0064, bit: 9
	/* BT656 time mux channel detect done*/
	#define offset_of_vif_reg_vif_ch1_bt656_ch_det_done (200)
	#define mask_of_vif_reg_vif_ch1_bt656_ch_det_done (0x200)
	...
	// h0065, bit: 7
	/* bt656 crop enable*/
	#define offset_of_vif_reg_vif_ch1_bt656_clamp_en (202)
	...
	// h0065, bit: 14
	/* Bt656 mode detection status 0*/
	#define offset_of_vif_reg_vif_ch1_bt656_det_status0 (202)
	#define mask_of_vif_reg_vif_ch1_bt656_det_status0 (0x4000)
	unsigned int reg_vif_ch1_bt656_det_status0:1;

	// h0065, bit: 15
	/* Bt656 mode detection status 1*/
	#define offset_of_vif_reg_vif_ch1_bt656_det_status1 (202)
	...
	// h0066, bit: 11
	/* bt656 vertical crop size V*/
	#define offset_of_vif_reg_vif_ch1_bt656_crop_v (204)
	...
	// h0067, bit: 11
	/* bt656 vertical crop size H*/
	#define offset_of_vif_reg_vif_ch1_bt656_crop_h (206)
	...
	// h0068, bit: 0
	/* BT656 input source select*/
	#define offset_of_vif_reg_vif_ch2_bt656_input_sel (208)
	#define mask_of_vif_reg_vif_ch2_bt656_input_sel (0x1)
	unsigned int reg_vif_ch2_bt656_input_sel:1;

	// h0068, bit: 1
	/* BT656 time mux channel detect enable*/
	#define offset_of_vif_reg_vif_ch2_bt656_ch_det_en (208)
	#define mask_of_vif_reg_vif_ch2_bt656_ch_det_en (0x2)
	...
	#[0]: EAV detect
	#[1]: SAV detect*/
	#define offset_of_vif_reg_vif_ch2_bt656_ch_det_sel (208)
	#define mask_of_vif_reg_vif_ch2_bt656_ch_det_sel (0x4)
	unsigned int reg_vif_ch2_bt656_ch_det_sel:1;

	// h0068, bit: 3
	/* BT656 bit swap function*/
	#define offset_of_vif_reg_vif_ch2_bt656_bit_swap (208)
	#define mask_of_vif_reg_vif_ch2_bt656_bit_swap (0x8)
	unsigned int reg_vif_ch2_bt656_bit_swap:1;

	// h0068, bit: 4
	/* BT656 8bit mode*/
	#define offset_of_vif_reg_vif_ch2_bt656_8bit_mode (208)
	#define mask_of_vif_reg_vif_ch2_bt656_8bit_mode (0x10)
	unsigned int reg_vif_ch2_bt656_8bit_mode:1;

	// h0068, bit: 5
	/* BT656 8bit mode extend LSB bit*/
	#define offset_of_vif_reg_vif_ch2_bt656_8bit_ext (208)
	#define mask_of_vif_reg_vif_ch2_bt656_8bit_ext (0x20)
	...
	// h0068, bit: 8
	/* BT656 phase 0 channel*/
	#define offset_of_vif_reg_vif_ch2_bt656_ch (208)
	#define mask_of_vif_reg_vif_ch2_bt656_ch (0x100)
	unsigned int reg_vif_ch2_bt656_ch:1;

	// h0068, bit: 9
	/* BT656 time mux channel detect done*/
	#define offset_of_vif_reg_vif_ch2_bt656_ch_det_done (208)
	#define mask_of_vif_reg_vif_ch2_bt656_ch_det_done (0x200)
	...
	// h0069, bit: 1
	/* 0:  vsync is sync to hsync dely 1 line 1:  vsync is sync to hsync dely 2 line 2: vsync is sync to hsync dely 0 line 3:vsync is decoded by bt656 decoder*/
	#define offset_of_vif_reg_vif_ch2_bt656_vs_sel (210)
	#define mask_of_vif_reg_vif_ch2_bt656_vs_sel (0x3)
	unsigned int reg_vif_ch2_bt656_vs_sel:2;

	// h0069, bit: 2
	/* bt656 decoder hsync inv*/
	#define offset_of_vif_reg_vif_ch2_bt656_hs_inv (210)
	#define mask_of_vif_reg_vif_ch2_bt656_hs_inv (0x4)
	unsigned int reg_vif_ch2_bt656_hs_inv:1;

	// h0069, bit: 3
	/* bt656 decoder vsync inv*/
	#define offset_of_vif_reg_vif_ch2_bt656_vs_inv (210)
	#define mask_of_vif_reg_vif_ch2_bt656_vs_inv (0x8)
	...
	// h0069, bit: 7
	/* bt656 crop enable*/
	#define offset_of_vif_reg_vif_ch2_bt656_clamp_en (210)
	#define mask_of_vif_reg_vif_ch2_bt656_clamp_en (0x80)
	...
	// h0069, bit: 14
	/* Bt656 mode detection status 0*/
	#define offset_of_vif_reg_vif_ch2_bt656_det_status0 (210)
	#define mask_of_vif_reg_vif_ch2_bt656_det_status0 (0x4000)
	unsigned int reg_vif_ch2_bt656_det_status0:1;

	// h0069, bit: 15
	/* Bt656 mode detection status 1*/
	#define offset_of_vif_reg_vif_ch2_bt656_det_status1 (210)
	#define mask_of_vif_reg_vif_ch2_bt656_det_status1 (0x8000)
	...
	// h006a, bit: 11
	/* bt656 vertical crop size V*/
	#define offset_of_vif_reg_vif_ch2_bt656_crop_v (212)
	#define mask_of_vif_reg_vif_ch2_bt656_crop_v (0xfff)
	...
	// h006b, bit: 11
	/* bt656 vertical crop size H*/
	#define offset_of_vif_reg_vif_ch2_bt656_crop_h (214)
	#define mask_of_vif_reg_vif_ch2_bt656_crop_h (0xfff)
...
}  __attribute__((packed, aligned(1))) mercury5_reg_vif;
#endif
