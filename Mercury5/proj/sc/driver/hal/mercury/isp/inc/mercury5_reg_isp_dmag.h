// Generate Time: 2017-06-23 20:12:53.589015
////////////////////////////////////////////////////////////////////////////////
//
...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __MERCURY5_REG_ISP_DMAG__
#define __MERCURY5_REG_ISP_DMAG__
typedef struct {
	// h0000, bit: 0
	/* ISP RDMA enable*/
	...
	#define mask_of_dmag_reg_isp_rdma_mode (0x300)
	...
	3'd2: 16-bit
	3'd3: 12-bit
	3'd4: 32-bit (1T4P, 8-bit/P)
	3'd5: 40-bit (1T4P, 10-bit/P)
	3'd6: 64-bit (1T4P, 16-bit/P)
	3'd7: 48-bit (1T4P, 12-bit/P)*/
	#define offset_of_dmag_reg_isp_wdma_mode (64)
	#define mask_of_dmag_reg_isp_wdma_mode (0x700)
	unsigned int reg_isp_wdma_mode:3;
...
}  __attribute__((packed, aligned(1))) mercury5_reg_isp_dmag;
#endif
