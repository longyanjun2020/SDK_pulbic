// Generate Time: 2017-06-23 20:12:52.402370
////////////////////////////////////////////////////////////////////////////////
//
...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __MERCURY5_REG_ISP0__
#define __MERCURY5_REG_ISP0__
typedef struct {
	// h0000, bit: 0
	/* Enable ISP Engine
	...
	# Low Active
	 ( single buffer register )*/
	#define offset_of_isp0_reg_sensor_sw_rstz (2)
	#define mask_of_isp0_reg_sensor_sw_rstz (0x2)
	...
	# 1'b1: Power Down
	 ( single buffer register )
	no-used*/
	#define offset_of_isp0_reg_sen_pwdn (2)
	#define mask_of_isp0_reg_sen_pwdn (0x4)
	...
	# 1'b1 Enable
	 ( single buffer register )*/
	#define offset_of_isp0_reg_en_isp_clk_sensor_delay (2)
	#define mask_of_isp0_reg_en_isp_clk_sensor_delay (0x8)
	...
	#define mask_of_isp0_reg_isp_sw_p1_rstz (0x20)
	...
	#define mask_of_isp0_reg_isp_sw_p2_rstz (0x40)
	...
	// h0001, bit: 8
	/* Software Reset for ISP_input_P1(sensor  clk domain)
	# Low Active
	 ( single buffer register )*/
	#define offset_of_isp0_reg_sensor_sw_p1_rstz (2)
	#define mask_of_isp0_reg_sensor_sw_p1_rstz (0x100)
	unsigned int reg_sensor_sw_p1_rstz:1;

	// h0001, bit: 9
	/* Software Reset for ISP_input_P2(sensor clk domain)
	# Low Active
	 ( single buffer register )*/
	#define offset_of_isp0_reg_sensor_sw_p2_rstz (2)
	#define mask_of_isp0_reg_sensor_sw_p2_rstz (0x200)
	unsigned int reg_sensor_sw_p2_rstz:1;
	...
	#define mask_of_isp0_reg_isp_crop_start_x (0xfff)
	...
	#define mask_of_isp0_reg_isp_crop_start_y (0xfff)
	...
	#define mask_of_isp0_reg_isp_crop_width (0xfff)
	...
	#define mask_of_isp0_reg_isp_crop_high (0xfff)
	...
	#define mask_of_isp0_reg_isp_wdma_crop_start_x (0xfff)
	...
	#define mask_of_isp0_reg_isp_wdma_crop_start_y (0xfff)
	...
	#define mask_of_isp0_reg_isp_wdma_crop_high (0xfff)
	...
	#define mask_of_isp0_reg_isp_sensor_line_cnt (0xfff)
	...
	// h0022, bit: 3
	/* ISP p1h auto trigger sel*/
    #define offset_of_isp0_reg_p1h_auto_trigger_sel (68)
	#define mask_of_isp0_reg_p1h_auto_trigger_sel (0xF)
	unsigned int reg_isp_p1h_auto_trigger_sel:4;
	...
	#define mask_of_isp0_reg_vdos_x_st (0x1fff)
	...
	#define mask_of_isp0_reg_vdos_y_st (0x1fff)
	unsigned int reg_vdos_y_st:13;
	...
	#define mask_of_isp0_reg_vdos_sblock_width (0xfff)
	...
	#define mask_of_isp0_reg_vdos_sblock_height (0xfff)
	...
	#define mask_of_isp0_reg_isp_sr2crop_line_cnt (0xfff)
	...
	#define mask_of_isp0_reg_sw_specify_int_line (0xfff)
...
}  __attribute__((packed, aligned(1))) mercury5_reg_isp0;
#endif
