// Generate Time: 2017-06-23 20:12:53.229686
////////////////////////////////////////////////////////////////////////////////
//
...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __MERCURY5_REG_ISP3__
#define __MERCURY5_REG_ISP3__
typedef struct {
	// h0000, bit: 0
	...
	#define mask_of_isp3_reg_ae_blksize_x_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_ae_blksize_y_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_ae_blk_h_offset (0xfff)
	...
	#define mask_of_isp3_reg_ae_blk_v_offset (0xfff)
	...
	#define offset_of_isp3_reg_statis_awb_mi_lenx4 (28)
	#define mask_of_isp3_reg_statis_awb_mi_lenx4 (0x3)
	unsigned int reg_statis_awb_mi_lenx4:2;

	// h000e, bit: 7
	/* AWB write miu mask period between each burst*/
	#define offset_of_isp3_reg_statis_awb_mi_mask_cycx16 (28)
	#define mask_of_isp3_reg_statis_awb_mi_mask_cycx16 (0xfc)
	unsigned int reg_statis_awb_mi_mask_cycx16:6;

	// h000e, bit: 9
	/* Block average write miu burst length x4*/
	#define offset_of_isp3_reg_statis_avg_mi_lenx4 (28)
	#define mask_of_isp3_reg_statis_avg_mi_lenx4 (0x300)
	unsigned int reg_statis_avg_mi_lenx4:2;

	// h000e, bit: 14
	/* Block average write miu mask period between each burst*/
	#define offset_of_isp3_reg_statis_avg_mi_mask_cycx16 (28)
	#define mask_of_isp3_reg_statis_avg_mi_mask_cycx16 (0xfc00)
	...
	#define offset_of_isp3_reg_statis_histo_mi_lenx4 (30)
	#define mask_of_isp3_reg_statis_histo_mi_lenx4 (0x3)
	unsigned int reg_statis_histo_mi_lenx4:2;

	// h000f, bit: 7
	/* Histogram  write miu mask period between each burst*/
	#define offset_of_isp3_reg_statis_histo_mi_mask_cycx16 (30)
	#define mask_of_isp3_reg_statis_histo_mi_mask_cycx16 (0xfc)
	...
	#define mask_of_isp3_reg_alsc_offsetx (0xfff)
	...
	#define mask_of_isp3_reg_alsc_offsety (0xfff)
	...
	// h0030, bit: 0
	/* DNR enable*/
	#define offset_of_isp3_reg_dnr_en (96)
	#define mask_of_isp3_reg_dnr_en (0x1)
	unsigned int reg_dnr_en:1;

	// h0030, bit: 1
	/* DNR luma adaptive enable*/
	#define offset_of_isp3_reg_dnr_lum_en (96)
	#define mask_of_isp3_reg_dnr_lum_en (0x2)
	...
	0: 3-bits
	1: 4-bits*/
	#define offset_of_isp3_reg_dnr_lum_sh (96)
	#define mask_of_isp3_reg_dnr_lum_sh (0x4)
	...
	#define offset_of_isp3_reg_dnr_filter_en (96)
	#define mask_of_isp3_reg_dnr_filter_en (0x10)
	unsigned int reg_dnr_filter_en:1;

	// h0030, bit: 6
	/* DNR motion filter mode*/
	#define offset_of_isp3_reg_dnr_filter_mode (96)
	#define mask_of_isp3_reg_dnr_filter_mode (0x60)
	...
	#define offset_of_isp3_reg_dnr_filter_div0 (96)
	#define mask_of_isp3_reg_dnr_filter_div0 (0x700)
	...
	#define offset_of_isp3_reg_dnr_filter_div1 (96)
	#define mask_of_isp3_reg_dnr_filter_div1 (0x3000)
	...
	#define offset_of_isp3_reg_dnr_lum_table (98)
	#define mask_of_isp3_reg_dnr_lum_table (0xffff)
	...
	// h0032, bit: 14
	/* DNR luma adaptive table*/
	#define offset_of_isp3_reg_dnr_lum_table_1 (100)
	#define mask_of_isp3_reg_dnr_lum_table_1 (0xffff)
	...
	// h0033, bit: 0
	/* DNR table select*/
	#define offset_of_isp3_reg_nr_table_sel (102)
	#define mask_of_isp3_reg_nr_table_sel (0x1)
	unsigned int reg_nr_table_sel:1;

	// h0033, bit: 1
	/* DNR non-dither method enable*/
	#define offset_of_isp3_reg_dnr_nondither_method (102)
	#define mask_of_isp3_reg_dnr_nondither_method (0x2)
	unsigned int reg_dnr_nondither_method:1;

	// h0033, bit: 2
	/* DNR non-dither method select*/
	#define offset_of_isp3_reg_dnr_nondither_method_mode (102)
	#define mask_of_isp3_reg_dnr_nondither_method_mode (0x4)
	unsigned int reg_dnr_nondither_method_mode:1;

	// h0033, bit: 4
	/* DNR rounding mode for blending*/
	#define offset_of_isp3_reg_round_mode (102)
	#define mask_of_isp3_reg_round_mode (0x18)
	...
	#define offset_of_isp3_reg_sticky_solver_th (102)
	#define mask_of_isp3_reg_sticky_solver_th (0x1f00)
	...
	#define offset_of_isp3_reg_sticky_solver_en (102)
	#define mask_of_isp3_reg_sticky_solver_en (0x8000)
	...
	// h0034, bit: 14
	/* DNR table*/
	#define offset_of_isp3_reg_dnr_tabley (104)
	#define mask_of_isp3_reg_dnr_tabley (0xffff)
	...
	// h0035, bit: 14
	/* DNR table*/
	#define offset_of_isp3_reg_dnr_tabley_1 (106)
	#define mask_of_isp3_reg_dnr_tabley_1 (0xffff)
	...
	// h0036, bit: 14
	/* DNR table*/
	#define offset_of_isp3_reg_dnr_tabley_2 (108)
	#define mask_of_isp3_reg_dnr_tabley_2 (0xffff)
	...
	// h0037, bit: 14
	/* DNR table*/
	#define offset_of_isp3_reg_dnr_tabley_3 (110)
	#define mask_of_isp3_reg_dnr_tabley_3 (0xffff)
	...
	#define offset_of_isp3_reg_dnr_fb_base_0 (112)
	#define mask_of_isp3_reg_dnr_fb_base_0 (0xffff)
	...
	// h0039, bit: 10
	/* DNR frame buffer base address 0*/
	#define offset_of_isp3_reg_dnr_fb_base_0_1 (114)
	#define mask_of_isp3_reg_dnr_fb_base_0_1 (0x7ff)
	...
	#define offset_of_isp3_reg_dnr_fb_base_1 (116)
	#define mask_of_isp3_reg_dnr_fb_base_1 (0xffff)
	...
	// h003b, bit: 10
	/* DNR frame buffer base address 1*/
	#define offset_of_isp3_reg_dnr_fb_base_1_1 (118)
	#define mask_of_isp3_reg_dnr_fb_base_1_1 (0x7ff)
	...
	// h003c, bit: 3
	/* Pitch width/192*/
	#define offset_of_isp3_reg_dnr_fb_pitch_in_tile (120)
	#define mask_of_isp3_reg_dnr_fb_pitch_in_tile (0xf)
	unsigned int reg_dnr_fb_pitch_in_tile:4;

	// h003c, bit: 7
	/* DNR write dma miu high priority threshold*/
	#define offset_of_isp3_reg_dnr_wdma_pri_thd (120)
	#define mask_of_isp3_reg_dnr_wdma_pri_thd (0xf0)
	unsigned int reg_dnr_wdma_pri_thd:4;

	// h003c, bit: 11
	/* DNR read dma miu high priority threshold*/
	#define offset_of_isp3_reg_dnr_rdma_pri_thd (120)
	#define mask_of_isp3_reg_dnr_rdma_pri_thd (0xf00)
	unsigned int reg_dnr_rdma_pri_thd:4;

	// h003c, bit: 12
	/* DNR read dma miu high priority enable*/
	#define offset_of_isp3_reg_dnr_rdma_hpri_en (120)
	#define mask_of_isp3_reg_dnr_rdma_hpri_en (0x1000)
	...
	// h003d, bit: 0
	/* Motion (SAD) enable*/
	#define offset_of_isp3_reg_motion_en (122)
	#define mask_of_isp3_reg_motion_en (0x1)
	unsigned int reg_motion_en:1;

	// h003d, bit: 4
	/* Motion MIU store burst byte count
	(1count=16bytes, MIU defaule=128 bytes)*/
	#define offset_of_isp3_reg_mot_burst_cnt (122)
	#define mask_of_isp3_reg_mot_burst_cnt (0x1e)
	...
	// h003d, bit: 14
	/* Motion threshold*/
	#define offset_of_isp3_reg_motion_thrd (122)
	#define mask_of_isp3_reg_motion_thrd (0xff00)
	...
	#define offset_of_isp3_reg_mot_fb_base (124)
	#define mask_of_isp3_reg_mot_fb_base (0xffff)
	...
	// h003f, bit: 10
	/* Motion frame buffer base address*/
	#define offset_of_isp3_reg_mot_fb_base_1 (126)
	#define mask_of_isp3_reg_mot_fb_base_1 (0x7ff)
	...
	#define offset_of_isp3_reg_dnr_wdma_uaddr (128)
	#define mask_of_isp3_reg_dnr_wdma_uaddr (0xffff)
	...
	// h0041, bit: 10
	/* DNR dma write address upper bound*/
	#define offset_of_isp3_reg_dnr_wdma_uaddr_1 (130)
	#define mask_of_isp3_reg_dnr_wdma_uaddr_1 (0x7ff)
	...
	#define offset_of_isp3_reg_dnr_wdma_adr_over_max (130)
	#define mask_of_isp3_reg_dnr_wdma_adr_over_max (0x8000)
	...
	2'd1: Current frame
	2'd2: Debug data*/
	#define offset_of_isp3_reg_dnr_ofrm_sel (132)
	#define mask_of_isp3_reg_dnr_ofrm_sel (0x3)
	...
	1'b0: Black frame
	1'b1: Current frame*/
	#define offset_of_isp3_reg_rot_ofrm_sel (132)
	#define mask_of_isp3_reg_rot_ofrm_sel (0x4)
	...
	// h0043, bit: 0
	/* ROT enable*/
	#define offset_of_isp3_reg_rot_en (134)
	#define mask_of_isp3_reg_rot_en (0x1)
	unsigned int reg_rot_en:1;

	// h0043, bit: 4
	/* ROT output rate control */
	#define offset_of_isp3_reg_rot_rate_cyc (134)
	#define mask_of_isp3_reg_rot_rate_cyc (0x1e)
	...
	// h0044, bit: 14
	/* dnr wdma status*/
	#define offset_of_isp3_reg_dnr_wdma_status (136)
	#define mask_of_isp3_reg_dnr_wdma_status (0xffff)
	...
	// h0045, bit: 14
	/* dnr wdma status*/
	#define offset_of_isp3_reg_dnr_rdma_status (138)
	#define mask_of_isp3_reg_dnr_rdma_status (0xffff)
	...
	#define mask_of_isp3_reg_awb_blksize_x_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_awb_blksize_y_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_awb_blk_h_offset (0xfff)
	...
	#define mask_of_isp3_reg_awb_blk_v_offset (0xfff)
	...
	#define mask_of_isp3_reg_awb_blk_valid_x_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_awb_blk_valid_y_m1 (0x3ff)
	...
	#define offset_of_isp3_reg_histo_int_row_num (192)
	#define mask_of_isp3_reg_histo_int_row_num (0x7f00)
	...
	#define mask_of_isp3_reg_histo_blksize_x_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_histo_blksize_y_m1 (0x3ff)
	...
	#define mask_of_isp3_reg_histo_blk_h_offset (0xfff)
	...
	#define mask_of_isp3_reg_histo_blk_v_offset (0xfff)
...
}  __attribute__((packed, aligned(1))) mercury5_reg_isp3;
#endif
