...
typedef struct
{
    volatile mercury5_reg_isp0  *isp0_cfg;
    volatile mercury5_reg_isp1  *isp1_cfg;
    volatile mercury5_reg_isp2  *isp2_cfg;
    volatile mercury5_reg_isp3  *isp3_cfg;
    volatile mercury5_reg_isp3  *stats_alsc_dnr_cfg;
   //mercury5_reg_isp4         volatile *miu;
    volatile mercury5_reg_isp4  *isp4_cfg;
    volatile mercury5_reg_isp5  *isp5_cfg;
    volatile mercury5_reg_isp6  *isp6_cfg;
    volatile mercury5_reg_isp7  *isp7_cfg;
    volatile mercury5_reg_isp8  *isp8_cfg;
    volatile mercury5_reg_isp9  *isp9_cfg;
    volatile mercury5_reg_isp10 *isp10_cfg;
    volatile mercury5_reg_isp11 *isp11_cfg;
    volatile mercury5_reg_isp12 *isp12_cfg;
    volatile mercury5_reg_isp_miu2sram  *mload_cfg;
    volatile mercury5_reg_isp_miu2sram  *scl_mload_cfg;
    volatile mercury5_reg_isp_dmag  *dma0_cfg;
    volatile mercury5_reg_isp_dmag  *dma1_cfg;
    volatile  mercury5_reg_isp_dmag *dma2_cfg;
    volatile mercury5_reg_isp_dmag  *dma3_cfg;
    volatile mercury5_reg_vif   *vif_cfg;
    //isp7_pgen_cfg_t           volatile *pgen_cfg;
