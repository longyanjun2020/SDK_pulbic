...
#define IMI_HF              (0x0001 << 9) // when 1, the IMI is set in its high frequency mode and a wait state is inserted for each non sequenctial read access. No wia tstate is inserted for read sequential accesses
...
#define SYSREG_MEMCFG_BANK3_MSK	(1<<SYSREG_MEMCFG_BANK3_OFF)
#define SYSREG_MEMCFG_BANK3_TO_CPU	(1<<SYSREG_MEMCFG_BANK3_OFF)
#define SYSREG_MEMCFG_BANK3_TO_DSP	(0<<SYSREG_MEMCFG_BANK3_OFF)
...
#define SYSREG_MEMCFG_BANK4_MSK	(1<<SYSREG_MEMCFG_BANK4_OFF)
#define SYSREG_MEMCFG_BANK4_TO_CPU	(1<<SYSREG_MEMCFG_BANK4_OFF)
#define SYSREG_MEMCFG_BANK4_TO_DSP	(0<<SYSREG_MEMCFG_BANK4_OFF)
...
#define SYSREG_MEMCFG_IMI2_OFF	22
#define SYSREG_MEMCFG_IMI2_MSK	(1<<SYSREG_MEMCFG_IMI2_OFF)
#define SYSREG_MEMCFG_IMI2_TO_CPU	1
#define SYSREG_MEMCFG_IMI2_TO_DSP	0
...
extern volatile W5SysReg_t* const g_ptW5SysReg;
