...
*/
    ...
    u32 :28; /// [0x2F]
    /* [0x30] */
    u32 reg_dma_start                 :1 ; /// Reserved
    u32 :31; /// [0x30]
    /* [0x31] */
    u32 reg_dma_cnt                   :16; /// Reserved
    u32 :16; /// [0x31]
    /* [0x32] */
    u32 reg_dma_miu_start_adr1        :16; /// Reserved
    u32 :16; /// [0x32]
    /* [0x33] */
    u32 reg_dma_miu_start_adr2        :16; /// Reserved
    u32 :16; /// [0x33]
    /* [0x34] */
    u32 reg_dma_busy                  :1 ; /// Reserved
    u32 reg_dma_done                  :1 ; /// Reserved
    u32 :30; /// [0x34]
    /* [0x35] */
    u32 reg_dma_cnt_status            :16; /// Reserved
    u32 :16; /// [0x35]
    /* [0x36] */
...
*/
    ...
    u32 :32; /// [0x39]
    /* [0x3A] */
    u32 reg_one_way                   :1 ; /// It will transfer a pulse to a level signal  when this register be written.
                                           /// 
    u32 :31; /// [0x3A]
    u32 :32; /// [0x3B]
    /* [0x3C] */
    u32 reg_spi_bypass_pwd            :16; /// Force SPI_PAD as input mode. (PWD = 0xaaaa)
    u32 :16; /// [0x3C]
    u32 :32; /// [0x3D]
    u32 :32; /// [0x3E]
    /* [0x3F] */
...
extern volatile KePagingSpi_t* const g_ptKePagingSpi;
