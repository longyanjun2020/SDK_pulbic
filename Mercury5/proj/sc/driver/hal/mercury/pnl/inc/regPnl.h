...
#define LCD_FRM_END_ST      BIT0
#define LCD_IDX_RDY_ST      BIT1
#define LCD_CMD_RDY_ST      BIT2
#define LCD_RGB_VSYNC_ST        BIT3
#define LCD_RGB_FRM_CNT_HIT_ST BIT4

#define LCD_BUSY_ST             BIT5
#define LCD_RGB_HSYNC_ST        BIT6
#define LCD_RGB_LINE1_MATCH_INT_ST          BIT7
#define LCD_RGB_LINE2_MATCH_INT_ST          BIT8

#define LCD_FLM_INT_ST          BIT9
#define LCD_RGB_UNFLOW_ST       BIT12
...
#define PNL_RGB_DTYPE                   (REG_PNL_BASE +REG_PNL_19)
        ...
        #define YUV422_D16BIT_Y1V_Y0U           BITS(5:0,0x17) //(BIT5|BIT2|BIT1|BIT0) //0x27
        #define YUV422_D16BIT_Y1U_Y0V           BITS(5:0,0x16) //(BIT5|BIT2|BIT1)        //0x26
        #define YUV422_D16BIT_Y0V_Y1U           BITS(5:0,0x15) //(BIT5|BIT2|BIT0)       //0x25
        #define YUV422_D16BIT_Y0U_Y1V           BITS(5:0,0x14) //(BIT5|BIT2)            //0x24
        #define YUV422_D16BIT_VY1_UY0           BITS(5:0,0x13) //(BIT5|BIT1|BIT0)       //0x23
        #define YUV422_D16BIT_UY1_VY0           BITS(5:0,0x12) //(BIT5|BIT1)            //0x22
        #define YUV422_D16BIT_VY0_UY1           BITS(5:0,0x11) //(BIT5|BIT0)            //0x21
        #define YUV422_D16BIT_UY0_VY1           BITS(5:0,0x10) //(BIT5)
...
#define PNL_RGB_CTL_4       (REG_PNL_BASE +REG_PNL_3A)      //for parallel panel only
        ...
        #define LCD_OUT_RGB_TYPE_MASK            BIT0
...
#define PNL_PL_LCD_AUTO_CFG         (REG_PNL_BASE +REG_PNL_4E)      //
     #define AUTO_TX_TYPE_IDX               0x0000
        ...
        #define LCD_TX_TYPE_MASK(_n)            (1 << _n)
...
#define PNL_PL_LCD_FMT          (REG_PNL_BASE +REG_PNL_51)      //
     #define LCD_SPI1_PL2                               0x00 //[Reserved:ShouldNotToRemoved]
        ...
        #define LCD_P_EN_MASK                           (BIT1|BIT0)
...
#define PNL_CCIR656_CTL               (REG_PNL_BASE +REG_PNL_60)      //
      #define CCIR656_OUT_EN                      BIT0
      #define CCIR656_INTERLACE_EN                BIT1
//------------------------------------------------------------------------------
// Dec Misc Setting
//------------------------------------------------------------------------------
...
#define CLKG_ODCLK_CTRL0     (REG_CKG_BASE+BK_REG(0x54))
    ...
    #define CKG_ODCLK_MSK                   BITMASK(4:2)
