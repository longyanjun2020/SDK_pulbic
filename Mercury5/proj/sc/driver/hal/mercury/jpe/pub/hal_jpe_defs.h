...
#define JPE_MSG(dbglv, _fmt, _args...)                          \
    do if (dbglv <= JPE_MSG_LEVEL) {                            \
        UartSendTrace(JPE_MSG_TITLE  _fmt, JPE_MSG_FUNC, ## _args);   \
    } while(0)
...
#endif  // JPE_MSG_ENABLE

typedef enum
{
    JPE_HAL_DEV_IDLE = 0,
    JPE_HAL_DEV_BUSY,
    JPE_HAL_DEV_ENC_DONE,
    JPE_HAL_DEV_OUTBUF_FULL,
    JPE_HAL_DEV_INBUF_FULL
} JpeHalDevStatus_e;

typedef enum
{
    JPE_HAL_IOC_RET_SUCCESS             = 0,
    JPE_HAL_IOC_RET_BAD_QTABLE          = 1,
    JPE_HAL_IOC_RET_BAD_QP              = 2,
    JPE_HAL_IOC_RET_BAD_BITSOFFSET      = 3,
    JPE_HAL_IOC_RET_BAD_BANKNUM         = 4,
    JPE_HAL_IOC_RET_BAD_INBUF           = 5,
    JPE_HAL_IOC_RET_BAD_OUTBUF          = 6,
    JPE_HAL_IOC_RET_BAD_NULLPTR         = 7,
    JPE_HAL_IOC_RET_BAD_BANKCNT         = 8,
    JPE_HAL_IOC_RET_BAD_LASTZZ          = 9,
    JPE_HAL_IOC_RET_UNKOWN_COMMAND      = 10,
    JPE_HAL_IOC_RET_BAD_VIRTUAL_MEM     = 11,
    JPE_HAL_IOC_RET_NEED_DRIVER_INIT    = 12,
    JPE_HAL_IOC_RET_FMT_NOT_SUPPORT     = 13,
    JPE_HAL_IOC_RET_HW_IS_RUNNING       = 14,
    JPE_HAL_IOC_RET_FAIL                = 15
} JpeHalIocRetStatus_e;
