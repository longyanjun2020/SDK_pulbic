...
//=============================================================================
...
#else
    #define REG_IRQ_BASE                    (0xFD000000 + (0x101900 << 1))
    #define REG_IRQHYP_BASE                 (0xFD000000 + (0x101000 << 1))
    ...
    #define REG_FIQHYP_MASK_L               (REG_INT_BASE_ADDR + 0x0004)
    #define REG_FIQHYP_MASK_H               (REG_INT_BASE_ADDR + 0x0005)
    #define REG_FIQSUP_MASK_L               (REG_INT_BASE_ADDR + 0x0006)
    #define REG_FIQSUP_MASK_H               (REG_INT_BASE_ADDR + 0x0007)
    ...
    #define REG_FIQHYP_CLEAR_L              (REG_INT_BASE_ADDR + 0x000c)
    #define REG_FIQHYP_CLEAR_H              (REG_INT_BASE_ADDR + 0x000d)
    #define REG_FIQSUP_CLEAR_L              (REG_INT_BASE_ADDR + 0x000e)
    #define REG_FIQSUP_CLEAR_H              (REG_INT_BASE_ADDR + 0x000f)
    ...
    #define REG_FIQHYP_PENDING_L            (REG_INT_BASE_ADDR + 0x000c)
    #define REG_FIQHYP_PENDING_H            (REG_INT_BASE_ADDR + 0x000d)
    #define REG_FIQSUP_PENDING_L            (REG_INT_BASE_ADDR + 0x000e)
    #define REG_FIQSUP_PENDING_H            (REG_INT_BASE_ADDR + 0x000f)
    ...
    #define REG_IRQHYP_MASK_L               (REG_INT_BASE_ADDR + 0x0014)
    #define REG_IRQHYP_MASK_H               (REG_INT_BASE_ADDR + 0x0015)
    #define REG_IRQSUP_MASK_L               (REG_INT_BASE_ADDR + 0x0016)
    #define REG_IRQSUP_MASK_H               (REG_INT_BASE_ADDR + 0x0017)
    ...
    #define REG_IRQHYP_PENDING_L            (REG_INT_BASE_ADDR + 0x001c)
    #define REG_IRQHYP_PENDING_H            (REG_INT_BASE_ADDR + 0x001d)
    #define REG_IRQSUP_PENDING_L            (REG_INT_BASE_ADDR + 0x001e)
    #define REG_IRQSUP_PENDING_H            (REG_INT_BASE_ADDR + 0x001f)

//=============================================================================
    #define IRQ_REG(addr)                   (*((volatile MS_U16*)(REG_IRQ_BASE + ((addr) << 2))))
    #define IRQHYP_REG(addr)                (*((volatile MS_U16*)(REG_IRQHYP_BASE + ((addr) << 2))))
