...
//-------------------------------------------------------------------------------------------------
#if 1//defined (MSOS_TYPE_ECOS) || defined (MSOS_TYPE_LINUX) || defined (MSOS_TYPE_NOS) || defined (MSOS_TYPE_UCOS) || defined (MSOS_TYPE_NUTTX) || defined (MSOS_TYPE_OPTEE) || defined(MSOS_TYPE_RTK)

//compatible with Nucleus's task_entry
#if defined(MSOS_TYPE_RTK)
typedef void ( *TaskEntry ) (void *argv);                           ///< Task entry function
#else
...
#if defined (MSOS_TYPE_UCOS) || defined(MSOS_TYPE_RTK)
/// Task priority
typedef enum
{
...
//-------------------------------------------------------------------------------------------------
#if 1//defined(UFO_PUBLIC_HEADER_300) || defined(UFO_PUBLIC_HEADER_212)
