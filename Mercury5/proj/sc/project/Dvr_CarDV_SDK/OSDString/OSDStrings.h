#ifndef _OSDSTRINGS_H_
#define _OSDSTRINGS_H_
typedef enum AHC_OSD_STRING_IDS {
IDS_DS_MANUAL_SETTINGS = 0,
...
extern const unsigned char* gEnglishOSDStringPool[];
extern const unsigned char* gSpanishOSDStringPool[];
extern const unsigned char* gPortugueseOSDStringPool[];
extern const unsigned char* gRussianOSDStringPool[];
extern const unsigned char* gSChineseOSDStringPool[];
extern const unsigned char* gTChineseOSDStringPool[];
extern const unsigned char* gGermanOSDStringPool[];
extern const unsigned char* gFrenchOSDStringPool[];
extern const unsigned char* gItalianOSDStringPool[];
extern const unsigned char* gSlovakOSDStringPool[];
extern const unsigned char* gLatvianOSDStringPool[];
extern const unsigned char* gRomanianOSDStringPool[];
extern const unsigned char* gPolishOSDStringPool[];
extern const unsigned char* gUkraninianOSDStringPool[];
extern const unsigned char* gJapaneseOSDStringPool[];
extern const unsigned char* gKoreanOSDStringPool[];
extern const unsigned char* gCzechOSDStringPool[];
#endif
