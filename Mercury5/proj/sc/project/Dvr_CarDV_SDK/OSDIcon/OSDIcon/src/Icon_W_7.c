...
static GUI_CONST_STORAGE GUI_COLOR ColorsIcon_W_7[] = {
     0xAA50FF,0xFFFFFF
};

static GUI_CONST_STORAGE GUI_LOGPALETTE PalIcon_W_7 = {
  2,	/* number of entries */
  1, 	/* Has transparency */
  &ColorsIcon_W_7[0]
};

static GUI_CONST_STORAGE unsigned char acIcon_W_7[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmIcon_W_7 = {
  16, /* XSize */
  22, /* YSize */
  16, /* BytesPerLine */
  8, /* BitsPerPixel */
  acIcon_W_7,  /* Pointer to picture data (indices) */
  &PalIcon_W_7  /* Pointer to palette */
};
