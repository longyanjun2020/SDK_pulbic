...
static GUI_CONST_STORAGE GUI_COLOR ColorsIcon_W_8[] = {
     0xAA50FF,0xFFFFFF
};

static GUI_CONST_STORAGE GUI_LOGPALETTE PalIcon_W_8 = {
  2,	/* number of entries */
  1, 	/* Has transparency */
  &ColorsIcon_W_8[0]
};

static GUI_CONST_STORAGE unsigned char acIcon_W_8[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmIcon_W_8 = {
  16, /* XSize */
  22, /* YSize */
  16, /* BytesPerLine */
  8, /* BitsPerPixel */
  acIcon_W_8,  /* Pointer to picture data (indices) */
  &PalIcon_W_8  /* Pointer to palette */
};
