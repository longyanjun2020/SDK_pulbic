...
static GUI_CONST_STORAGE GUI_COLOR ColorsIcon_W_5[] = {
     0xAA50FF,0xFFFFFF
};

static GUI_CONST_STORAGE GUI_LOGPALETTE PalIcon_W_5 = {
  2,	/* number of entries */
  1, 	/* Has transparency */
  &ColorsIcon_W_5[0]
};

static GUI_CONST_STORAGE unsigned char acIcon_W_5[] = {
  ...
  0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00,
  0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x00,
...
GUI_CONST_STORAGE GUI_BITMAP bmIcon_W_5 = {
  16, /* XSize */
  22, /* YSize */
  16, /* BytesPerLine */
  8, /* BitsPerPixel */
  acIcon_W_5,  /* Pointer to picture data (indices) */
  &PalIcon_W_5  /* Pointer to palette */
};
