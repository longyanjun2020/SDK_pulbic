...
#define SCD_CAM_PREVIEW_MIRROR          (0)

#ifdef VERTICAL_PANEL
    #define PIP_WIDTH_RATIO             (9)
    #define PIP_HEIGHT_RATIO            (16)

    #if (DISP_HEIGHT > (DISP_WIDTH<<1))
        #define PIP_WIDTH               (DISP_WIDTH>>1)
        #define PIP_HEIGHT              (PIP_WIDTH/PIP_WIDTH_RATIO*PIP_HEIGHT_RATIO)
    #else
        #define PIP_HEIGHT              (DISP_HEIGHT>>1)
        #define PIP_WIDTH               (PIP_HEIGHT/PIP_HEIGHT_RATIO*PIP_WIDTH_RATIO)
    #endif
#else
    #define PIP_WIDTH_RATIO             (16)
    #define PIP_HEIGHT_RATIO            (9)

    #if (DISP_WIDTH > (DISP_HEIGHT<<1))
        #define PIP_HEIGHT              (DISP_HEIGHT>>1)
        #define PIP_WIDTH               (PIP_HEIGHT/PIP_HEIGHT_RATIO*PIP_WIDTH_RATIO)
    #else
        #define PIP_WIDTH               (DISP_WIDTH>>1)
...
#define BIND_SENSOR_IMX307              (0)
#define BIND_SENSOR_OV2643              (0)
#define BIND_SENSOR_OV2710              (0)
#define BIND_SENSOR_OV2710_2ND          (0)
#define BIND_SENSOR_OV2718_MIPI         (0)     //MENU_MOVIE_SIZE_1080P_30_COMBINED_HDR_EN
#define BIND_SENSOR_OV2718_MIPI_2ND     (0)
...
#define BIND_SENSOR_BG0806              (0)
#define BIND_SENSOR_BG0836              (0)
#define BIND_SENSOR_BG0836_MIPI         (0)
#define BIND_SENSOR_PS5260              (0)
#define BIND_SENSOR_PS5280              (0)
#define BIND_SENSOR_SC2363              (0)
#define BIND_SENSOR_SC4233_MIPI         (0)
...
#define BIND_SENSOR_TP2852_MIPI         (0)

// AHD
#define BIND_SENSOR_NVP6124B            (0)
#define BIND_SENSOR_RN6778              (0)
#define BIND_SENSOR_RN6752              (1)
#define BIND_SENSOR_RN6852              (0)
#define BIND_SENSOR_RN6752_MIPI         (0)
#define BIND_SENSOR_RN6852_MIPI         (0)
#define BIND_SENSOR_PR2000              (0)
#define BIND_SENSOR_PR2000_BT656        (0)
#define BIND_SENSOR_NONE_MIPI           (0)


#define SNR_R_CHECK_SIG_STABLE_COUNT    (10)   // 10x20ms
#define SNR_R_CHECK_SIG_TYPE_PERIODIC   (300)  // 300ms
...
#define GSENSOR_MODULE              (GSENSOR_MODULE_RT3000) //GSENSOR_MODULE_RT3000 / GSENSOR_MODULE_LIS3DH /
...
#define VR_VIDEO_TYPE               (COMMON_VR_VIDEO_TYPE_3GP)//COMMON_VR_VIDEO_TYPE_TS
...
//Note: Below options are needed to refer to MMPS_3GPRECD_AUDIO_OPTION
    ...
    #define AHC_AAC_AUDIO_OPTION        MMPS_3GPRECD_AUDIO_AAC_16K_32K
#else
...
#if (VR_VIDEO_TYPE == COMMON_VR_VIDEO_TYPE_TS)
#define VR_AUDIO_TYPE               (VR_AUDIO_TYPE_AAC)
#else
...
#define INFO_ISP_MSG_ON_PNL             (0)//INFO_ISP_MSG_ON_PNL_C must be enable also.
...
#define WAIT_CHECK_BDEVICE_CONN_INTERVAL    (1000)//for 8339 device, Need modify to 4000
#define WAIT_BDEVICE_DISCONN_INTERVAL       (100)
#define WAIT_CHECK_BDEVICE_DISCONN_DELAY_CNT    (8)

#define USB_IN_DETECT_VBUS_PIN              (MMP_GPIO_MAX)//instead of Power key-2 status       (MMP_GPIO25)//B15
...
#define ADC_KEY_VOLT_U              (3280)
#define ADC_KEY_VOLT_D              (1383)
#define ADC_KEY_VOLT_L              (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_R              (ADC_KEY_VOLT_DEFAULT)

#define ADC_KEY_VOLT_ENTER          (ADC_KEY_VOLT_DEFAULT)
#if (MORE_ADC_KEY==1)
#define ADC_KEY_VOLT_REC            (2817)
#define ADC_KEY_VOLT_MENU           (1877)
#define ADC_KEY_VOLT_PLAY           (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_MODE           (2367)
#define ADC_KEY_VOLT_FUNC1          (932)
#define ADC_KEY_VOLT_FUNC2          (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_FUNC3          (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_WIDE           (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_TELE           (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_SOS            (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_MUTE           (461)
#define ADC_KEY_VOLT_CAPTURE        (ADC_KEY_VOLT_DEFAULT)
#endif
...
#define KEY_GPIO_POWER              (MMP_GPIO_MAX)//GetKEYPowerFunc
...
#define TOUCH_RESET_GPIO            (MMP_GPIO_MAX)
 ...
 *  ADAS setting
 *===========================================================================*/
//#define CUS_ADAS_OUTPUT_LOG   //ADAS log save to sd card
