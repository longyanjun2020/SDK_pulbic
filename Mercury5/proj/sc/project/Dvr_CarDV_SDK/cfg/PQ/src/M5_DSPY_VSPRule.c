 ...
 unsigned char MST_VSPRule_IP_Index_DSPY[PQ_VSPRule_IP_NUM_DSPY]=
{
    PQ_IP_VSP_Y_SC1_DSPY,
    PQ_IP_VSP_C_SC1_DSPY,
    PQ_IP_SRAM1_DSPY,
};


 unsigned char MST_VSPRule_Array_DSPY[PQ_VSPRule_NUM_DSPY][PQ_VSPRule_IP_NUM_DSPY]=
{
