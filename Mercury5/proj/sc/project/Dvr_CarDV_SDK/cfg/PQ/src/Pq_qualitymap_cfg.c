...
#if 1
#include "M5_DSPY.c"                  // table config parameter
#include "M5_DSPY_1920.c"             // table config parameter
#include "M5_DSPY_HSPRule.c"          // table config parameter
#include "M5_DSPY_VSPRule.c"          // table config parameter
#include "M5_DSPY_GRule.c"            // table config parameter
#include "M5_DSPY_1920_GRule.c"       // table config parameter
#endif
#endif
