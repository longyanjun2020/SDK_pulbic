 ...
 unsigned char MST_HSPRule_IP_Index_DSPY[PQ_HSPRule_IP_NUM_DSPY]=
{
    PQ_IP_HSP_Y_SC1_DSPY,
    PQ_IP_HSP_C_SC1_DSPY,
    PQ_IP_SRAM2_DSPY,
};


 unsigned char MST_HSPRule_Array_DSPY[PQ_HSPRule_NUM_DSPY][PQ_HSPRule_IP_NUM_DSPY]=
{
