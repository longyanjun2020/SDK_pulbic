...
MAKE_VEN_APP_ITEM(E_VEN_HTTP, VEN_HTTP, MNU_STYLE_STATIC, CLSID_HTTPSRV, VEN_TASK_NUM, CPU_SPEED_LOW, VEN_UI_INT_NORMAL, VEN_DBG_GROUP_0, FALSE, NULL, NULL, NULL, NULL, NULL)
#else
