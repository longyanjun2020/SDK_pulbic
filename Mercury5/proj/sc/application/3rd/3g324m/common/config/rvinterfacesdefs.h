...
#define RV_SEMAPHORE_RTK 10
#define RV_SEMAPHORE_NONE 11 /* No effect, single threaded environment only */
...
#define RV_THREAD_RTK 12
#define RV_THREAD_NONE 13 /* Work as single threaded only */
...
#define RV_LOCK_RTK 10 /* Just use a semaphore */
#define RV_LOCK_NONE 11 /* No locking, single threaded environment only */
