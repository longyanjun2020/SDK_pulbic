...
/* SCTP support */
#if defined(RV_CFLAG_SCTP)
#undef  RV_NET_TYPE
#if defined(RV_CFLAG_IPV6)
#define RV_NET_TYPE RV_NET_IPV6+RV_NET_SCTP
#else
#define RV_NET_TYPE RV_NET_SCTP
#endif
#endif
/* Use of poll() */
...
/* IPsec for IMS support */
#if defined(RV_CFLAG_IMS_IPSEC)
#undef  RV_IMS_IPSEC_ENABLED
#define RV_IMS_IPSEC_ENABLED RV_YES
#endif
