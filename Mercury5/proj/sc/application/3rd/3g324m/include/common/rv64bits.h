...
#define RvInt64Assign(_sign,_ms32,_ls32) ((RvUint64)((_sign)*(((RvUint64)_ms32)<<32)+(_ls32)))
...
#if (RV_OS_TYPE == RV_OS_TYPE_SYMBIAN) && (RV_TOOL_TYPE == RV_TOOL_TYPE_GNU) && (RV_OS_VERSION < RV_OS_SYMBIAN_9)
RVCOREAPI 
RvUint64 RvSymbUint64Div(RvUint64 d1, RvUint64 d2);    
RvInt64 RvSymbInt64Div(RvInt64 d1, RvInt64 d2);    
RvUint64 RvSymbUint64Mod(RvUint64 d1, RvUint64 d2);    
RvInt64 RvSymbInt64Mod(RvInt64 d1, RvInt64 d2);    
#define RvUint64Div RvSymbUint64Div
#define RvInt64Div RvSymbInt64Div
#define RvUint64Mod RvSymbUint64Mod
#define RvInt64Mod RvSymbInt64Mod
#else
