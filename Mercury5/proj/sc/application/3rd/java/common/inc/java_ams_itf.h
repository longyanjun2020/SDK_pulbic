...
enum
{
...
#ifdef JAVAAMS_REMOVE_ALL
    JAVA_AMS_REMOVE_ALL_SUITE,
#endif
#endif
...
#ifdef __NCC_3RD_JAVA_PORTING_LAYER__
    JAVA_AMS_SET_NET_PROFILE,
    JAVA_AMS_GET_NET_PROFILE,
    JAVA_AMS_RST_PREINSTALL,
    JAVA_AMS_RST_NETPROFILE,
#endif
    ...
    JAVA_PUSH_REGISTER_NDEF,
    JAVA_PUSH_DEREGISTER_NDEF,
#endif
...
{
    int retCode;
}Jams_SetNetProfileRsp_t;

typedef struct
{
    int retCode;
    u32 simCard;
}Jams_GetNetProfileRsp_t;
#endif
...
typedef struct
{
    ...
    u32 SemID;
    int *retCode;
} Jams_PushReqisterNDEFReq_t,Jams_PushDeReqisterNDEFReq_t;
#endif
...
#ifdef __NCC_3RD_JAVA_PORTING_LAYER__
   Jams_SetJavaNetProfile_t AmsSetJavaNetProfileReq;
#endif
} Jams_req_data_t;
...
#ifdef __JAVA_OAKMONT_NFC_PUSH_SUPPORT__
   //3rd to MMI
   Jams_PushReqisterNDEFReq_t		    amsPushRegisterNDEFReq;
   Jams_PushDeReqisterNDEFReq_t		amsPushDeRegisterNDEFReq;
#endif

#ifdef __NCC_3RD_JAVA_PORTING_LAYER__
   Jams_SetNetProfileRsp_t     amsSetNetProfileRsp;
   Jams_GetNetProfileRsp_t     amsGetNetProfileRsp;
   Jams_CommonRsp_t            amsCommonRsp;
#endif
 } Jams_rsp_data_t;
