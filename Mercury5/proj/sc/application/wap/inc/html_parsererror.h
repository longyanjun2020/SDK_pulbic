...
#ifndef __HTML_PARSERERROR_H__
#define __HTML_PARSERERROR_H__
...
typedef enum {
    ...
    XML_HTML_STRUCURE_ERROR, /** 93*/
    XML_HTML_UNKNOWN_TAG /** 94 */
}xmlParserErrors;

extern void *xmlGenericErrorContext;
void
xmlGenericError(void *ctx, const int8_t *msg, ...);

#ifdef __cplusplus
}
#endif

#endif /* __HTML_PARSERERROR_H__ */
