...
#define ft_scalloc(x)       //calloc                              // not used now
#define ft_sfree(x)         MsHMEMFree(x,0)
#define ft_smalloc(x)       MsHMEMMalloc(ftHmemCacheHandle,x,0)
#define ft_srealloc(x,y)    MsHMEMRealloc(ftHmemCacheHandle,x,y,0)
