/**
* @file    mmi_srv_cl_priv.h
* @brief
*
*/

#ifndef __MMI_SRV_CL_PRIV_H__
#define __MMI_SRV_CL_PRIV_H__
...
*/
MAE_Ret SrvClCreate(SrvClient_t *pClient, s32 *pData);
...
@return MAE_RET_FAILED                  If an error happen.
*/
MAE_Ret SrvClDestroy(SrvClient_t *pClient, s32 *pData);

/*-----------------------------------------------------*/
#endif //__MMI_SRV_CL_PRIV_H__
