...
//declared in kmx library, keep these for header file consistence
#if 0
 ...
 * after the function successfully returned, pointer points to raw_ldb_buffer can be used as database for all the 
 * ldb interface. 
 */
...
int kmx_relocate_layout(unsigned char *layout_buffer,int size);
