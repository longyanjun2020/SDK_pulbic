...
#  PATH_PicViewerApp:
#  the directory that contains the file PicViewerApp.mak.
#  The build process needs this variable to find the makefile
#  and compile PicViewerApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_PicViewerApp)/inc/priv \
    $(PATH_PicViewerApp)/res \
    $(PATH_ResMgr)/inc \
    $(PATH_ResMgr)/inc/ABL \
...
SRC_C_LIST = \
    mmi_picviewerapp.c \
    mmi_picviewerapp_util.c

PATH_C = $(PATH_PicViewerApp)/src
