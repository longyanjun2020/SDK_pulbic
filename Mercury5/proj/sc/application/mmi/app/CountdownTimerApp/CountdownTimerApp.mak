...
#  PATH_CountdownTimerApp:
#  the directory that contains the file CountdownTimerApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CountdownTimerApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_build) \
    $(PATH_core)/pub \
    $(PATH_CountdownTimerApp)/inc \
    $(PATH_CountdownTimerApp)/inc/priv \
    $(PATH_CountdownTimerApp)/res \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
    $(PATH_fc)/pub \
...
SRC_C_LIST = \
    mmi_countdowntimerapp.c

PATH_C = $(PATH_CountdownTimerApp)/src
