...
#  PATH_ShortcutPhbApp:
#  the directory that contains the file ShortcutPhbApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ShortcutPhbApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_sdk)/inc \
    $(PATH_sdk)/pub \
    $(PATH_ShortcutPhbApp)/inc \
    $(PATH_ShortcutPhbApp)/inc/priv \
    $(PATH_ShortcutPhbApp)/res \
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
    $(PATH_sys)/pub \
    $(PATH_time)/pub \
...
PATH_C = $(PATH_ShortcutPhbApp)/src
