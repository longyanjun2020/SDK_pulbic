...
#  PATH_AtvApp:
#  the directory that contains the file AtvApp.mak.
#  The build process needs this variable to find the makefile
#  and compile AtvApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_atvapp.c \
    mmi_atvapp_esgparser.c \
    mmi_atvapp_esgtagstack.c \
    mmi_atvapp_util.c \
    mmi_atvapp_xmlparser.c

PATH_C = $(PATH_AtvApp)/src
