...
#  PATH_AndroidMainMenuApp:
#  the directory that contains the file AndroidMainMenuApp.mak.
#  The build process needs this variable to find the makefile
#  and compile AndroidMainMenuApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_AndroidMainMenuApp)/inc/priv \
    $(PATH_AndroidMainMenuApp)/res \
...
SRC_C_LIST = \
    mmi_android_mainmenuapp.c

PATH_C = $(PATH_AndroidMainMenuApp)/src
