...
#  PATH_DesktopWidget:
#  the directory that contains the file DesktopWidget.mak.
#  The build process needs this variable to find the makefile
#  and compile DesktopWidget.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_wdg_aclockdesktop.c \
    mmi_wdg_calendardesktop.c \
    mmi_wdg_dclockdesktop.c \
    mmi_wdg_desktop.c \
    mmi_wdg_fmdesktop.c \
    mmi_wdg_infodesktopwidget.c \
    mmi_wdg_messagedesktop.c \
    mmi_wdg_mpdesktop.c \
    mmi_wdg_notedesktop.c \
    mmi_wdg_notepaddesktop.c \
    mmi_wdg_opdesktop.c \
    mmi_wdg_rotatecube.c \
    mmi_wdg_petdesktop.c \
    mmi_wdg_phonebookdesktop.c \
    mmi_wdg_photodesktop.c \
    mmi_wdg_profile.c \
    mmi_wdg_searchdesktop.c \
    mmi_wdg_shortcutdesktop.c \
    mmi_wdg_statuspage.c

PATH_C = $(PATH_DesktopWidget)/src
