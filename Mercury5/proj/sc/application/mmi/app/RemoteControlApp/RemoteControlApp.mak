...
#  PATH_RemoteControlApp:
#  the directory that contains the file RemoteControlApp.mak.
#  The build process needs this variable to find the makefile
#  and compile RemoteControlApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_RemoteControlApp)/inc \
    $(PATH_RemoteControlApp)/inc/priv \
    $(PATH_ResMgr)/inc \
    $(PATH_ResMgr)/inc/ABL \
...
SRC_C_LIST = \
    mmi_remotecontrolapp.c

PATH_C = $(PATH_RemoteControlApp)/src
