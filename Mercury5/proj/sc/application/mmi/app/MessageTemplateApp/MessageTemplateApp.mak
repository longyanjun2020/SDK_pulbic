...
#  PATH_MessageTemplateApp:
#  the directory that contains the file MessageTemplateApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MessageTemplateApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MessageTemplateApp)/inc/priv \
    $(PATH_MessageTemplateApp)/res \
...
SRC_C_LIST = \
    mmi_messagetemplateapp.c

PATH_C = $(PATH_MessageTemplateApp)/src
