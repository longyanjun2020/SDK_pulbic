...
#  PATH_G3DMainMenuApp:
#  the directory that contains the file G3DMainMenuApp.mak.
#  The build process needs this variable to find the makefile
#  and compile G3DMainMenuApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_G3DMainMenuApp)/inc \
    $(PATH_G3DMainMenuApp)/inc/priv \
    $(PATH_G3DMainMenuApp)/res \
    $(PATH_gss)/pub \
    $(PATH_i18n)/inc \
...
SRC_C_LIST = \
    mmi_g3dmainmenuapp.c

PATH_C = $(PATH_G3DMainMenuApp)/src
