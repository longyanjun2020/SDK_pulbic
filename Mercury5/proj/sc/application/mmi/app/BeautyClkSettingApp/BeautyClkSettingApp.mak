...
#  PATH_BeautyClkSettingApp:
#  the directory that contains the file BeautyClkSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile BeautyClkSettingApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_audio_mdl)/pub \
    $(PATH_BeautyClkSettingApp)/inc \
    $(PATH_BeautyClkSettingApp)/inc/priv \
    $(PATH_BeautyClkSettingApp)/res \
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
...
SRC_C_LIST = \
    mmi_beautyclksettingapp.c

PATH_C = $(PATH_BeautyClkSettingApp)/src
