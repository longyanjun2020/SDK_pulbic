...
#  PATH_EvtCenterApp:
#  the directory that contains the file EvtCenterApp.mak.
#  The build process needs this variable to find the makefile
#  and compile EvtCenterApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_EvtCenterApp)/inc/priv \
    $(PATH_EvtCenterApp)/res \
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_gss)/pub \
    $(PATH_i18n)/inc \
