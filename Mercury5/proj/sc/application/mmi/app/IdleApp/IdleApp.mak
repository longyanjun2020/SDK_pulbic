...
#  PATH_IdleApp:
#  the directory that contains the file IdleApp.mak.
#  The build process needs this variable to find the makefile
#  and compile IdleApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_idleapp.c \
    mmi_idleappgadget_util.c \
    mmi_idleapp_multipage_ext.c \
    mmi_idlepedometer_util.c

PATH_C = $(PATH_IdleApp)/src
