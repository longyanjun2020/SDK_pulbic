...
#  PATH_CbSettingApp:
#  the directory that contains the file CbSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CbSettingApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_CbSettingApp)/inc \
    $(PATH_CbSettingApp)/inc/priv \
    $(PATH_CbSettingApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
