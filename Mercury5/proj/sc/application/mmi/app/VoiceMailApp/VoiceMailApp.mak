...
#  PATH_VoiceMailApp:
#  the directory that contains the file VoiceMailApp.mak.
#  The build process needs this variable to find the makefile
#  and compile VoiceMailApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_VoiceMailApp)/inc/priv \
    $(PATH_VoiceMailApp)/res \
    $(PATH_widget)/inc \
