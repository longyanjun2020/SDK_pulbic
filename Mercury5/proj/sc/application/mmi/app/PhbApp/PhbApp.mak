...
#  PATH_PhbApp:
#  the directory that contains the file PhbApp.mak.
#  The build process needs this variable to find the makefile
#  and compile PhbApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_phbapp.c \
    mmi_phbapp_callback.c \
    mmi_phbapp_urlhandler.c

PATH_C = $(PATH_PhbApp)/src
