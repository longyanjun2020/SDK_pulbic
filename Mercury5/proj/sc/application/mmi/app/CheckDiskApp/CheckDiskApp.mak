...
#  PATH_CheckDiskApp:
#  the directory that contains the file CheckDiskApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CheckDiskApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_audio_mdl)/pub \
    $(PATH_build) \
    $(PATH_CheckDiskApp)/inc \
    $(PATH_CheckDiskApp)/inc/priv \
    $(PATH_CheckDiskApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_fc)/pub \
