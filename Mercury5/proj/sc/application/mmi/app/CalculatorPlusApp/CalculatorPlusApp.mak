...
#  PATH_CalculatorPlusApp:
#  the directory that contains the file CalculatorPlusApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CalculatorPlusApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_audio_mdl)/pub \
    $(PATH_build) \
    $(PATH_CalculatorPlusApp)/inc \
    $(PATH_CalculatorPlusApp)/inc/priv \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_fc)/pub \
...
SRC_C_LIST = \
    mmi_calculatorplusapp.c \
    mmi_calcAbstractLayer.c

PATH_C = $(PATH_CalculatorPlusApp)/src
