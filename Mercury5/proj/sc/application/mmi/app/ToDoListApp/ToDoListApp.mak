...
#  PATH_ToDoListApp:
#  the directory that contains the file ToDoListApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ToDoListApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_time)/pub \
    $(PATH_timer)/pub \
    $(PATH_ToDoListApp)/inc \
    $(PATH_ToDoListApp)/inc/priv \
    $(PATH_ToDoListApp)/res \
    $(PATH_trc)/pub \
    $(PATH_vfs)/pub \
    $(PATH_widget)/inc \
...
SRC_C_LIST = \
    mmi_todolistapp.c \
    mmi_todolistapp_view.c

PATH_C = $(PATH_ToDoListApp)/src
