...
#  PATH_CallSettingApp:
#  the directory that contains the file CallSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CallSettingApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_callsettingapp.c \
    mmi_callsettingapp_util.c

PATH_C = $(PATH_CallSettingApp)/src
