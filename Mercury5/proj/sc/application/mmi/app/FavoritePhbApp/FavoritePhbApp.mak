...
#  PATH_FavoritePhbApp:
#  the directory that contains the file FavoritePhbApp.mak.
#  The build process needs this variable to find the makefile
#  and compile FavoritePhbApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
    $(PATH_FavoritePhbApp)/inc \
    $(PATH_FavoritePhbApp)/inc/priv \
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_FileMgrApp)/inc \
    $(PATH_fms)/pub \
...
PATH_C = $(PATH_FavoritePhbApp)/src
