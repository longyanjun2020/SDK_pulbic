...
#  PATH_IdlePreviewApp:
#  the directory that contains the file IdlePreviewApp.mak.
#  The build process needs this variable to find the makefile
#  and compile IdlePreviewApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_gss)/pub \
    $(PATH_i18n)/inc \
    $(PATH_IdlePreviewApp)/inc \
    $(PATH_IdlePreviewApp)/inc/priv \
    $(PATH_IdlePreviewApp)/res \
...
SRC_C_LIST = \
    mmi_idlepreviewapp.c

PATH_C = $(PATH_IdlePreviewApp)/src
