...
#  PATH_CalibrationApp:
#  the directory that contains the file CalibrationApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CalibrationApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_CalibrationApp)/inc \
    $(PATH_CalibrationApp)/inc/priv \
    $(PATH_CalibrationApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
...
SRC_C_LIST = \
    mmi_calibrationapp.c

PATH_C = $(PATH_CalibrationApp)/src
