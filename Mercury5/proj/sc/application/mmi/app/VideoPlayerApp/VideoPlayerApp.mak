...
#  PATH_VideoPlayerApp:
#  the directory that contains the file VideoPlayerApp.mak.
#  The build process needs this variable to find the makefile
#  and compile VideoPlayerApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_trc)/pub \
    $(PATH_vfs)/pub \
    $(PATH_VideoPlayerApp)/inc \
    $(PATH_VideoPlayerApp)/inc/priv \
    $(PATH_VideoPlayerApp)/res \
    $(PATH_widget)/inc \
...
SRC_C_LIST = \
    mmi_videoplayerapp.c \
    mmi_videoplayerapp_util.c

PATH_C = $(PATH_VideoPlayerApp)/src
