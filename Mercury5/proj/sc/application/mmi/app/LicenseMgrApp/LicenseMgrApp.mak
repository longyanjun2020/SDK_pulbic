...
#  PATH_LicenseMgrApp:
#  the directory that contains the file LicenseMgrApp.mak.
#  The build process needs this variable to find the makefile
#  and compile LicenseMgrApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_LicenseMgrApp)/inc \
    $(PATH_LicenseMgrApp)/inc/priv \
    $(PATH_LicenseMgrApp)/res \
    $(PATH_mae)/pub \
