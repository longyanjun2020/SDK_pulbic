...
#  PATH_MmsSettingApp:
#  the directory that contains the file MmsSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MmsSettingApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MmsSettingApp)/inc/priv \
    $(PATH_MmsSettingApp)/res \
    $(PATH_model)/pub \
    $(PATH_mserv)/inc \
    $(PATH_MsWrapper)/pub \
