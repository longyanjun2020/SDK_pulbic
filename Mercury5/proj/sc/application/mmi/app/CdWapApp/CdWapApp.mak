...
#  PATH_CdWapApp:
#  the directory that contains the file CdWapApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CdWapApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_cdwapapp.c \
    mmi_cdwapapp_common.c \
    mmi_cdwapapp_interface.c

PATH_C = $(PATH_CdWapApp)/src
