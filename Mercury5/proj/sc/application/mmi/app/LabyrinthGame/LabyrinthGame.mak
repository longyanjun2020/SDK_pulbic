...
#  PATH_LabyrinthGame:
#  the directory that contains the file LabyrinthGame.mak.
#  The build process needs this variable to find the makefile
#  and compile LabyrinthGame.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_LabyrinthGame)/inc \
    $(PATH_LabyrinthGame)/inc/priv \
    $(PATH_mae)/pub \
    $(PATH_mmi_res) \
...
REL_SRC_C_LIST = \
    mmi_labyrinthgame.c \
    mmi_labyrinthgame_ge.c

PATH_C = $(PATH_LabyrinthGame)/src
