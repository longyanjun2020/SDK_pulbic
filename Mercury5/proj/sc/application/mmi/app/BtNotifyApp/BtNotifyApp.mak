...
#  PATH_BtNotifyApp:
#  the directory that contains the file BtNotifyApp.mak.
#  The build process needs this variable to find the makefile
#  and compile BtNotifyApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_audio_mdl)/pub \
    $(PATH_bluetooth)/pub \
    $(PATH_BtNotifyApp)/inc \
    $(PATH_BtNotifyApp)/inc/priv \
    $(PATH_BtNotifyApp)/res \
    $(PATH_build) \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
