...
#  PATH_AngryBird:
#  the directory that contains the file AngryBird.mak.
#  The build process needs this variable to find the makefile
#  and compile AngryBird.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_FishFuryGame)/inc \
    $(PATH_FishFuryGame)/inc/priv \
    $(PATH_mae)/pub \
    $(PATH_mae)/inc \
    $(PATH_mmi_res) \
...
REL_SRC_C_LIST = \
    mmi_fishfurygame.c \
    mmi_fishfurygame_actors.c \
    mmi_fishfurygame_mainscene.c \
    mmi_fishfurygame_menuscene.c \
    mmi_fishfurygame_pausescene.c \
    mmi_fishfurygame_helpscene.c \
    mmi_fishfurygame_playscene.c \
    mmi_fishfurygame_gameoverscene.c

PATH_C = $(PATH_FishFuryGame)/src
