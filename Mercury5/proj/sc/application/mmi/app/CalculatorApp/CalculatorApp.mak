...
#  PATH_CalculatorApp:
#  the directory that contains the file CalculatorApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CalculatorApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_audio_mdl)/pub \
    $(PATH_build) \
    $(PATH_CalculatorApp)/inc \
    $(PATH_CalculatorApp)/inc/priv \
    $(PATH_CalculatorApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_fc)/pub \
