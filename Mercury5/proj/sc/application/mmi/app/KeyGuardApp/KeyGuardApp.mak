...
#  PATH_KeyGuardApp:
#  the directory that contains the file KeyGuardApp.mak.
#  The build process needs this variable to find the makefile
#  and compile KeyGuardApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_KeyGuardApp)/inc/priv \
    $(PATH_KeyGuardApp)/res \
    $(PATH_mae)/pub \
    $(PATH_mae)/src \
    $(PATH_mmi_res) \
