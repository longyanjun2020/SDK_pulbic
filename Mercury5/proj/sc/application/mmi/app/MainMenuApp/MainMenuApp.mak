...
#  PATH_MainMenuApp:
#  the directory that contains the file MainMenuApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MainMenuApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MainMenuApp)/inc/priv \
    $(PATH_MainMenuApp)/res \
...
SRC_C_LIST = \
    mmi_mainmenuapp.c \
    mmi_mainmenuapp_ifonestyle.c

PATH_C = $(PATH_MainMenuApp)/src
