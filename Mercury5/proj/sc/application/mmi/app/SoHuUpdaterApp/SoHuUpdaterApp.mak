...
#  PATH_SoHuUpdaterApp:
#  the directory that contains the file SoHuUpdaterApp.mak.
#  The build process needs this variable to find the makefile
#  and compile SoHuUpdaterApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_sdk)/inc \
    $(PATH_sdk)/pub \
    $(PATH_SoHuUpdaterApp)/inc \
    $(PATH_SoHuUpdaterApp)/inc/priv \
    $(PATH_SoHuUpdaterApp)/inc/util \
    $(PATH_SoHuUpdaterApp)/res \
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
    $(PATH_sys)/pub \
    $(PATH_time)/pub \
...
PATH_C = $(PATH_SoHuUpdaterApp)/src

PATH_C += $(PATH_SoHuUpdaterApp)/src/util
