...
#  PATH_MessageEditorApp:
#  the directory that contains the file MessageEditorApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MessageEditorApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MessageEditorApp)/inc/priv \
    $(PATH_MessageEditorApp)/res \
    $(PATH_MessageTemplateApp)/inc \
...
SRC_C_LIST = \
    mmi_messageeditorapp.c \
    mmi_messageeditorapp_handler.c \
    mmi_messageeditorapp_mms.c \
    mmi_messageeditorapp_recipients.c \
    mmi_messageeditorapp_sms.c \
    mmi_messageeditorapp_util.c

PATH_C = $(PATH_MessageEditorApp)/src
