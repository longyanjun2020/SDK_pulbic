...
#  PATH_CallerLocationApp:
#  the directory that contains the file CallerLocationApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CallerLocationApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_CallerLocationApp)/inc \
    $(PATH_CallerLocationApp)/inc/priv \
    $(PATH_CallerLocationApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
...
SRC_C_LIST = \
    mmi_callerlocationapp.c \
    mmi_callerlocationapp_view.c

PATH_C = $(PATH_CallerLocationApp)/src
