...
#  PATH_SettingApp:
#  the directory that contains the file SettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile SettingApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_settingapp.c \
    mmi_settingapp_util.c \
    mmi_settingapp_view.c

PATH_C = $(PATH_SettingApp)/src
