...
#  PATH_AliveWidget:
#  the directory that contains the file AliveWidget.mak.
#  The build process needs this variable to find the makefile
#  and compile AliveWidget.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_AliveWidget)/inc/priv \
    $(PATH_AliveWidget)/res \
