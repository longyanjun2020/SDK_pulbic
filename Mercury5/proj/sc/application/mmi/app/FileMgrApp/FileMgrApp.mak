...
#  PATH_FileMgrApp:
#  the directory that contains the file FileMgrApp.mak.
#  The build process needs this variable to find the makefile
#  and compile FileMgrApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_filemgrapp.c \
    mmi_filemgrapp_cmn.c \
    mmi_filemgrapp_info.c \
    mmi_filemgrapp_lister.c \
    mmi_filemgrapp_medialist.c \
    mmi_filemgrapp_operation.c \
    mmi_filemgrapp_predefine.c \
    mmi_filemgrapp_util.c \
    mmi_filemgrapp_view.c

PATH_C = $(PATH_FileMgrApp)/src
