...
#  PATH_AntiStealApp:
#  the directory that contains the file AntiStealApp.mak.
#  The build process needs this variable to find the makefile
#  and compile AntiStealApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_AntiStealApp)/inc \
    $(PATH_AntiStealApp)/inc/priv \
