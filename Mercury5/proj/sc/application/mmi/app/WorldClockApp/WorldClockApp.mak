...
#  PATH_WorldClockApp:
#  the directory that contains the file WorldClockApp.mak.
#  The build process needs this variable to find the makefile
#  and compile WorldClockApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_WorldClockApp)/inc/priv \
    $(PATH_WorldClockApp)/res
...
SRC_C_LIST = \
    mmi_worldclockapp.c \
    mmi_worldclockapp_view.c

PATH_C = $(PATH_WorldClockApp)/src
