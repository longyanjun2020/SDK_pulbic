...
#  PATH_HamsterFightApp:
#  the directory that contains the file HamsterFightApp.mak.
#  The build process needs this variable to find the makefile
#  and compile HamsterFightApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fms)/pub \
    $(PATH_gss)/pub \
    $(PATH_HamsterFightApp)/inc \
    $(PATH_HamsterFightApp)/inc/priv \
    $(PATH_HamsterFightApp)/res \
    $(PATH_i18n)/inc \
...
SRC_C_LIST = \
    mmi_hamsterfightapp.c

PATH_C = $(PATH_HamsterFightApp)/src
