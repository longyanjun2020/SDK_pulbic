...
#  PATH_StopwatchApp:
#  the directory that contains the file StopwatchApp.mak.
#  The build process needs this variable to find the makefile
#  and compile StopwatchApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
    $(PATH_StopwatchApp)/inc \
    $(PATH_StopwatchApp)/inc/priv \
    $(PATH_StopwatchApp)/res \
    $(PATH_sys)/pub \
    $(PATH_time)/pub \
    $(PATH_timer)/pub \
    $(PATH_trc)/pub \
