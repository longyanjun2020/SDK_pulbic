...
#  PATH_MessageViewerApp:
#  the directory that contains the file MessageViewerApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MessageViewerApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MessageViewerApp)/inc/priv \
    $(PATH_MessageViewerApp)/res \
...
SRC_C_LIST = \
    mmi_messageviewerapp.c

PATH_C = $(PATH_MessageViewerApp)/src
