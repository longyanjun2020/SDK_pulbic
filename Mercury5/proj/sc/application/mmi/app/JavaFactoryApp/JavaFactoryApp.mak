...
#  PATH_JavaFactoryApp:
#  the directory that contains the file JavaFactoryApp.mak.
#  The build process needs this variable to find the makefile
#  and compile JavaFactoryApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_javafactoryapp.c

PATH_C = $(PATH_JavaFactoryApp)/src
