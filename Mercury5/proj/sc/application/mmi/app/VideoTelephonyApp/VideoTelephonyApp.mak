...
#  PATH_VideoTelephonyApp:
#  the directory that contains the file VideoTelephonyApp.mak.
#  The build process needs this variable to find the makefile
#  and compile VideoTelephonyApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_videotelephonyapp.c \
    mmi_videotelephonyapp_crunch.c \
    mmi_videotelephonyapp_util.c

PATH_C = $(PATH_VideoTelephonyApp)/src
