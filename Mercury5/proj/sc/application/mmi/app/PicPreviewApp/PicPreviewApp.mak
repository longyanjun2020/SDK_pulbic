...
#  PATH_PicPreviewApp:
#  the directory that contains the file PicPreviewApp.mak.
#  The build process needs this variable to find the makefile
#  and compile PicPreviewApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_PicPreviewApp)/inc \
    $(PATH_PicPreviewApp)/inc/priv \
    $(PATH_PicPreviewApp)/res \
    $(PATH_ResMgr)/inc \
    $(PATH_ResMgr)/inc/ABL \
