...
#  PATH_AndroidKeyGuardApp:
#  the directory that contains the file AndroidKeyGuardApp.mak.
#  The build process needs this variable to find the makefile
#  and compile AndroidKeyGuardApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_AndroidKeyGuardApp)/inc \
    $(PATH_AndroidKeyGuardApp)/inc/priv \
    $(PATH_AndroidKeyGuardApp)/res \
...
SRC_C_LIST = \
    mmi_android_keyguardapp.c

PATH_C = $(PATH_AndroidKeyGuardApp)/src
