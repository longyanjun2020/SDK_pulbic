...
#  PATH_NetworkCounterApp:
#  the directory that contains the file NetworkCounterApp.mak.
#  The build process needs this variable to find the makefile
#  and compile NetworkCounterApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_NetworkCounterApp)/inc \
    $(PATH_NetworkCounterApp)/inc/priv \
    $(PATH_NetworkCounterApp)/res \
    $(PATH_ResMgr)/inc \
    $(PATH_ResMgr)/inc/ABL \
...
SRC_C_LIST = \
    mmi_networkcounterapp.c

PATH_C = $(PATH_NetworkCounterApp)/src
