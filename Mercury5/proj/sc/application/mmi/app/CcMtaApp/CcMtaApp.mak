...
#  PATH_CcMtaApp:
#  the directory that contains the file CcMtaApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CcMtaApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_CallSettingApp)/inc \
    $(PATH_CallSettingApp)/inc/priv \
    $(PATH_CcApp)/inc \
    $(PATH_CcApp)/inc/priv \
    $(PATH_CcMtaApp)/inc \
    $(PATH_CcMtaApp)/inc/priv \
    $(PATH_CcMtaApp)/res \
    $(PATH_core)/pub \
    $(PATH_cpu_mdl)/pub \
    $(PATH_cus_app)/inc \
...
SRC_C_LIST = \
    mmi_ccmtaapp.c \
    mmi_ccmtaapp_crunch.c \
    mmi_ccmtaapp_util.c \
    mmi_vtccmtaapp.c \
    mmi_vtccmtaapp_crunch.c \
    mmi_vtccmtaapp_util.c

PATH_C = $(PATH_CcMtaApp)/src
