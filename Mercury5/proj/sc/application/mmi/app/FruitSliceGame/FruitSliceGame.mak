...
#  PATH_FruitSliceGame:
#  the directory that contains the file FruitSliceGame.mak.
#  The build process needs this variable to find the makefile
#  and compile FruitSliceGame.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_FruitSliceGame)/inc \
    $(PATH_FruitSliceGame)/inc/priv \
    $(PATH_mae)/pub \
    $(PATH_mmi_res) \
...
REL_SRC_C_LIST = \
    mmi_fruitslicegame.c \
    mmi_fruitslicegame_ge.c \
    mmi_fruitslicegame_util.c

PATH_C = $(PATH_FruitSliceGame)/src
