...
#  PATH_MessageCenterApp:
#  the directory that contains the file MessageCenterApp.mak.
#  The build process needs this variable to find the makefile
#  and compile MessageCenterApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_MessageCenterApp)/inc/priv \
    $(PATH_MessageCenterApp)/res \
...
SRC_C_LIST = \
    mmi_messagecenterapp.c

PATH_C = $(PATH_MessageCenterApp)/src
