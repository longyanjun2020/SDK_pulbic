...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_VampireGame)/inc \
    $(PATH_VampireGame)/inc/priv \
    $(PATH_mae)/pub \
    $(PATH_mae)/inc \
    $(PATH_mmi_res) \
...
REL_SRC_C_LIST = \
    mmi_vampiregame.c \
    mmi_vampiregame_actors.c \
    mmi_vampiregame_mainscene.c \
    mmi_vampiregame_levelscene.c \
    mmi_vampiregame_gamescene.c

PATH_C = $(PATH_VampireGame)/src
