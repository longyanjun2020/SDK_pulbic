...
#  PATH_GogoBoxGame:
#  the directory that contains the file GogoBoxGame.mak.
#  The build process needs this variable to find the makefile
#  and compile GogoBoxGame.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_GogoBoxGame)/inc \
    $(PATH_GogoBoxGame)/inc/priv \
    $(PATH_mae)/pub \
    $(PATH_MglDemoApp)/inc \
    $(PATH_MglDemoApp)/inc/priv \
    $(PATH_mmi_res) \
...
REL_SRC_C_LIST = \
    mmi_gogoboxgame.c \
    mmi_gogoboxgame_ge.c

PATH_C = $(PATH_GogoBoxGame)/src
