...
#  PATH_DialerGroupApp:
#  the directory that contains the file DialerGroupApp.mak.
#  The build process needs this variable to find the makefile
#  and compile DialerGroupApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_DialerGroupApp)/inc \
    $(PATH_DialerGroupApp)/inc/priv \
    $(PATH_esl)/pub \
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_gss)/pub \
...
SRC_C_LIST = \
    mmi_dialergroupapp.c

PATH_C = $(PATH_DialerGroupApp)/src
