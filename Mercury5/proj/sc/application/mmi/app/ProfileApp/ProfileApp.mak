...
#  PATH_ProfileApp:
#  the directory that contains the file ProfileApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ProfileApp.lib.
#  Related files:
...
SRC_C_LIST = \
    mmi_profileapp.c \
    mmi_profileapp_util.c \
    mmi_profileapp_view.c

PATH_C = $(PATH_ProfileApp)/src
