...
#  PATH_UnitConverterApp:
#  the directory that contains the file UnitConverterApp.mak.
#  The build process needs this variable to find the makefile
#  and compile UnitConverterApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_timer)/pub \
    $(PATH_trc)/pub \
    $(PATH_UnitConverterApp)/inc \
    $(PATH_UnitConverterApp)/inc/priv \
    $(PATH_UnitConverterApp)/res \
    $(PATH_vfs)/pub \
    $(PATH_widget)/inc \
...
SRC_C_LIST = \
    mmi_unitconverterapp.c \
    mmi_unitconverterapp_util.c

PATH_C = $(PATH_UnitConverterApp)/src
