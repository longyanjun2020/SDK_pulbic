...
#  PATH_KingMovieApp:
#  the directory that contains the file KingMovieApp.mak.
#  The build process needs this variable to find the makefile
#  and compile KingMovieApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_KingMovieApp)/inc \
    $(PATH_KingMovieApp)/inc/priv \
    $(PATH_KingMovieApp)/res \
    $(PATH_mae)/pub \
    $(PATH_mae)/src \
    $(PATH_mmi_res) \
...
SRC_C_LIST = \
    mmi_kingmovieapp.c \
    mmi_kingmovieapp_3dstyle_ext.c

PATH_C = $(PATH_KingMovieApp)/src
