...
#  PATH_ShortcutsApp:
#  the directory that contains the file ShortcutsApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ShortcutsApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_ShortcutsApp)/inc/priv \
    $(PATH_ShortcutsApp)/res \
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
    $(PATH_sys)/pub \
    $(PATH_time)/pub \
