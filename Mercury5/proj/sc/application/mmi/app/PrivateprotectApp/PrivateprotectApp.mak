...
#  PATH_PrivateprotectApp:
#  the directory that contains the file PrivateprotectApp.mak.
#  The build process needs this variable to find the makefile
#  and compile PrivateprotectApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_PrivateprotectApp)/inc \
    $(PATH_PrivateprotectApp)/inc/priv \
    $(PATH_PrivateprotectApp)/res \
    $(PATH_ResMgr)/inc \
    $(PATH_ResMgr)/inc/ABL \
...
SRC_C_LIST = \
    mmi_privateprotectapp.c \
    mmi_privateprotectpwapp.c

PATH_C = $(PATH_PrivateprotectApp)/src
