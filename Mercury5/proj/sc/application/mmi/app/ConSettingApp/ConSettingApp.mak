...
#  PATH_ConSettingApp:
#  the directory that contains the file ConSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ConSettingApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_bluetooth)/pub \
    $(PATH_build) \
    $(PATH_ConSettingApp)/inc \
    $(PATH_ConSettingApp)/inc/priv \
    $(PATH_ConSettingApp)/res \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
