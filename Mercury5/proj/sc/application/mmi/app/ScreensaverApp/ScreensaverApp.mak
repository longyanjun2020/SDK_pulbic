...
#  PATH_ScreensaverApp:
#  the directory that contains the file ScreensaverApp.mak.
#  The build process needs this variable to find the makefile
#  and compile ScreensaverApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_rtc)/pub \
    $(PATH_rtk)/pub \
    $(PATH_ScreensaverApp)/inc \
    $(PATH_ScreensaverApp)/inc/priv \
    $(PATH_ScreensaverApp)/res \
    $(PATH_sdk)/inc \
    $(PATH_sdk)/pub \
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
...
SRC_C_LIST = \
    mmi_screensaverapp.c

PATH_C = $(PATH_ScreensaverApp)/src
