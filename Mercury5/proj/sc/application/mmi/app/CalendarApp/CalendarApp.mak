...
#  PATH_CalendarApp:
#  the directory that contains the file CalendarApp.mak.
#  The build process needs this variable to find the makefile
#  and compile CalendarApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_CalendarApp)/inc/priv \
    $(PATH_CalendarApp)/res \
    $(PATH_IndCalendar)/pub \
    $(PATH_core)/pub \
    $(PATH_cus_app)/inc \
    $(PATH_CusDefine)/pub \
    $(PATH_esl)/pub \
...
SRC_C_LIST = \
    mmi_calendarapp.c \
    mmi_calendarapp_util.c \
    mmi_calendarapp_indian.c
	
PATH_C = $(PATH_CalendarApp)/src
