...
#  PATH_FruitGambleGame:
#  the directory that contains the file FruitGambleGame.mak.
#  The build process needs this variable to find the makefile
#  and compile FruitGambleGame.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_fc)/pub \
    $(PATH_FileMgr)/pub \
    $(PATH_FruitGambleGame)/inc \
    $(PATH_FruitGambleGame)/inc/priv \
    $(PATH_FruitGambleGame)/res \
    $(PATH_gss)/pub \
    $(PATH_i18n)/inc \
...
SRC_C_LIST = \
    mmi_fruitgamblegame.c

PATH_C = $(PATH_FruitGambleGame)/src
