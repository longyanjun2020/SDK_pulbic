...
#  PATH_VoiceMemoApp:
#  the directory that contains the file VoiceMemoApp.mak.
#  The build process needs this variable to find the makefile
#  and compile VoiceMemoApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_trc)/pub \
    $(PATH_vfs)/pub \
    $(PATH_VoiceMemoApp)/inc \
    $(PATH_VoiceMemoApp)/inc/priv \
    $(PATH_VoiceMemoApp)/res \
    $(PATH_widget)/inc \
