...
#  PATH_SmsSettingApp:
#  the directory that contains the file SmsSettingApp.mak.
#  The build process needs this variable to find the makefile
#  and compile SmsSettingApp.lib.
#  Related files:
...
PATH_H = \
    ...
    $(PATH_sdk)/inc \
    $(PATH_sdk)/pub \
    $(PATH_SmsSettingApp)/inc \
    $(PATH_SmsSettingApp)/inc/priv \
    $(PATH_SmsSettingApp)/res \
    $(PATH_srv)/pub \
    $(PATH_SrvWrapper)/pub \
    $(PATH_sys)/pub \
    $(PATH_time)/pub \
