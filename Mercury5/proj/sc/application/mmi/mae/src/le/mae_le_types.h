#ifndef __MAE_LG_TYPES_H__
#define __MAE_LG_TYPES_H__
...
enum
{
	...
	LE_LANGUAGE_TAG_BEN = 0x42454E20, /* 'BEN' (Bengali) */
 	...
 	LE_LANGUAGE_TAG_HAN = 0x4A414E20, /* 'JAN' (Japanese) */
	LE_LANGUAGE_TAG_JAN = 0x4B414E20, /* 'KAN' (Kannada) */
