/**
 * \file    mae_font_telugu.h
 * \brief   The document describes the interface of Telugu font
 * \author  
 * @version $Id: mae_font_telugu.h $
 */
#ifndef __MAE_FONT_TELUGU_H__
#define __MAE_FONT_TELUGU_H__
...
#define IS_TELUGU_PRIV_RANGE(_char) (_char >= TELUGU_L_KA && _char <= TELUGU_L_HA_HALANT)
#define IS_TELUGU_PRIV_DEPVOW_COMPOSING_CHAR(_char) ((_char >= TELUGU_L_SMALL_KA && _char <= TELUGU_L_SMALL_NA) \
                                                      || (_char >= TELUGU_L_SMALL_PA && _char <= TELUGU_L_SMALL_LLA) \
                                                      || (_char >= TELUGU_L_SMALL_VA && _char <= TELUGU_L_SMALL_HA))
#define IS_TELUGU_PRIV_DEPVOW_RIGHT_POS_CHAR(_char) (_char == TELUGU_L_SMALL_KA \
	                                                 || _char == TELUGU_L_SMALL_CA || _char == TELUGU_L_SMALL_CHA \
                                                     || _char == TELUGU_L_SMALL_NA || (_char >= TELUGU_L_SMALL_PA && _char <= TELUGU_L_SMALL_YA) \
                                                     || _char == TELUGU_L_SMALL_LLA || _char == TELUGU_L_SMALL_VA \
                                                     || _char == TELUGU_L_SMALL_SHA || _char == TELUGU_L_SMALL_SA)
...
typedef enum
{
	...
	TELUGU_L_PE                   = 0xed2a,
	TELUGU_L_PEE                  = 0xed2b,
	TELUGU_L_VE_1                 = 0xed2c,
	TELUGU_L_VEE_1                = 0xed2d,
	TELUGU_L_NO                   = 0xed2e,
	TELUGU_L_SI                   = 0xed2f,
	TELUGU_L_SII                  = 0xed30,

	//add new TELUGU priv unicode
	TELUGU_L_GI                   = 0xed31,
	TELUGU_L_GII                  = 0xed32,
	TELUGU_L_JHI                  = 0xed33,
	TELUGU_L_JHII                 = 0xed34,
	TELUGU_L_TTHI                 = 0xed35,
	TELUGU_L_TTHII                = 0xed36,
	TELUGU_L_RI                   = 0xed37,
	TELUGU_L_RII                  = 0xed38,
	TELUGU_L_HI                   = 0xed39,
	TELUGU_L_HII                  = 0xed3a,
	TELUGU_L_HE                   = 0xed3b,
	TELUGU_L_HEE                  = 0xed3c,
	TELUGU_L_HA_HALANT            = 0xed3d,
	TELUGU_L_MAI                  = 0xed3e,
	TELUGU_L_MAII                 = 0xed3f,
}TeluguLigatures_e;

#endif //__TELUGU_FONT__
#endif //__INDIC_FONT__
#endif /* __MAE_FONT_TELUGU_H__ */
