 ...
 *
 * @version $Id: mmi_mae_clstbl.h 1798 2009-09-21 02:37:54Z kenny.wu $
 */

#ifndef __MMI_MAE_CLSTBL_H__
#define __MMI_MAE_CLSTBL_H__
#include "mmi_mae_common_def.h"
#include "mmi_mae_shell_forward.h"
#include "mmi_mae_shell_types.h"
...
DECLARE_NEW_FUNC(MAE_Shell_New);
...
#ifdef __RFID__
DECLARE_NEW_FUNC(MAERfidReader_New);
#endif	//__RFID__
...
DECLARE_NEW_FUNC(ImageModel_New);
...
#ifdef __RFID__
	DEFINE_CLSID(CLSID_RFIDREADER,	MAERfidReader_New),
#endif	//__RFID__
...
DEFINE_CLS_CATEGORY(MAE_ModelClass)
{
	...
	DEFINE_CLSID(CLSID_IMAGEMODEL,		ImageModel_New),
