...
#define WSP_CSDU        256000    /**< Default Maximum Client SDU */
#define WSP_SSDU        256000    /**< Default Maximum Server SDU */
...
#define WSP_OPTIONS     0x48    /**< Protocol Options */
#define WSP_MOM         10      /**< Maximum Outstanding Method Requests.should not modified */
...
#define WTP_RetransTimeOut      4 /**< Retransmit interval,in ms.It should be modified according to the target system which the user using */
