...
#define PANEL_HEIGHT                720 // 576//PAL
...
void RTNA_LCD_InitMainLCD(void)
{
    ...
    m_PanelAttr.ulDotClkFreq        = 74250000; //28000000;
    ...
    m_PanelAttr.usCCIR656_HBlanking = 365;
    m_PanelAttr.usCCIR656_VTopBlank = 19;
    m_PanelAttr.usCCIR656_VBotBlank = 10;
    m_PanelAttr.usCCIR656_Mode      = LCD_SCAN_PROGRESS;
