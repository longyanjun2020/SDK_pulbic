...
#include "Mipi_SSD2828.h"
	...
	#define PANEL_WIDTH                 (540)//(800)
	#define PANEL_HEIGHT                (960)//(480)
	#elif Lcd_765_E00_480_854
	#define PANEL_WIDTH                 (480)//(800)
	#define PANEL_HEIGHT                (854)//(480)
	#else
	"error"
	#endif
#else
...
#if ENABLE_MIPI_PANEL
#if Lcd_95_A00_540_960
	m_PanelAttr.usHBPorch 		= 13;
	m_PanelAttr.usHBlanking 	= 24;
	m_PanelAttr.usHSyncW 		= 4;
	m_PanelAttr.usVBPorch 		= 12;
	m_PanelAttr.usVBlanking     = 19;
