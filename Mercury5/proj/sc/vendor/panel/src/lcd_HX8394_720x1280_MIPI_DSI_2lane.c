//==============================================================================
//
//  File        : lcd_HX8394_720x1280_MIPI_DSI_2lane.c
//  Description : 720x1280 MIPI DSI LCD Panel Control Function
//  Author      :
//  Revision    : 1.0
//
//==============================================================================
...
static LCM_PARAMS  m_MIPI_DSI_LCM=
{
        ...
        720,          24,     48,      48,          1280,       2,        5,       9,       0,       60,     2,                 DSI_FORMAT_RGB888,          DSI_SYNC_PULSE_MODE
