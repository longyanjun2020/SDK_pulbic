#ifndef _GSENSOR_GMA305_H_
#define _GSENSOR_GMA305_H_
...
#define GSENSOR_SLAVE_ADDR				(0x0C)//(0x0C)//(0x18)
#endif
#ifndef GSENSOR_SCL
...
typedef enum
{
	GSensor_Reg_PID 			= 0x00,
	GSensor_Reg_PWDN 			= 0x01,
	GSensor_Reg_MODE			= 0x02,
	GSensor_Reg_THR				= 0x03, // Motion detection threshold.
	GSensor_Reg_START_ADDR		= 0x04, // Start address for sequential read mode. return 11-bytes.
	GSensor_Reg_STATUS			= 0x05,
	GSensor_Reg_X_LSB			= 0x06,
	GSensor_Reg_X_MSB			= 0x07,
	GSensor_Reg_Y_LSB			= 0x08,
	GSensor_Reg_Y_MSB			= 0x09,
	GSensor_Reg_Z_LSB			= 0x0A,
	GSensor_Reg_Z_MSB			= 0x0B,
	GSensor_Reg_T_LSB			= 0x0C,
	GSensor_Reg_T_MSB			= 0x0D,
	GSensor_Reg_INTC			= 0x15,
	GSensor_Reg_CTL1			= 0x16,
	GSensor_Reg_CTL2			= 0x17,
	
	GSensor_Reg_INVALID			= 0x39
}GSENSOR_REG;
